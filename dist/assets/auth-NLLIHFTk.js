...
import p from"./vendor-swal-BSk0fVSb.js";const z="color-theme",he=3600*24*365;function me(e,o,a){document.cookie=`${e}=${o}; max-age=${a}; path=/; SameSite=Lax`}function de(e){const o=document.cookie.match(new RegExp("(?:^|; )"+e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"=([^;]*)"));return o?decodeURIComponent(o[1]):null}function ce(){const e=localStorage.getItem(z)||de(z);return e==="dark"||e==="light"?e:"light"}function Q(e){const o=document.documentElement;e==="dark"?o.classList.add("dark"):o.classList.remove("dark"),localStorage.setItem(z,e),me(z,e,he),ve(e),document.dispatchEvent(new CustomEvent("themeChanged",{detail:{theme:e}}))}function te(){const e=ce();Q(e==="dark"?"light":"dark")}function ve(e){const o=e==="dark",a=document.getElementById("pref-dark-mode");a&&(a.checked=o);const s=document.getElementById("theme-toggle-dark-icon"),r=document.getElementById("theme-toggle-light-icon");s&&r&&(s.classList.toggle("hidden",o),r.classList.toggle("hidden",!o));const t=document.getElementById("sidebar-theme-label");t&&(t.textContent=o?"Light Mode":"Dark Mode")}function Ne(){const e=ce();Q(e);const o=document.getElementById("pref-dark-mode");o&&o.addEventListener("change",()=>{Q(o.checked?"dark":"light")});const a=document.getElementById("theme-toggle-btn");a&&a.addEventListener("click",te),document.querySelectorAll("[data-theme-toggle]").forEach(s=>{s.addEventListener("click",te)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",s=>{localStorage.getItem(z)||de(z)||Q(s.matches?"dark":"light")})}function q(){return document.documentElement.classList.contains("dark")}window.toggleTheme=te;window.isDarkMode=q;const J=()=>"false".toLowerCase()==="true";function we(e){try{return JSON.stringify(e)}catch{return"[unserializable]"}}const W={debug(...e){J()&&console.debug(...e)},info(...e){J()&&console.info(...e)},warn(...e){J()&&console.warn(...e)},error(...e){console.error(...e)},table(e){J()&&console.table(e)},json(e,o){J()&&console.debug(e,we(o))}};async function re(e,o={}){const s=`${D()}${e}`;let r=null;try{const d=JSON.parse(localStorage.getItem("user"));d&&d.id&&(r=d.id)}catch{}const t={headers:{"Content-Type":"application/json",...r?{"X-User-Id":r}:{},...o.headers},...o};try{if(W.debug("[API] Request",{url:s,method:t.method||"GET",hasUserId:!!r}),t.body)try{W.json("[API] Payload",JSON.parse(t.body))}catch{W.debug("[API] Payload (raw)",t.body)}const d=await fetch(s,t);if(!d.ok)throw new Error(`HTTP ${d.status}: ${d.statusText}`);const n=await d.json();return W.debug("[API] Response",{url:s,ok:!0}),{success:!0,data:n}}catch(d){return W.error("API Request Error:",d),{success:!1,error:d.message}}}async function oe(e){return re(e,{method:"GET"})}async function Oe(e,o){return re(e,{method:"PUT",body:JSON.stringify(o)})}class ye{constructor(){this.intervals=new Map,this.isPageVisible=!0,document.addEventListener("visibilitychange",()=>{this.isPageVisible=!document.hidden,this.isPageVisible?console.log("[Polling] Page visible - resuming normal activity"):console.log("[Polling] Page hidden - reducing activity")})}start(o,a,s=1e4){this.stop(o),a();const r=setInterval(async()=>{this.isPageVisible&&await a()},s);this.intervals.set(o,r),console.log(`[Polling] Started: ${o} (every ${s}ms)`)}stop(o){this.intervals.has(o)&&(clearInterval(this.intervals.get(o)),this.intervals.delete(o),console.log(`[Polling] Stopped: ${o}`))}stopAll(){this.intervals.forEach((o,a)=>this.stop(a)),console.log("[Polling] All intervals stopped")}getActivePolls(){return Array.from(this.intervals.keys())}}const ke=new ye;function Te(){typeof window.initFlowbite=="function"?(window.initFlowbite(),console.log("[Flowbite] Components re-initialized")):console.warn("[Flowbite] initFlowbite() not available globally")}function Pe(e,o="",a="info"){p.fire({toast:!0,position:"top-end",icon:a,title:e,text:o,showConfirmButton:!1,timer:3e3,timerProgressBar:!0})}function Re(e){return JSON.stringify(e)}window.addEventListener("beforeunload",()=>{ke.stopAll()});const Z={queue:[],currentIndex:0,isActive:!1,isAutoSave:!1,lastInteractionTime:0,init(){this.showUploadModal()},showUploadModal(){const e=q(),o={bgCard:e?"bg-slate-900/40":"bg-gray-50/40",borderCard:e?"border-slate-800":"border-gray-100",textHeading:e?"text-green-500":"text-[#2e7d32]",textSubtitle:e?"text-slate-500":"text-gray-400 dark:text-gray-300",bgUpload:e?"bg-slate-800":"bg-white",borderUpload:e?"border-slate-700":"border-gray-200",textUpload:e?"text-slate-400":"text-gray-500",hoverUpload:e?"hover:bg-slate-800/80 hover:border-blue-500":"hover:bg-blue-50/50 hover:border-royal-blue",iconText:e?"text-green-400":"text-[#2e7d32]",iconBg:e?"bg-green-900/20":"bg-[#e8f5e9]",iconBorder:e?"border-green-800/30":"border-[#c8e6c9]"},a=`
        ...
        `;p.fire({html:a,width:"600px",showConfirmButton:!1,showCloseButton:!0,customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},didOpen:s=>{const r=s.querySelector("#csv-upload"),t=s.querySelector('label[for="csv-upload"]');["dragenter","dragover","dragleave","drop"].forEach(n=>{t.addEventListener(n,d,!1)});function d(n){n.preventDefault(),n.stopPropagation()}["dragenter","dragover"].forEach(n=>{t.addEventListener(n,()=>{t.classList.add("border-blue-500","bg-blue-50/50"),e&&t.classList.add("dark:bg-slate-800/80")},!1)}),["dragleave","drop"].forEach(n=>{t.addEventListener(n,()=>{t.classList.remove("border-blue-500","bg-blue-50/50"),e&&t.classList.remove("dark:bg-slate-800/80")},!1)}),r.addEventListener("change",n=>{const c=n.target.files[0];if(c){const l=s.querySelector("#auto-save-toggle");this.isAutoSave=l?l.checked:!1,this.handleFile(c)}}),t.addEventListener("drop",n=>{const l=n.dataTransfer.files[0];if(l){const i=s.querySelector("#auto-save-toggle");this.isAutoSave=i?i.checked:!1,this.handleFile(l)}},!1)}})},handleFile(e){if(!e.name.toLowerCase().endsWith(".csv")&&!e.name.toLowerCase().endsWith(".txt")){p.fire("Invalid File","Please upload a valid .csv or .txt file.","error");return}const o=new FileReader;o.onload=a=>{const s=a.target.result;this.parseCSV(s)},o.readAsText(e)},parseCSV(e){let o=[],a="",s=!1;for(let r=0;r<e.length;r++){let t=e[r];t==='"'&&(s=!s),!s&&(t===`
`||t==="\r")?(t==="\r"&&e[r+1]===`
`&&r++,a.trim()!==""&&o.push(a),a=""):a+=t}a.trim()!==""&&o.push(a),this.queue=[];for(let r=0;r<o.length;r++){let t=o[r].trim();if(!t)continue;let d=[],n="",c=!1;for(let l=0;l<t.length;l++){let i=t[l];i==='"'?c=!c:i===","&&!c?(d.push(n.replace(/(^"|"$)/g,"").trim()),n=""):n+=i}if(d.push(n.replace(/(^"|"$)/g,"").trim()),d.length>=2){const l=d[3];if(!l||isNaN(parseInt(l)))continue;const i=d[1];if(!i||i.toLowerCase()==="name"||i.toLowerCase()==="full name")continue;const g=d[2];let f=d[4]?d[4].toUpperCase().trim():"",x="";(f==="F"||f.includes("FEMALE"))&&(x="Female"),(f==="M"||f.includes("MALE"))&&(x="Male");const b=d[5],m=d[6],I=d[7],E=this.formatDate(d[8]),M=this.formatDate(d[9]);this.queue.push({name:i,address:g,age:l,gender:x,education:b,startDate:E,endDate:M,office:m,designation:I})}}this.queue.length>0?(this.isActive=!0,this.currentIndex=0,p.close(),this.processNext()):p.fire("Error","No valid beneficiary data found. Please ensure your CSV formatting matches the requirements.","error")},showProgressModal(){q();const e=Math.round(this.currentIndex/this.queue.length*100),o=`
        ...
        `;if(p.isVisible()&&p.getPopup().querySelector("#bulk-progress-bar")){const a=document.getElementById("bulk-progress-bar"),s=p.getPopup().querySelector("span.text-\\[10px\\]"),r=document.getElementById("bulk-current-name");a&&(a.style.width=`${e}%`),s&&(s.textContent=`${this.currentIndex} / ${this.queue.length}`),r&&(r.textContent=this.queue[this.currentIndex]?.name||"...")}else p.fire({html:o,showConfirmButton:!1,allowOutsideClick:!1,allowEscapeKey:!1,width:"450px",customClass:{container:"font-montserrat",popup:"rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-800"},didOpen:a=>{a.querySelector("#stop-bulk-btn").onclick=()=>this.onCancel()}})},formatDate(e){if(!e||e.trim()==="")return"";const o=new Date(e);if(isNaN(o.getTime())){const t=e.split("/");return t.length===3?`${t[2]}-${t[1].padStart(2,"0")}-${t[0].padStart(2,"0")}`:""}const a=o.getFullYear(),s=String(o.getMonth()+1).padStart(2,"0"),r=String(o.getDate()).padStart(2,"0");return`${a}-${s}-${r}`},async processNext(){if(this.currentIndex<this.queue.length){const e=this.queue[this.currentIndex];try{const a=await(await fetch(`${D()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e.name})})).json();if(a.success&&a.exists)return console.warn(`%c[Bulk Add] SKIPPED: ${e.name} already exists in database.`,"color: #ff9800; font-weight: bold;"),this.currentIndex++,this.processNext()}catch(o){console.error("Duplicate check failed:",o)}e._isBulk=!0,e._bulkCurrent=this.currentIndex+1,e._bulkTotal=this.queue.length,this.isAutoSave?(this.showProgressModal(),window.addBeneficiaryData?(async()=>{try{const a=e.startDate?new Date(e.startDate).getFullYear():new Date().getFullYear(),[s,r]=await Promise.all([oe(`api/beneficiaries.php?next_id&year=${a}`),oe(`api/beneficiaries.php?next_series_no&year=${a}`)]);s.success&&s.data?.success&&s.data?.nextId&&(e.gip_id=s.data.nextId,e.id=null),r.success&&r.data?.success&&r.data?.nextSeries&&(e.seriesNo=r.data.nextSeries)}catch(a){console.warn("[Bulk Add] Identifier fetch failed, continuing:",a?.message||a)}const o=await window.addBeneficiaryData(e);this.isActive&&(o?this.onSaveSuccess():ee(e))})():ee(e)):ee(e)}else this.isActive=!1,this.lastInteractionTime=Date.now(),p.fire({icon:"success",title:"Bulk Add Complete!",text:`Successfully processed ${this.queue.length} beneficiaries.`,confirmButtonColor:"#2e7d32"})},onSaveSuccess(){if(this.isActive){this.currentIndex++;const e=this.isAutoSave?100:1500;setTimeout(()=>{this.processNext()},e)}},onCancel(){this.isActive&&(this.isActive=!1,this.lastInteractionTime=Date.now(),this.queue=[],this.currentIndex=0,p.fire({icon:"info",title:"Bulk Add Cancelled",text:"Stopped processing the remaining beneficiaries and cleared the queue.",confirmButtonColor:"#3085d6"}).then(()=>{this.showUploadModal()}))}};window.BulkApp=Z;const $e="modulepreload",Ee=function(e,o){return new URL(e,o).href},ae={},ue=function(o,a,s){let r=Promise.resolve();if(a&&a.length>0){let l=function(i){return Promise.all(i.map(g=>Promise.resolve(g).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};const d=document.getElementsByTagName("link"),n=document.querySelector("meta[property=csp-nonce]"),c=n?.nonce||n?.getAttribute("nonce");r=l(a.map(i=>{if(i=Ee(i,s),i in ae)return;ae[i]=!0;const g=i.endsWith(".css"),f=g?'[rel="stylesheet"]':"";if(s)for(let b=d.length-1;b>=0;b--){const m=d[b];if(m.href===i&&(!g||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${f}`))return;const x=document.createElement("link");if(x.rel=g?"stylesheet":$e,g||(x.as="script"),x.crossOrigin="",x.href=i,c&&x.setAttribute("nonce",c),document.head.appendChild(x),g)return new Promise((b,m)=>{x.addEventListener("load",b),x.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${i}`)))})}))}function t(d){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=d,window.dispatchEvent(n),!n.defaultPrevented)throw d}return r.then(d=>{for(const n of d||[])n.status==="rejected"&&t(n.reason);return o().catch(t)})};function se(e){if(!e)return"";const o=new Date(e),a=new Date;let s=a.getFullYear()-o.getFullYear();const r=a.getMonth()-o.getMonth();return(r<0||r===0&&a.getDate()<o.getDate())&&s--,s>=0?s:0}function ne(e){return e?e.includes("DOLE")?"bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-800":e.includes("DepEd")?"bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800":e.includes("LGU")?"bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-800":e.includes("DICT")?"bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-800":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300"}function Se(e){if(!e)return"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300";const o=e.toUpperCase();return o==="ONGOING"?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800":o==="EXPIRED"?"bg-red-400 text-white border-red-400 dark:bg-red-900/60 dark:border-red-800":o==="RESIGNED"?"bg-[#ce1126] text-white border-[#ce1126] dark:bg-red-900/80 dark:border-red-900":o==="ABSORBED"?"bg-[#2e7d32] text-white border-[#2e7d32] dark:bg-green-900/80 dark:border-green-900":"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300"}function Y(e,o=0){let a=o;const s=e.arLogs||[],r=e.dtrLogs||[],t=e.docs||[],d=["GIP FORM","BIRTH CERTIFICATE","DIPLOMA","TOR","VALID ID"],n=d.map(i=>{const g=t.find(f=>f.name.toUpperCase()===i.toUpperCase());return g||{name:i,status:"PENDING",id:null}});t.forEach(i=>{d.some(f=>f.toUpperCase()===i.name.toUpperCase())||n.push(i)});const c=`
<div class="border-b border-default pb-4 mb-5 flex flex-col relative w-full pt-4 font-montserrat user-select-none">
    ...
    <div class="grid grid-cols-2 gap-4 mt-6 w-full">
        ...
        <div class="flex flex-col gap-1 text-left overflow-hidden">
            ...
            <div class="flex items-center flex-wrap gap-1.5 min-h-[30px]">
                <span class="${Se(e.remarks)} text-[10px] font-black px-2 py-1 rounded border uppercase tracking-widest shadow-sm border-l-4 ${e.remarks==="ONGOING"?"border-l-green-600":"border-l-red-600"}">${e.remarks}</span>
                <!-- Desktop Only Office Badge (Pill Style) -->
                <span class="${ne(e.office)} hidden sm:inline-block text-[9px] font-black px-2.5 py-1 rounded-full border shadow-sm truncate max-w-[120px] lg:max-w-none" title="${e.office}">${e.office}</span>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-1 text-left mt-4 sm:hidden">
        ...
        <span class="${ne(e.office)} text-[10px] font-black px-2.5 py-2 rounded border border-gray-200 dark:border-slate-700 uppercase tracking-widest shadow-sm border-l-4 border-l-indigo-500 w-full truncate" title="${e.office}">${e.office}</span>
    </div>
</div>
...
<div class="flex flex-col gap-4 text-sm mt-3 px-1">
    ...
    <div class="flex justify-between items-center group">
        ...
        <span class="${e.age||se(e.birthday)?"font-black text-heading":"font-bold text-gray-300 italic"} text-right">${e.age||se(e.birthday)||"N/A"}</span>
    </div>
    <div class="flex justify-between items-center group">
...
<div class="mt-8 pt-6 border-t border-default relative">
    ...
    <div id="drawer-page-1" class="hidden flex-1 flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-3">
            ${n.map(i=>{const g=i.status.toUpperCase(),x={VERIFIED:"COMPLETED",DECLINED:"REJECTED",PENDING:"PENDING"}[g]||g,b=x==="COMPLETED",m=x==="REJECTED",I=b?"text-green-500":m?"text-red-500":"text-gray-400 dark:text-gray-500",E=b?"bg-green-50/50 dark:bg-green-900/10":m?"bg-red-50/50 dark:bg-red-900/10":"bg-gray-50/50 dark:bg-slate-800/50",M=b?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800 hover:bg-green-200 cursor-pointer":m?"bg-red-100 text-red-700 border-red-200 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800 hover:bg-red-200 cursor-pointer":"bg-white text-gray-500 border-gray-200 dark:bg-slate-700 dark:text-gray-400 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-600 cursor-pointer";let B='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';return b?B='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>':m&&(B='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"></path></svg>'),`
                <div class="flex items-center justify-between p-3.5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm transition-all hover:-translate-y-0.5 ${E}">
                    <div class="flex items-center gap-3 w-full">
                        <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-white dark:bg-slate-800 shadow-sm border border-gray-100 dark:border-slate-700 ${I}">
                            ${B}
                        </div>
                        <span class="text-xs sm:text-sm font-black ${b?"text-heading":"text-gray-500 dark:text-gray-400"} uppercase tracking-tight flex-1">${i.name}</span>
                    </div>
                    <button type="button" class="ml-3 ${M} text-[10px] font-black px-3 py-1.5 rounded-full border uppercase tracking-widest transition-colors flex-shrink-0 drawer-doc-btn" data-id="${i.id}" data-name="${i.name}" data-status="${x} cursosr-pointer">
                        ${x}
                    </button>
                </div>
                `}).join("")}
...
<style>
    ...
    `;let l=document.getElementById("beneficiary-drawer-container");l&&l.remove(),l=document.createElement("div"),l.id="beneficiary-drawer-container",l.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-neutral-primary-soft dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl",l.setAttribute("tabindex","-1"),l.setAttribute("data-drawer-backdrop","true"),l.innerHTML=c,document.body.appendChild(l),ue(async()=>{const{Drawer:i}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:i}},__vite__mapDeps([0,1]),import.meta.url).then(({Drawer:i})=>{const g={placement:"right",backdrop:!0,bodyScrolling:!1,edge:!1,edgeOffset:"",backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{l&&l.parentNode&&l.remove()},300)}},f=new i(l,g);f.show(),l.querySelector("#close-drawer-btn").addEventListener("click",()=>f.hide());const b=l.querySelector("#drawer-prev-btn"),m=l.querySelector("#drawer-next-btn"),I=2,E=()=>{l.querySelectorAll("[id^=drawer-page-]").forEach((v,C)=>{v.classList.toggle("hidden",C!==a)}),b.disabled=a===0,m.disabled=a===I,b.classList.toggle("opacity-50",a===0),m.classList.toggle("opacity-50",a===I)};b.addEventListener("click",()=>{a>0&&a--,E()}),m.addEventListener("click",()=>{a<I&&a++,E()}),E(),l.querySelectorAll(".drawer-doc-btn").forEach(v=>{v.addEventListener("click",async()=>{const C=v.dataset.name,$=v.dataset.status,L=await p.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Update Document</span>',html:`
                    ...
                    `,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest">Update</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest">Cancel</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2 cursor-pointer",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2 cursor-pointer"},buttonsStyling:!1,preConfirm:()=>document.getElementById("swal-doc-status").value});if(L.isConfirmed){const y=L.value;if(y===$)return;try{const A=new FormData;A.append("gip_id",e.id),A.append("doc_name",C);const h={COMPLETED:"VERIFIED",REJECTED:"DECLINED",PENDING:"PENDING"}[y]||y;A.append("status",h);const S=await(await fetch(`${D()}api/logs.php?type=docs`,{method:"POST",body:A})).text();let k={success:!1};try{k=JSON.parse(S)}catch{}k.success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Status updated!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error",k.error||"Failed to update","error")}catch(A){p.fire("Error",A.message,"error")}}})});const M=()=>{if(!r.length)return new Date().toISOString().split("T")[0];const v=new Date(r[0].date);return v.setDate(v.getDate()+1),v.toISOString().split("T")[0]},B=()=>{if(!s.length){const L=new Date,y=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][L.getMonth()];return L.getDate()<=15?`${y} 1-15`:`${y} 16-${new Date(L.getFullYear(),L.getMonth()+1,0).getDate()}`}const v=s[0].period||"",C=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],$=v.toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+)/);if($){let L=$[1],y=parseInt($[2]),A=C.indexOf(L);if(A!==-1)return y===1?`${L} 16-${new Date(new Date().getFullYear(),A+1,0).getDate()}`:`${C[(A+1)%12]} 1-15`}return"NEW PERIOD"},T=async(v,C)=>{p.fire({title:"Adding...",allowOutsideClick:!1,showConfirmButton:!1}),p.showLoading();try{const $=new FormData;$.append("gip_id",e.id),v==="dtr"&&$.append("record_date",C),v==="ar"&&$.append("period",C),(await(await fetch(`${D()}api/logs.php?type=${v}`,{method:"POST",body:$})).json()).success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Auto-Added!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error","Failed to add log.","error")}catch($){p.fire("Error",$.message,"error")}},F=async(v,C,$,L)=>{const y=C==="dtr"?"Record Date":"Period",{value:A}=await p.fire({title:`<span class="text-xl font-black text-heading uppercase tracking-tight">Edit ${v} Log</span>`,html:`
                    <div class="flex flex-col gap-4 text-left font-montserrat mt-2">
                        <div>
                            <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest block mb-1">${y}</label>
                            <input id="swal-log-val" value="${L}" class="bg-gray-50 border border-gray-200 text-heading text-sm rounded-xl focus:ring-brand focus:border-brand block w-full p-2.5 font-bold uppercase transition-all" placeholder="Enter value">
                        </div>
                    </div>
                `,focusConfirm:!1,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest">SAVE REVISIONS</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest">CANCEL</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>({val:document.getElementById("swal-log-val").value.trim().toUpperCase()})});if(A&&A.val!==L)try{const u={type:C,id:$,status:"PENDING"};C==="dtr"&&(u.record_date=A.val),C==="ar"&&(u.period=A.val);const w=await(await fetch(`${D()}api/logs.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)})).json();w.success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Log Updated!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error",w.error||"Failed to update log.","error")}catch(u){p.fire("Error",u.message,"error")}},j=l.querySelector("#add-dtr-log-btn");j&&j.addEventListener("click",()=>T("dtr",M()));const N=l.querySelector("#add-ar-log-btn");N&&N.addEventListener("click",()=>T("ar",B())),l.querySelectorAll(".edit-log-btn").forEach(v=>{v.addEventListener("click",C=>{if(C.target.closest(".delete-log-btn"))return;const $=v.dataset.type,L=v.dataset.id,y=v.dataset.val;F($.toUpperCase(),$,L,y)})}),l.querySelectorAll(".delete-log-btn").forEach(v=>{v.addEventListener("click",async()=>{const C=v.dataset.id,$=v.dataset.type;if((await p.fire({title:'<span class="text-xl font-black text-philippine-red uppercase tracking-tight">Delete item?</span>',text:"This action cannot be undone.",icon:"warning",showCancelButton:!0,confirmButtonText:'<span class="font-black tracking-widest uppercase">Delete</span>',cancelButtonText:'<span class="font-black tracking-widest uppercase">Wait</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-philippine-red text-white hover:bg-red-700 text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1})).isConfirmed)try{const y=new FormData;y.append("log_id",C),y.append("action","delete");const u=await(await fetch(`${D()}api/logs.php?type=${$}`,{method:"POST",body:y})).text();let h={success:!1};try{h=JSON.parse(u)}catch{}h.success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Deleted",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error","Failed to delete data.","error")}catch(y){p.fire("Error",y.message,"error")}})})}).catch(console.error)}function Ce(e){const o=q(),a=`w-full bg-transparent border-b-2 ${o?"border-slate-700 text-white focus:border-brand placeholder-slate-600":"border-gray-200 text-gray-900 focus:border-brand placeholder-gray-300"} px-1 py-1 text-sm font-black outline-none transition-all focus:ring-0`,s=`w-full bg-transparent border-none ${o?"text-white":"text-royal-blue"} px-0 py-0 text-xl sm:text-2xl font-black leading-tight tracking-tight focus:ring-0 outline-none placeholder-gray-300 resize-none overflow-hidden`,r=["DOLE Field Office","LGU","DEPED","DICT","PCA"];function t(c){if(!c)return"";const l=new Date(c),i=new Date;let g=i.getFullYear()-l.getFullYear();const f=i.getMonth()-l.getMonth();return(f<0||f===0&&i.getDate()<l.getDate())&&g--,g>=0?g:0}const d=`
    ...
    <div class="flex flex-col gap-4 text-sm mt-3 px-1 pb-24">
        ...
        <div class="flex flex-col gap-2 pt-3 mt-1 border-t border-gray-50 dark:border-slate-800/60">
            ...
            <div id="edit-education-suggestions-box" class="hidden mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                ${pe.map(c=>`<button type="button" class="edit-education-option w-full text-left px-3 py-2 text-[11px] font-bold text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-slate-700 cursor-pointer"><span class="option-text">${c.name}</span></button>`).join("")}
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-4 text-sm mt-4 px-1">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div id="edit-designation-suggestions-box" class="hidden mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                ${ge.map(c=>`<button type="button" class="edit-designation-option w-full text-left px-3 py-2 text-[11px] font-bold text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-slate-700 cursor-pointer"><span class="option-text">${c}</span></button>`).join("")}
            </div>
        </div>
...
.editable-indicator {
    ...
    `;let n=document.getElementById("edit-drawer-container");n&&n.remove(),n=document.createElement("div"),n.id="edit-drawer-container",n.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-white dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl pb-0",n.setAttribute("tabindex","-1"),n.innerHTML=d,document.body.appendChild(n),setTimeout(()=>{const c=n.querySelector('textarea[name="name"]');c&&(c.style.height="auto",c.style.height=c.scrollHeight+"px")},10),(async()=>{try{const c=await re("api/beneficiaries.php?get_offices=1");if(c.success&&c.data.offices){const l=n.querySelector("#edit-office-suggestions-box");if(l){const i=["DOLE Field Office","LGU","DEPED","DICT","PCA"],g=[...new Set([...i,...c.data.offices])];l.innerHTML=g.map(f=>`
                    ...
                    `).join("")}}}catch(c){console.error("Error fetching office suggestions:",c)}})(),ue(async()=>{const{Drawer:c}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:c}},__vite__mapDeps([0,1]),import.meta.url).then(({Drawer:c})=>{const l=new c(n,{placement:"right",backdrop:!0,bodyScrolling:!1,backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{n.parentNode&&n.remove()},300)}});l.show(),n.querySelector("#close-edit-drawer-btn").addEventListener("click",()=>l.hide()),n.querySelector("#edit-drawer-cancel-btn").addEventListener("click",()=>l.hide());const i=n.querySelector("#edit-beneficiary-drawer-form"),g=n.querySelector("#edit-bday-input"),f=n.querySelector("#edit-age-display");let x=!1;g&&f&&(f.addEventListener("input",()=>{x=!0}),g.addEventListener("change",m=>{m.target.value&&(!x||!f.value)&&(f.value=t(m.target.value))}));const b=(m,I,E)=>{const M=n.querySelector(m),B=n.querySelector(I);if(!M||!B)return;const T=()=>B.classList.add("hidden"),F=()=>B.classList.remove("hidden");M.addEventListener("focus",F),M.addEventListener("input",()=>{const j=M.value.toLowerCase().trim();let N=0;B.querySelectorAll(E).forEach(v=>{const $=(v.querySelector(".option-text")?.textContent||v.textContent||"").toLowerCase().includes(j);v.style.display=$?"block":"none",$&&N++}),N>0?F():T()}),B.addEventListener("click",j=>{const N=j.target.closest(E);N&&(M.value=(N.querySelector(".option-text")?.textContent||N.textContent||"").trim(),T(),M.dispatchEvent(new Event("change")))}),document.addEventListener("click",j=>{!M.contains(j.target)&&!B.contains(j.target)&&T()})};b("#edit-education-input","#edit-education-suggestions-box",".edit-education-option"),b("#edit-designation-input","#edit-designation-suggestions-box",".edit-designation-option"),b("#edit-office-input","#edit-office-suggestions-box",".edit-office-option"),i.querySelectorAll("input, select, textarea").forEach(m=>{const I=(m.getAttribute("type")||"").toLowerCase(),E=!m.disabled&&!m.readOnly&&I!=="hidden";m.classList.remove("editable-indicator"),E&&m.classList.add("editable-indicator")}),i.addEventListener("submit",m=>{m.preventDefault();const I=new FormData(i),E={};I.forEach((M,B)=>E[B]=M),E.id=e.id,E.gip_id=e.id,window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(E,!0,!1)){l.hide();const B=document.querySelector("#close-drawer-btn");B&&B.click(),p.fire({toast:!0,position:"top-end",icon:"success",title:"Record Updated",showConfirmButton:!1,timer:3e3})}})()})})}function ie(e="Incorrect Username or Password"){p.fire({html:`
            <div class="p-6">
        ...
        `,timer:e?800:3e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1,width:"350px",padding:"0",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-hidden border border-gray-100",timerProgressBar:"bg-green-500 h-1.5"},backdrop:"rgba(0, 0, 0, 0.4)"})}function _e(){window.viewBeneficiary=async function(e,o=0){const a=`logs_cache_${e.id}`;let s=!1;try{if(window.__doleDB&&window.__doleDB.getSecureCache){const b=await window.__doleDB.getSecureCache(a);b&&(e.arLogs=b.arLogs||[],e.dtrLogs=b.dtrLogs||[],e.docs=b.docs||[],Y(e,o),s=!0)}const[r,t,d]=await Promise.all([fetch(`${D()}api/logs.php?type=ar&gip_id=${encodeURIComponent(e.id)}`),fetch(`${D()}api/logs.php?type=dtr&gip_id=${encodeURIComponent(e.id)}`),fetch(`${D()}api/logs.php?type=docs&gip_id=${encodeURIComponent(e.id)}`)]),n=await r.json(),c=await t.json(),l=await d.json(),i=n.success?n.logs:[],g=c.success?c.logs:[],f=l.success?l.logs:[],x={arLogs:i,dtrLogs:g,docs:f};window.__doleDB&&window.__doleDB.setSecureCache&&await window.__doleDB.setSecureCache(a,x),e.arLogs=i,e.dtrLogs=g,e.docs=f,s?document.getElementById("beneficiary-drawer-container")&&Y(e,o):Y(e,o)}catch(r){console.error("Error fetching logs/docs:",r),s||(e.arLogs=[],e.dtrLogs=[],e.docs=[],Y(e,o))}},window.showAddDataModal=function(e){ee(e)},window.editBeneficiary=function(e){Ce(e)},window.showExportConfigModal=function(e){Ae(e)},window.showProfileModal=function(){Le()}}async function Le(){try{let e="";try{const s=JSON.parse(localStorage.getItem("user"));s&&s.id&&(e=`?user_id=${s.id}`)}catch{}const a=await(await fetch(`${D()}api/profile.php${e}`)).json();if(a.success){const s=a.profile;De(s)}else p.fire({icon:"error",title:"Error",text:a.error||"Failed to load profile"})}catch(e){console.error("Error fetching profile:",e)}}function De(e){const o=e.profile_picture_path?`${D()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(r=>r[0]).join("").substring(0,2).toUpperCase():"US",s=`
    ...
    `;p.fire({html:s,width:"450px",showConfirmButton:!1,showCloseButton:!0,padding:"1.5rem",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-visible ldn-modal-popup",closeButton:"focus:outline-none bg-gray-50 border-none swal2-custom-close cursor-pointer"},didOpen:r=>{const t=r.querySelector("#profile-edit-form"),d=r.querySelector("#profile-pic-input"),n=r.querySelector("#profile-avatar-preview");d.addEventListener("change",c=>{const l=c.target.files[0];if(l){const i=new FileReader;i.onload=g=>{n.innerHTML=`<img src="${g.target.result}" class="w-full h-full object-cover" />`},i.readAsDataURL(l)}}),t.addEventListener("submit",async c=>{c.preventDefault();const l=new FormData(t);try{const i=JSON.parse(localStorage.getItem("user"));i&&i.id&&l.append("user_id",i.id)}catch{}try{const g=await(await fetch(`${D()}api/profile.php`,{method:"POST",body:l})).json();g.success?(g.profile&&(localStorage.setItem("user",JSON.stringify(g.profile)),Ie(g.profile)),p.close(),p.fire({toast:!0,position:"top-end",icon:"success",title:"Profile Updated",showConfirmButton:!1,timer:3e3,timerProgressBar:!0})):p.fire({icon:"error",title:"Update Failed",text:g.error||"Something went wrong"})}catch(i){console.error("Error saving profile:",i)}})}})}function Ie(e){const o=e.profile_picture_path?`${D()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(t=>t[0]).join("").substring(0,2).toUpperCase():"US",s=document.querySelectorAll(".sidebar-user-name"),r=document.querySelectorAll(".sidebar-user-avatar");s.forEach(t=>t.textContent=e.full_name),r.forEach(t=>{o?t.innerHTML=`<img src="${o}" class="w-full h-full object-cover" />`:t.textContent=a}),localStorage.setItem("user_full_name",e.full_name),o&&localStorage.setItem("user_avatar",o)}function Ae(e){const o=window.getExportFilters?window.getExportFilters():{office:"ALL",status:"ALL",search:"",sort:"name",section:"ALL",columns:["id","name","office","position","startdate","enddate","status"],preparedBy:localStorage.getItem("ldn_export_prepared")||"",approvedBy:localStorage.getItem("ldn_export_approved")||""},a=`
        <div class="text-left font-montserrat p-1 overflow-visible">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-royal-blue/10 rounded-2xl flex items-center justify-center">
            ...
            <form id="export-config-form" class="space-y-6">
                ...
                <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        ${["ID","Name","Office","Position","Start Date","End Date","Status"].map(s=>{const r=s.toLowerCase().replace(" ",""),t=o.columns.includes(r),d=`col-switch-${r}`;return`
    ...
    `;p.fire({html:d,width:window.innerWidth<1024?"96vw":"1000px",showConfirmButton:!1,showCloseButton:!1,padding:window.innerWidth<1024?"0.75rem":"2rem",customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},didOpen:n=>{const c=n.querySelector("#cancel-modal-btn");c&&c.addEventListener("click",()=>{!o&&!e?._isBulk&&localStorage.removeItem("add_beneficiary_draft"),p.close(),e?._isBulk&&Z.onCancel()});const l=n.querySelector("#bulk-add-btn");l&&l.addEventListener("click",()=>{p.close(),Z.init()});const i=n.querySelector("#birthday-input"),g=n.querySelector("#age-display");i&&g&&(i.addEventListener("change",u=>{u.target.value&&(g.value=le(u.target.value))}),i.value&&!e?.age&&(g.value=le(i.value)));const f=n.querySelector("#name-input-field"),x=n.querySelector("#duplicate-warning");if(f&&x){let u;f.addEventListener("input",h=>{const w=h.target.value.trim();if(clearTimeout(u),w.length<3){x.classList.add("hidden");return}u=setTimeout(async()=>{try{const k=await(await fetch(`${D()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:w})})).json();k.success&&k.exists?(x.classList.remove("hidden"),q()?x.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":x.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600"):x.classList.add("hidden")}catch(S){console.error("Duplicate check error:",S)}},500)}),e?.name&&(x.classList.add("hidden"),(async()=>{const w=await(await fetch(`${D()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e.name})})).json();w.success&&w.exists&&(x.classList.remove("hidden"),q()?x.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":x.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600")})())}const b=n.querySelector("#full-id-input"),m=n.querySelector("#series-no-input"),I=n.querySelector('input[name="startDate"]'),E=n.querySelector('input[name="endDate"]'),M=n.querySelectorAll('input[name="remarks"]'),B=n.querySelector("#extension-log-container"),T=u=>{o||(b&&(b.classList.add("animate-pulse"),b.placeholder="Loading...",fetch(`${D()}api/beneficiaries.php?next_id&year=${u}`).then(h=>h.json()).then(h=>{b.classList.remove("animate-pulse"),h.success&&h.nextId&&(b.value=h.nextId)})),m&&(m.classList.add("animate-pulse"),m.placeholder="Loading...",fetch(`${D()}api/beneficiaries.php?next_series_no&year=${u}`).then(h=>h.json()).then(h=>{m.classList.remove("animate-pulse"),h.success&&h.nextSeries&&(m.value=h.nextSeries)})))},F=()=>{const u=n.querySelector('input[name="remarks"]:checked');return u?u.value:"ONGOING"},j=u=>{const h=n.querySelector(`input[name="remarks"][value="${u}"]`);h&&(h.checked=!0,v())},N=()=>{if(E&&E.value){const u=E.value.split("-"),h=new Date(u[0],u[1]-1,u[2]),w=new Date;w.setHours(0,0,0,0);let S="ONGOING";h<w&&(S="EXPIRED"),j(S)}},v=()=>{if(!B)return;if(F()==="ABSORBED"){const h=e?.absorbDate||new Date().toLocaleString("en-US",{timeZone:"Asia/Manila",month:"short",day:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});B.innerHTML=`
                    ...
                    `}else B.innerHTML=""};if(I&&(I.addEventListener("change",u=>{const h=u.target.value;if(h){const w=new Date(h).getFullYear();if(T(w),E&&!E.value){const S=new Date(h);S.setMonth(S.getMonth()+1),E.value=S.toISOString().split("T")[0]}N()}}),!o)){const u=I.value?new Date(I.value).getFullYear():new Date().getFullYear();T(u)}E&&E.addEventListener("change",N),M.forEach(u=>u.addEventListener("change",v));const C=n.querySelector("#resign-btn"),$=n.querySelector("#absorb-btn");C&&C.addEventListener("click",()=>j("RESIGNED")),$&&$.addEventListener("click",()=>j("ABSORBED")),n.querySelectorAll('input[type="text"], textarea').forEach(u=>{["id-number-input","full-id-input"].includes(u.id)||u.addEventListener("input",()=>{const h=u.selectionStart,w=u.selectionEnd;u.value=u.value.toUpperCase(),u.setSelectionRange(h,w)})}),N(),v(),L("education-input","course-suggestions","course-option"),L("designation-input","work-suggestions","work-option"),L("office-input","office-suggestions","office-option");function L(u,h,w){const S=n.querySelector(`#${u}`),k=n.querySelector(`#${h}`);if(!S||!k)return;let R=!1;S.addEventListener("focus",()=>k.classList.remove("hidden")),document.addEventListener("click",O=>{!S.contains(O.target)&&!k.contains(O.target)&&k.classList.add("hidden")}),S.addEventListener("input",()=>{if(R){R=!1;return}const O=S.value.toLowerCase(),G=k.querySelectorAll(`.${w}`);let X=!1;G.forEach(_=>{const P=_.querySelector(".option-text");(P?P.innerText:_.innerText).toLowerCase().includes(O)?(_.style.display="block",X=!0):_.style.display="none"}),X?k.classList.remove("hidden"):k.classList.add("hidden")}),k.querySelectorAll(`.${w}`).forEach(O=>{O.addEventListener("click",()=>{const G=O.querySelector(".option-text");S.value=G?G.innerText.trim():O.innerText.trim(),R=!0,k.classList.add("hidden"),S.dispatchEvent(new Event("change"))})})}const y=n.querySelector("#add-beneficiary-form"),A="add_beneficiary_draft";if(!o){const u=localStorage.getItem(A);if(u)try{const h=JSON.parse(u);Object.entries(h).forEach(([w,S])=>{const k=y.elements[w];k&&k.type!=="file"&&k.type!=="hidden"&&(k.value=S)})}catch(h){console.error("Error loading draft",h)}}y.addEventListener("input",u=>{if(!o){const h=new FormData(y),w={};h.forEach((S,k)=>w[k]=S),localStorage.setItem(A,JSON.stringify(w))}}),y&&y.addEventListener("submit",u=>{u.preventDefault(),y.querySelectorAll('input:not([type="hidden"]), select, textarea').forEach(U=>{U.classList.remove("ring-2","ring-red-500","!border-red-500")});const w=new FormData(y);let S=!1;const k=U=>{const H=y.querySelector(`[name="${U}"]`);H&&H.classList.add("ring-2","ring-red-500","!border-red-500"),S=!0},R=w.get("name"),O=w.get("contact"),G=w.get("startDate"),X=w.get("endDate"),_=w.get("designation");if((!R||R.trim()===""||/[0-9]/.test(R))&&k("name"),O&&O.trim()!==""&&/[^0-9]/.test(O.replace(/[\s\-\+\(\)]/g,""))&&k("contact"),G||k("startDate"),X||k("endDate"),(!_||_.trim()==="")&&k("designation"),S)return;const P={};w.forEach((U,H)=>{P[H]=U});const V=n.querySelector("#full-id-input")?.value;o?(P.id=e?.id,V&&(P.gip_id=V)):(P.id=null,V&&(P.gip_id=V)),window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(P)){if(!o){const H="add_beneficiary_draft",fe=y.querySelector('[name="office"]')?.value||"",be=y.querySelector('[name="designation"]')?.value||"",xe=y.querySelector('[name="education"]')?.value||"";localStorage.setItem(H,JSON.stringify({office:fe,designation:be,education:xe}))}p.close(),setTimeout(()=>{p.fire({toast:!0,position:"top-end",icon:"success",title:`Record ${o?"Updated":"Added"} Successfully`,showConfirmButton:!1,timer:3e3,timerProgressBar:!0}),!o&&e?._isBulk&&Z.onSaveSuccess()},100)}else p.fire({icon:"error",title:"Save Failed",text:"There was an error saving the record to the database."})})()})}})}window.handleContactSubmit=async function(e){e.preventDefault();const o=e.target,a=o.querySelector('button[type="submit"]'),s=a.innerHTML;a.disabled=!0,a.innerHTML=`
        <svg class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        </svg>
        Sending...
    `;try{const r=new FormData(o);if((await fetch(o.action,{method:"POST",body:r,headers:{Accept:"application/json"}})).ok)p.fire({toast:!0,position:"top-end",icon:"success",title:"Message Sent Successfully!",text:"Thank you for reaching out. I will get back to you soon!",showConfirmButton:!1,timer:4e3,timerProgressBar:!0,didOpen:d=>{d.addEventListener("mouseenter",p.stopTimer),d.addEventListener("mouseleave",p.resumeTimer)},customClass:{popup:"rounded-2xl border-l-4 border-teal-500 shadow-2xl"}}),o.reset();else throw new Error("Failed to send")}catch{p.fire({toast:!0,position:"top-end",icon:"error",title:"Oops! Something went wrong.",text:"Could not send your message. Please try again later.",showConfirmButton:!1,timer:4e3,customClass:{popup:"rounded-2xl border-l-4 border-red-500 shadow-2xl"}})}finally{a.disabled=!1,a.innerHTML=s}return!1};"true".toLowerCase();function D(){const e=window.location.pathname,o="/dole-system/",a=e.toLowerCase().indexOf(o.toLowerCase());return a!==-1?e.substring(0,a+o.length):"/"}function qe(){const e=localStorage.getItem("hasVisitedBefore"),o=document.getElementById("page-loader");e&&(document.documentElement.classList.add("loaded"),o&&(o.style.display="none")),window.addEventListener("load",()=>{const a=document.querySelector("body > *:not(.page-loader)");a&&a.classList.add("content-fade-in"),setTimeout(()=>{document.documentElement.classList.add("loaded"),o&&o.classList.add("hidden"),document.body.style.overflow="auto",localStorage.setItem("hasVisitedBefore","true")},300)})}const K={_key:"DOLE-GIP-SECURE-KEY-2026",encrypt:function(e){try{const o=r=>r.split("").map(t=>t.charCodeAt(0)),a=r=>("0"+Number(r).toString(16)).substr(-2),s=r=>o(this._key).reduce((t,d)=>t^d,r);return e.split("").map(o).map(s).map(a).join("")}catch(o){return console.error("Encryption Failed",o),null}},decrypt:function(e){try{const o=s=>s.split("").map(r=>r.charCodeAt(0)),a=s=>o(this._key).reduce((r,t)=>r^t,s);return e.match(/.{1,2}/g).map(s=>parseInt(s,16)).map(a).map(s=>String.fromCharCode(s)).join("")}catch(o){return console.error("Decryption Failed",o),null}}};function Fe(){document.querySelectorAll(".login-form-shared").forEach(o=>{const a=o.querySelector('input[name="username"]'),s=o.querySelector('input[name="password"]'),r=o.querySelector('input[name="rememberMe"]');if(a&&s&&r){const t=localStorage.getItem("secure_user"),d=localStorage.getItem("secure_pass");if(t&&d){const n=K.decrypt(t),c=K.decrypt(d);n&&c&&(a.value=n,s.value=c,r.checked=!0)}}o.addEventListener("submit",async t=>{t.preventDefault();try{const n=await(await fetch(`${D()}api/auth.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:a.value,password:s.value})})).json();if(n.success){r.checked?(localStorage.setItem("secure_user",K.encrypt(a.value)),localStorage.setItem("secure_pass",K.encrypt(s.value))):(localStorage.removeItem("secure_user"),localStorage.removeItem("secure_pass"));const c=localStorage.getItem("hasLoggedInBefore")==="true";localStorage.setItem("isLoggedIn","true"),localStorage.setItem("hasLoggedInBefore","true"),localStorage.setItem("user",JSON.stringify(n.user));const l=document.getElementById("drawer-login");if(l){l.classList.add("translate-y-full");const i=l.querySelector("[data-drawer-hide]");i&&i.click()}await Be(c),Me(c)}else{const c=document.getElementById("drawer-login");c?(c.classList.add("translate-y-full"),setTimeout(()=>{ie(),setTimeout(()=>{c.classList.remove("translate-y-full"),s.value="",s.focus()},600)},400)):(ie(),s.value="",s.focus())}}catch(d){console.error("Login Error:",d),p.fire({icon:"error",title:"Login Error",text:"Unable to reach the server. Please check your connection."})}})})}function Me(e=!1){const o=document.getElementById("left-panel"),a=document.getElementById("right-panel"),s=document.getElementById("left-panel-content"),r=document.getElementById("right-panel-content");s&&(s.style.opacity="0"),r&&(r.style.opacity="0");const t=document.createElement("div");t.className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none";const d=e?"":"animate__delay-1s",n=e?"animation-duration: 0.8s;":"animation-duration: 2s;";t.innerHTML=`
        <img src="${D()}frontend/images/logo/doleiligan.png" class="w-64 h-64 md:w-96 md:h-96 object-contain bg-white/20 backdrop-blur-sm shadow-2xl rounded-full p-4 animate__animated animate__rotateOut ${d}" style="${n}" alt="DOLE Logo">
    `,document.body.appendChild(t);const c=e?0:1e3,l=e?600:1500;setTimeout(()=>{o&&o.classList.add("animate-slide-left"),a&&a.classList.add("animate-slide-right"),setTimeout(()=>{window.location.href=`${D()}frontend/dashboard/`},l)},c)}function Ge(){const e=document.getElementById("logoutBtn");e&&e.addEventListener("click",()=>{localStorage.removeItem("isLoggedIn"),window.location.href=`${D()}`})}function Ue(){const e=document.getElementById("mobile-splash"),o=document.getElementById("show-login-btn"),a=document.getElementById("back-to-splash"),s=document.getElementById("mobile-bg-content"),r=document.getElementById("mobile-welcome-text"),t=document.getElementById("reopen-login-drawer"),d=document.getElementById("request-notifications-btn"),n=async()=>{if("Notification"in window){const b=await Notification.requestPermission();console.log("Notification permission:",b),b==="granted"&&d&&d.classList.add("hidden")}};Notification.permission==="default"&&d&&(d.classList.remove("hidden"),d.addEventListener("click",n));const c=()=>{e&&(e.style.transform="translateY(-100%)",setTimeout(()=>{e.style.visibility="hidden",e.style.pointerEvents="none",e.style.zIndex="-1",Notification.permission==="default"&&n();const b=document.getElementById("drawer-login");b&&b.classList.remove("translate-y-full")},800))},l=()=>{e&&(e.style.zIndex="9999",e.style.pointerEvents="auto",e.style.visibility="visible",e.style.transform="translateY(0)")};o&&o.addEventListener("click",c),document.querySelectorAll(".forgot-password-link").forEach(b=>{b.addEventListener("click",m=>{m.target.closest("#mobile-splash")&&c()})}),a&&a.addEventListener("click",()=>{const b=document.getElementById("drawer-login");if(b){b.classList.add("translate-y-full");const m=b.querySelector("[data-drawer-hide]");m&&m.click()}l()});const g=document.getElementById("drawer-login"),f=document.getElementById("curved-welcome"),x=document.getElementById("peoples-bg");g&&new MutationObserver(m=>{m.forEach(I=>{I.attributeName==="class"&&(g.classList.contains("translate-y-full")?(s&&(s.style.transform="translateY(0)"),r&&(r.style.opacity="1",r.style.transform="translateY(0) scale(1)"),f&&(f.style.opacity="0",f.style.transform="scale(0.5)"),t&&e&&e.style.visibility==="hidden"&&(t.style.opacity="1",t.style.transform="scale(1)"),x&&(x.classList.add("opacity-0","scale-0"),x.classList.remove("opacity-40","scale-[1.6]"))):(s&&(s.style.transform="translateY(-35%)"),r&&(r.style.opacity="0",r.style.transform="translateY(20px) scale(0.9)"),f&&(f.style.opacity="1",f.style.transform="scale(1)"),t&&(t.style.opacity="0",t.style.transform="scale(0)"),x&&(x.classList.remove("opacity-0","scale-0"),x.classList.add("opacity-40","scale-[1.6]"))))})}).observe(g,{attributes:!0})}export{ue as _,re as a,Re as b,oe as c,Oe as d,Ne as e,Fe as f,D as g,Ge as h,qe as i,Ue as j,_e as k,W as l,ke as p,Te as r,Pe as s,Ie as u};
