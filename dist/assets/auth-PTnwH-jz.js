const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vendor-flowbite-B2TFTxm5.js","assets/vendor-DC5wud4b.js"])))=>i.map(i=>d[i]);
import u from"./vendor-swal-BSk0fVSb.js";const F="color-theme",ge=3600*24*365;function fe(e,o,a){document.cookie=`${e}=${o}; max-age=${a}; path=/; SameSite=Lax`}function ae(e){const o=document.cookie.match(new RegExp("(?:^|; )"+e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"=([^;]*)"));return o?decodeURIComponent(o[1]):null}function se(){const e=localStorage.getItem(F)||ae(F);return e==="dark"||e==="light"?e:"light"}function X(e){const o=document.documentElement;e==="dark"?o.classList.add("dark"):o.classList.remove("dark"),localStorage.setItem(F,e),fe(F,e,ge),be(e),document.dispatchEvent(new CustomEvent("themeChanged",{detail:{theme:e}}))}function K(){const e=se();X(e==="dark"?"light":"dark")}function be(e){const o=e==="dark",a=document.getElementById("pref-dark-mode");a&&(a.checked=o);const n=document.getElementById("theme-toggle-dark-icon"),r=document.getElementById("theme-toggle-light-icon");n&&r&&(n.classList.toggle("hidden",o),r.classList.toggle("hidden",!o));const t=document.getElementById("sidebar-theme-label");t&&(t.textContent=o?"Light Mode":"Dark Mode")}function Be(){const e=se();X(e);const o=document.getElementById("pref-dark-mode");o&&o.addEventListener("change",()=>{X(o.checked?"dark":"light")});const a=document.getElementById("theme-toggle-btn");a&&a.addEventListener("click",K),document.querySelectorAll("[data-theme-toggle]").forEach(n=>{n.addEventListener("click",K)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",n=>{localStorage.getItem(F)||ae(F)||X(n.matches?"dark":"light")})}function G(){return document.documentElement.classList.contains("dark")}window.toggleTheme=K;window.isDarkMode=G;const J={queue:[],currentIndex:0,isActive:!1,lastInteractionTime:0,init(){this.showUploadModal()},showUploadModal(){const e=G(),o={bgCard:e?"bg-slate-900/40":"bg-gray-50/40",borderCard:e?"border-slate-800":"border-gray-100",textHeading:e?"text-green-500":"text-[#2e7d32]",textSubtitle:e?"text-slate-500":"text-gray-400 dark:text-gray-300",bgUpload:e?"bg-slate-800":"bg-white",borderUpload:e?"border-slate-700":"border-gray-200",textUpload:e?"text-slate-400":"text-gray-500",hoverUpload:e?"hover:bg-slate-800/80 hover:border-blue-500":"hover:bg-blue-50/50 hover:border-royal-blue",iconText:e?"text-green-400":"text-[#2e7d32]",iconBg:e?"bg-green-900/20":"bg-[#e8f5e9]",iconBorder:e?"border-green-800/30":"border-[#c8e6c9]"},a=`
        ...
        `;u.fire({html:a,width:"600px",showConfirmButton:!1,showCloseButton:!0,customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},didOpen:n=>{const r=n.querySelector("#csv-upload"),t=n.querySelector('label[for="csv-upload"]');["dragenter","dragover","dragleave","drop"].forEach(s=>{t.addEventListener(s,i,!1)});function i(s){s.preventDefault(),s.stopPropagation()}["dragenter","dragover"].forEach(s=>{t.addEventListener(s,()=>{t.classList.add("border-blue-500","bg-blue-50/50"),e&&t.classList.add("dark:bg-slate-800/80")},!1)}),["dragleave","drop"].forEach(s=>{t.addEventListener(s,()=>{t.classList.remove("border-blue-500","bg-blue-50/50"),e&&t.classList.remove("dark:bg-slate-800/80")},!1)}),t.addEventListener("drop",s=>{const d=s.dataTransfer.files[0];d&&this.handleFile(d)},!1),r.addEventListener("change",s=>{const c=s.target.files[0];c&&this.handleFile(c)})}})},handleFile(e){if(!e.name.toLowerCase().endsWith(".csv")&&!e.name.toLowerCase().endsWith(".txt")){u.fire("Invalid File","Please upload a valid .csv or .txt file.","error");return}const o=new FileReader;o.onload=a=>{const n=a.target.result;this.parseCSV(n)},o.readAsText(e)},parseCSV(e){let o=[],a="",n=!1;for(let r=0;r<e.length;r++){let t=e[r];t==='"'&&(n=!n),!n&&(t===`
`||t==="\r")?(t==="\r"&&e[r+1]===`
`&&r++,a.trim()!==""&&o.push(a),a=""):a+=t}a.trim()!==""&&o.push(a),this.queue=[];for(let r=0;r<o.length;r++){let t=o[r].trim();if(!t)continue;let i=[],s="",c=!1;for(let d=0;d<t.length;d++){let l=t[d];l==='"'?c=!c:l===","&&!c?(i.push(s.replace(/(^"|"$)/g,"").trim()),s=""):s+=l}if(i.push(s.replace(/(^"|"$)/g,"").trim()),i.length>=10){const d=i[3];if(!d||isNaN(parseInt(d)))continue;const l=i[1];if(!l||l.toLowerCase()==="name"||l.toLowerCase()==="full name")continue;const b=i[2];let f=i[4]?i[4].toUpperCase().trim():"",h="";(f==="F"||f.includes("FEMALE"))&&(h="Female"),(f==="M"||f.includes("MALE"))&&(h="Male");const x=i[5],$=i[6],D=i[7],I=this.formatDate(i[8]),N=this.formatDate(i[9]);this.queue.push({name:l,address:b,age:d,gender:h,education:x,startDate:I,endDate:N,office:$,designation:D})}}this.queue.length>0?(this.isActive=!0,this.currentIndex=0,u.close(),this.processNext()):u.fire("Error","No valid beneficiary data found. Please ensure your CSV formatting matches the requirements.","error")},formatDate(e){if(!e||e.trim()==="")return"";const o=new Date(e);if(isNaN(o.getTime())){const t=e.split("/");return t.length===3?`${t[2]}-${t[1].padStart(2,"0")}-${t[0].padStart(2,"0")}`:""}const a=o.getFullYear(),n=String(o.getMonth()+1).padStart(2,"0"),r=String(o.getDate()).padStart(2,"0");return`${a}-${n}-${r}`},async processNext(){if(this.currentIndex<this.queue.length){const e=this.queue[this.currentIndex];try{const a=await(await fetch(`${B()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e.name})})).json();if(a.success&&a.exists)return console.warn(`%c[Bulk Add] SKIPPED: ${e.name} already exists in database.`,"color: #ff9800; font-weight: bold;"),this.currentIndex++,this.processNext()}catch(o){console.error("Duplicate check failed:",o)}e._isBulk=!0,e._bulkCurrent=this.currentIndex+1,e._bulkTotal=this.queue.length,de(e)}else this.isActive=!1,this.lastInteractionTime=Date.now(),u.fire({icon:"success",title:"Bulk Add Complete!",text:`Successfully processed ${this.queue.length} beneficiaries.`,confirmButtonColor:"#2e7d32"})},onSaveSuccess(){this.isActive&&(this.currentIndex++,setTimeout(()=>{this.processNext()},3500))},onCancel(){this.isActive&&(this.isActive=!1,this.lastInteractionTime=Date.now(),this.queue=[],this.currentIndex=0,u.fire({icon:"info",title:"Bulk Add Cancelled",text:"Stopped processing the remaining beneficiaries and cleared the queue.",confirmButtonColor:"#3085d6"}).then(()=>{this.showUploadModal()}))}};window.BulkApp=J;const xe="modulepreload",he=function(e){return"/"+e},Q={},ne=function(o,a,n){let r=Promise.resolve();if(a&&a.length>0){let c=function(d){return Promise.all(d.map(l=>Promise.resolve(l).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),s=i?.nonce||i?.getAttribute("nonce");r=c(a.map(d=>{if(d=he(d),d in Q)return;Q[d]=!0;const l=d.endsWith(".css"),b=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${b}`))return;const f=document.createElement("link");if(f.rel=l?"stylesheet":xe,l||(f.as="script"),f.crossOrigin="",f.href=d,s&&f.setAttribute("nonce",s),document.head.appendChild(f),l)return new Promise((h,x)=>{f.addEventListener("load",h),f.addEventListener("error",()=>x(new Error(`Unable to preload CSS for ${d}`)))})}))}function t(i){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=i,window.dispatchEvent(s),!s.defaultPrevented)throw i}return r.then(i=>{for(const s of i||[])s.status==="rejected"&&t(s.reason);return o().catch(t)})};function Z(e){if(!e)return"";const o=new Date(e),a=new Date;let n=a.getFullYear()-o.getFullYear();const r=a.getMonth()-o.getMonth();return(r<0||r===0&&a.getDate()<o.getDate())&&n--,n>=0?n:0}function ee(e){return e?e.includes("DOLE")?"bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-800":e.includes("DepEd")?"bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800":e.includes("LGU")?"bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-800":e.includes("DICT")?"bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-800":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300"}function me(e){if(!e)return"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300";const o=e.toUpperCase();return o==="ONGOING"?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800":o==="EXPIRED"?"bg-red-400 text-white border-red-400 dark:bg-red-900/60 dark:border-red-800":o==="RESIGNED"?"bg-[#ce1126] text-white border-[#ce1126] dark:bg-red-900/80 dark:border-red-900":o==="ABSORBED"?"bg-[#2e7d32] text-white border-[#2e7d32] dark:bg-green-900/80 dark:border-green-900":"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300"}function te(e,o=0){let a=o;const n=e.arLogs||[],r=e.dtrLogs||[],t=e.docs||[],i=["GIP FORM","BIRTH CERTIFICATE","DIPLOMA","TOR","VALID ID"],s=i.map(l=>{const b=t.find(f=>f.name.toUpperCase()===l.toUpperCase());return b||{name:l,status:"PENDING",id:null}});t.forEach(l=>{i.some(f=>f.toUpperCase()===l.name.toUpperCase())||s.push(l)});const c=`
<div class="border-b border-default pb-4 mb-5 flex flex-col relative w-full pt-4 font-montserrat user-select-none">
    ...
    <div class="grid grid-cols-2 gap-4 mt-6 w-full">
        ...
        <div class="flex flex-col gap-1 text-left overflow-hidden">
            ...
            <div class="flex items-center flex-wrap gap-1.5 min-h-[30px]">
                ...
                <span class="${ee(e.office)} hidden sm:inline-block text-[9px] font-black px-2.5 py-1 rounded-full border shadow-sm truncate max-w-[120px] lg:max-w-none" title="${e.office}">${e.office}</span>
            </div>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-1 text-left mt-4 sm:hidden">
        ...
        <span class="${ee(e.office)} text-[10px] font-black px-2.5 py-2 rounded border border-gray-200 dark:border-slate-700 uppercase tracking-widest shadow-sm border-l-4 border-l-indigo-500 w-full truncate" title="${e.office}">${e.office}</span>
    </div>
</div>
...
<div class="flex flex-col gap-4 text-sm mt-3 px-1">
    ...
    <div class="flex justify-between items-center group">
        ...
        <span class="${e.age||Z(e.birthday)?"font-black text-heading":"font-bold text-gray-300 italic"} text-right">${e.age||Z(e.birthday)||"N/A"}</span>
    </div>
    <div class="flex justify-between items-center group">
...
<div class="mt-8 pt-6 border-t border-default relative">
    ...
    <div id="drawer-page-1" class="hidden flex-1 flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-3">
            ${s.map(l=>{const b=l.status.toUpperCase(),h={VERIFIED:"COMPLETED",DECLINED:"REJECTED",PENDING:"PENDING"}[b]||b,x=h==="COMPLETED",$=h==="REJECTED",D=x?"text-green-500":$?"text-red-500":"text-gray-400 dark:text-gray-500",I=x?"bg-green-50/50 dark:bg-green-900/10":$?"bg-red-50/50 dark:bg-red-900/10":"bg-gray-50/50 dark:bg-slate-800/50",N=x?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800 hover:bg-green-200 cursor-pointer":$?"bg-red-100 text-red-700 border-red-200 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800 hover:bg-red-200 cursor-pointer":"bg-white text-gray-500 border-gray-200 dark:bg-slate-700 dark:text-gray-400 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-600 cursor-pointer";let A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';return x?A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>':$&&(A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"></path></svg>'),`
                <div class="flex items-center justify-between p-3.5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm transition-all hover:-translate-y-0.5 ${I}">
                    ...
                    <button type="button" class="ml-3 ${N} text-[10px] font-black px-3 py-1.5 rounded-full border uppercase tracking-widest transition-colors flex-shrink-0 drawer-doc-btn" data-id="${l.id}" data-name="${l.name}" data-status="${h} cursosr-pointer">
                        ${h}
                    </button>
                </div>
                `}).join("")}
...
<style>
    ...
    `;let d=document.getElementById("beneficiary-drawer-container");d&&d.remove(),d=document.createElement("div"),d.id="beneficiary-drawer-container",d.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-neutral-primary-soft dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl",d.setAttribute("tabindex","-1"),d.setAttribute("data-drawer-backdrop","true"),d.innerHTML=c,document.body.appendChild(d),ne(async()=>{const{Drawer:l}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:l}},__vite__mapDeps([0,1])).then(({Drawer:l})=>{const b={placement:"right",backdrop:!0,bodyScrolling:!1,edge:!1,edgeOffset:"",backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{d&&d.parentNode&&d.remove()},300)}},f=new l(d,b);f.show(),d.querySelector("#close-drawer-btn").addEventListener("click",()=>f.hide());const x=d.querySelector("#drawer-prev-btn"),$=d.querySelector("#drawer-next-btn"),D=2,I=()=>{d.querySelectorAll("[id^=drawer-page-]").forEach((w,S)=>{w.classList.toggle("hidden",S!==a)}),x.disabled=a===0,$.disabled=a===D,x.classList.toggle("opacity-50",a===0),$.classList.toggle("opacity-50",a===D)};x.addEventListener("click",()=>{a>0&&a--,I()}),$.addEventListener("click",()=>{a<D&&a++,I()}),I(),d.querySelectorAll(".drawer-doc-btn").forEach(w=>{w.addEventListener("click",async()=>{const S=w.dataset.name,E=w.dataset.status,C=await u.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Update Document</span>',html:`
                    ...
                    `,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest">Update</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest">Cancel</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>document.getElementById("swal-doc-status").value});if(C.isConfirmed){const v=C.value;if(v===E)return;try{const L=new FormData;L.append("gip_id",e.id),L.append("doc_name",S);const g={COMPLETED:"VERIFIED",REJECTED:"DECLINED",PENDING:"PENDING"}[v]||v;L.append("status",g);const k=await(await fetch(`${B()}api/logs.php?type=docs`,{method:"POST",body:L})).text();let y={success:!1};try{y=JSON.parse(k)}catch{}y.success?(u.fire({toast:!0,position:"top-end",icon:"success",title:"Status updated!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):u.fire("Error",y.error||"Failed to update","error")}catch(L){u.fire("Error",L.message,"error")}}})});const N=()=>{if(!r.length)return new Date().toISOString().split("T")[0];const w=new Date(r[0].date);return w.setDate(w.getDate()+1),w.toISOString().split("T")[0]},A=()=>{if(!n.length){const C=new Date,v=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"][C.getMonth()];return C.getDate()<=15?`${v} 1-15`:`${v} 16-${new Date(C.getFullYear(),C.getMonth()+1,0).getDate()}`}const w=n[0].period||"",S=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],E=w.toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+)/);if(E){let C=E[1],v=parseInt(E[2]),L=S.indexOf(C);if(L!==-1)return v===1?`${C} 16-${new Date(new Date().getFullYear(),L+1,0).getDate()}`:`${S[(L+1)%12]} 1-15`}return"NEW PERIOD"},U=async(w,S)=>{u.fire({title:"Adding...",allowOutsideClick:!1,showConfirmButton:!1}),u.showLoading();try{const E=new FormData;E.append("gip_id",e.id),w==="dtr"&&E.append("record_date",S),w==="ar"&&E.append("period",S),(await(await fetch(`${B()}api/logs.php?type=${w}`,{method:"POST",body:E})).json()).success?(u.fire({toast:!0,position:"top-end",icon:"success",title:"Auto-Added!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):u.fire("Error","Failed to add log.","error")}catch(E){u.fire("Error",E.message,"error")}},Y=async(w,S,E,C)=>{const v=S==="dtr"?"Record Date":"Period",{value:L}=await u.fire({title:`<span class="text-xl font-black text-heading uppercase tracking-tight">Edit ${w} Log</span>`,html:`
                    <div class="flex flex-col gap-4 text-left font-montserrat mt-2">
                        <div>
                            <label class="text-[10px] font-bold text-gray-500 uppercase tracking-widest block mb-1">${v}</label>
                ...
                `,focusConfirm:!1,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest">SAVE REVISIONS</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest">CANCEL</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>({val:document.getElementById("swal-log-val").value.trim().toUpperCase()})});if(L&&L.val!==C)try{const p={type:S,id:E,status:"PENDING"};S==="dtr"&&(p.record_date=L.val),S==="ar"&&(p.period=L.val);const m=await(await fetch(`${B()}api/logs.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(p)})).json();m.success?(u.fire({toast:!0,position:"top-end",icon:"success",title:"Log Updated!",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):u.fire("Error",m.error||"Failed to update log.","error")}catch(p){u.fire("Error",p.message,"error")}},T=d.querySelector("#add-dtr-log-btn");T&&T.addEventListener("click",()=>U("dtr",N()));const R=d.querySelector("#add-ar-log-btn");R&&R.addEventListener("click",()=>U("ar",A())),d.querySelectorAll(".edit-log-btn").forEach(w=>{w.addEventListener("click",S=>{if(S.target.closest(".delete-log-btn"))return;const E=w.dataset.type,C=w.dataset.id,v=w.dataset.val;Y(E.toUpperCase(),E,C,v)})}),d.querySelectorAll(".delete-log-btn").forEach(w=>{w.addEventListener("click",async()=>{const S=w.dataset.id,E=w.dataset.type;if((await u.fire({title:'<span class="text-xl font-black text-philippine-red uppercase tracking-tight">Delete item?</span>',text:"This action cannot be undone.",icon:"warning",showCancelButton:!0,confirmButtonText:'<span class="font-black tracking-widest uppercase">Delete</span>',cancelButtonText:'<span class="font-black tracking-widest uppercase">Wait</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-philippine-red text-white hover:bg-red-700 text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1})).isConfirmed)try{const v=new FormData;v.append("log_id",S),v.append("action","delete");const p=await(await fetch(`${B()}api/logs.php?type=${E}`,{method:"POST",body:v})).text();let g={success:!1};try{g=JSON.parse(p)}catch{}g.success?(u.fire({toast:!0,position:"top-end",icon:"success",title:"Deleted",showConfirmButton:!1,timer:1500}),f.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):u.fire("Error","Failed to delete data.","error")}catch(v){u.fire("Error",v.message,"error")}})})}).catch(console.error)}function ve(e){const o=G(),a=`w-full bg-transparent border-b-2 ${o?"border-slate-700 text-white focus:border-brand placeholder-slate-600":"border-gray-200 text-gray-900 focus:border-brand placeholder-gray-300"} px-1 py-1 text-sm font-black outline-none transition-all focus:ring-0`,n=`w-full bg-transparent border-none ${o?"text-white":"text-royal-blue"} px-0 py-0 text-xl sm:text-2xl font-black leading-tight tracking-tight focus:ring-0 outline-none placeholder-gray-300 resize-none overflow-hidden`;function r(s){if(!s)return"";const c=new Date(s),d=new Date;let l=d.getFullYear()-c.getFullYear();const b=d.getMonth()-c.getMonth();return(b<0||b===0&&d.getDate()<c.getDate())&&l--,l>=0?l:0}const t=`
<form id="edit-beneficiary-drawer-form" class="h-full flex flex-col pt-4 font-montserrat relative pb-20">
    ...
    <div class="flex flex-col relative w-full border-b border-default pb-4 mb-5 pe-12">
        <textarea name="name" class="${n}" rows="1" placeholder="Beneficiary Name" required oninput="this.style.height = ''; this.style.height = this.scrollHeight + 'px'">${e.name||""}</textarea>
    ...
    <div class="flex flex-col gap-1 text-left mt-4 mb-4">
        ...
        <select name="office" class="bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-[10px] sm:text-[11px] font-black px-2.5 py-2.5 rounded-lg border border-indigo-200 dark:border-indigo-800/60 uppercase tracking-widest shadow-sm outline-none focus:ring-2 focus:ring-brand w-full cursor-pointer">
            <option value="DOLE Field Office" ${e.office==="DOLE Field Office"?"selected":""}>DOLE Field Office</option>
            <option value="LGU" ${e.office==="LGU"?"selected":""}>LGU</option>
            <option value="DEPED" ${e.office==="DEPED"?"selected":""}>DEPED</option>
            <option value="DICT" ${e.office==="DICT"?"selected":""}>DICT</option>
            <option value="PCA" ${e.office==="PCA"?"selected":""}>PCA</option>
        </select>
    </div>
    ...
    <div class="flex flex-col gap-4 text-sm mt-3 px-1">
        ...
        <div class="flex justify-between items-center group">
            ...
            <input type="text" name="age" id="edit-age-display" value="${e.age||r(e.birthday)||""}" class="${a} text-right max-w-[80px]" readonly placeholder="Auto">
        </div>
        ...
        <div class="flex flex-col gap-2 pt-3 mt-1 border-t border-gray-50 dark:border-slate-800/60">
            ...
            <datalist id="course-suggestions">
                ${le.map(s=>`<option value="${s.name}"></option>`).join("")}
            </datalist>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-4 text-sm mt-4 px-1">
        ...
        <div class="flex flex-col gap-2">
            ...
            <datalist id="work-suggestions">
                ${ie.map(s=>`<option value="${s}"></option>`).join("")}
            </datalist>
        </div>
...
.text-right-select { text-align-last: right; }
    ...
    `;let i=document.getElementById("edit-drawer-container");i&&i.remove(),i=document.createElement("div"),i.id="edit-drawer-container",i.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-white dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl pb-0",i.setAttribute("tabindex","-1"),i.innerHTML=t,document.body.appendChild(i),setTimeout(()=>{const s=i.querySelector('textarea[name="name"]');s&&(s.style.height="auto",s.style.height=s.scrollHeight+"px")},10),ne(async()=>{const{Drawer:s}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:s}},__vite__mapDeps([0,1])).then(({Drawer:s})=>{const c=new s(i,{placement:"right",backdrop:!0,bodyScrolling:!1,backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{i.parentNode&&i.remove()},300)}});c.show(),i.querySelector("#close-edit-drawer-btn").addEventListener("click",()=>c.hide()),i.querySelector("#edit-drawer-cancel-btn").addEventListener("click",()=>c.hide());const d=i.querySelector("#edit-bday-input"),l=i.querySelector("#edit-age-display");d&&l&&d.addEventListener("change",f=>{f.target.value&&(l.value=r(f.target.value))});const b=i.querySelector("#edit-beneficiary-drawer-form");b.addEventListener("submit",f=>{f.preventDefault();const h=new FormData(b),x={};h.forEach(($,D)=>x[D]=$),x.id=e.id,x.gip_id=e.id,window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(x,!0,!1)){c.hide();const D=document.querySelector("#close-drawer-btn");D&&D.click(),u.fire({toast:!0,position:"top-end",icon:"success",title:"Record Updated",showConfirmButton:!1,timer:3e3})}})()})})}function re(e="Incorrect Username or Password"){u.fire({html:`
            <div class="p-6">
        ...
        `,timer:e?800:3e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1,width:"350px",padding:"0",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-hidden border border-gray-100",timerProgressBar:"bg-green-500 h-1.5"},backdrop:"rgba(0, 0, 0, 0.4)"})}function De(){window.viewBeneficiary=async function(e,o=0){try{const[a,n,r]=await Promise.all([fetch(`${B()}api/logs.php?type=ar&gip_id=${encodeURIComponent(e.id)}`),fetch(`${B()}api/logs.php?type=dtr&gip_id=${encodeURIComponent(e.id)}`),fetch(`${B()}api/logs.php?type=docs&gip_id=${encodeURIComponent(e.id)}`)]),t=await a.json(),i=await n.json(),s=await r.json();e.arLogs=t.success?t.logs:[],e.dtrLogs=i.success?i.logs:[],e.docs=s.success?s.logs:[],te(e,o)}catch(a){console.error("Error fetching logs/docs:",a),e.arLogs=[],e.dtrLogs=[],e.docs=[],te(e,o)}},window.showAddDataModal=function(e){de(e)},window.editBeneficiary=function(e){ve(e)},window.showExportConfigModal=function(e){Ee(e)},window.showProfileModal=function(){ye()}}async function ye(){try{let e="";try{const n=JSON.parse(localStorage.getItem("user"));n&&n.id&&(e=`?user_id=${n.id}`)}catch{}const a=await(await fetch(`${B()}api/profile.php${e}`)).json();if(a.success){const n=a.profile;ke(n)}else u.fire({icon:"error",title:"Error",text:a.error||"Failed to load profile"})}catch(e){console.error("Error fetching profile:",e)}}function ke(e){const o=e.profile_picture_path?`${B()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(r=>r[0]).join("").substring(0,2).toUpperCase():"US",n=`
    ...
    `;u.fire({html:n,width:"450px",showConfirmButton:!1,showCloseButton:!0,padding:"1.5rem",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-visible ldn-modal-popup",closeButton:"focus:outline-none bg-gray-50 border-none swal2-custom-close cursor-pointer"},didOpen:r=>{const t=r.querySelector("#profile-edit-form"),i=r.querySelector("#profile-pic-input"),s=r.querySelector("#profile-avatar-preview");i.addEventListener("change",c=>{const d=c.target.files[0];if(d){const l=new FileReader;l.onload=b=>{s.innerHTML=`<img src="${b.target.result}" class="w-full h-full object-cover" />`},l.readAsDataURL(d)}}),t.addEventListener("submit",async c=>{c.preventDefault();const d=new FormData(t);try{const l=JSON.parse(localStorage.getItem("user"));l&&l.id&&d.append("user_id",l.id)}catch{}try{const b=await(await fetch(`${B()}api/profile.php`,{method:"POST",body:d})).json();b.success?(b.profile&&(localStorage.setItem("user",JSON.stringify(b.profile)),$e(b.profile)),u.close(),u.fire({toast:!0,position:"top-end",icon:"success",title:"Profile Updated",showConfirmButton:!1,timer:3e3,timerProgressBar:!0})):u.fire({icon:"error",title:"Update Failed",text:b.error||"Something went wrong"})}catch(l){console.error("Error saving profile:",l)}})}})}function $e(e){const o=e.profile_picture_path?`${B()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(t=>t[0]).join("").substring(0,2).toUpperCase():"US",n=document.querySelectorAll(".sidebar-user-name"),r=document.querySelectorAll(".sidebar-user-avatar");n.forEach(t=>t.textContent=e.full_name),r.forEach(t=>{o?t.innerHTML=`<img src="${o}" class="w-full h-full object-cover" />`:t.textContent=a}),localStorage.setItem("user_full_name",e.full_name),o&&localStorage.setItem("user_avatar",o)}function Ee(e){const o=window.getExportFilters?window.getExportFilters():{office:"ALL",status:"ALL",search:"",sort:"name",section:"ALL",columns:["id","name","office","position","startdate","enddate","status"],preparedBy:localStorage.getItem("ldn_export_prepared")||"",approvedBy:localStorage.getItem("ldn_export_approved")||""},a=`
        <div class="text-left font-montserrat p-1 overflow-visible">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-royal-blue/10 rounded-2xl flex items-center justify-center">
            ...
            <form id="export-config-form" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-100/50">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-1.5">
                                ${["ALL","ONGOING","ABSORBED","RESIGNED","EXPIRED"].map(n=>{const r={ALL:"peer-checked:bg-blue-600",ONGOING:"peer-checked:bg-green-500",ABSORBED:"peer-checked:bg-teal-600",RESIGNED:"peer-checked:bg-gray-700",EXPIRED:"peer-checked:bg-red-600"};return`
                                        <label class="cursor-pointer">
                                            <input type="radio" name="export-status" value="${n}" ${o.status===n?"checked":""} class="hidden peer">
                                            <span class="px-2.5 py-1.5 rounded-lg border border-gray-100 bg-white text-[9px] font-black text-gray-400 dark:!text-white uppercase tracking-widest ${r[n]} peer-checked:text-white peer-checked:border-transparent transition-all block shadow-sm">${n}</span>
                                        </label>
                                    `}).join("")}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-1.5">
                                ${[{id:"ALL",label:"All",color:"peer-checked:bg-emerald-600"},{id:"ACTIVE",label:"Active",color:"peer-checked:bg-green-500"},{id:"ARCHIVED",label:"Archived",color:"peer-checked:bg-red-600"}].map(n=>`
                                    <label class="cursor-pointer flex-1">
                                        <input type="radio" name="export-section" value="${n.id}" ${o.section===n.id?"checked":""} class="hidden peer">
                                        <div class="py-1.5 bg-white border border-gray-100 rounded-lg flex items-center justify-center gap-1.5 transition-all ${n.color} peer-checked:text-white peer-checked:border-transparent shadow-sm">
                                            <span class="text-[9px] font-black uppercase tracking-tight">${n.label}</span>
                                        </div>
                                    </label>
                                `).join("")}
                            </div>
                ...
                <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        ${["ID","Name","Office","Position","Start Date","End Date","Status"].map(n=>{const r=n.toLowerCase().replace(" ",""),t=o.columns.includes(r),i=`col-switch-${r}`;return`
                                <label for="${i}" class="flex items-center gap-2 px-3 py-2 bg-white border border-gray-100 rounded-lg cursor-pointer hover:border-emerald-500/30 transition-all group select-none shadow-sm">
                                    <div class="relative flex items-center shrink-0 scale-90">
                                        <input type="checkbox" id="${i}" name="export-column" value="${r}" ${t?"checked":""} class="sr-only peer">
                                    ...
                                    <span class="text-[9px] font-black text-gray-600 uppercase tracking-tight group-hover:text-emerald-600">${n}</span>
                                </label>
                            `}).join("")}
                    </div>
                </div>
                            ...
                            <div class="group">
                                ...
                                <div class="relative" id="office-container">
                                    ...
                                    <div id="office-suggestions" class="hidden absolute left-0 right-0 mt-2 ${t.bgSugg} border ${t.borderSugg} rounded-xl shadow-2xl z-[100] max-h-48 overflow-y-auto font-montserrat ${t.borderDivide} p-1.5">
                                        ${["DOLE Field Office","LGU","DEPED","DICT","PCA"].map(s=>`
                                ...
                                <div class="flex flex-wrap gap-2 p-1.5 ${t.bgStatusWrap} border ${t.borderStatus} rounded-xl shadow-inner flex-1">
                                    ${(()=>{const s={ONGOING:"peer-checked:bg-green-400 peer-checked:text-white peer-checked:border-green-400",EXPIRED:"peer-checked:bg-red-400 peer-checked:text-white peer-checked:border-red-400",RESIGNED:"peer-checked:bg-[#ce1126] peer-checked:text-white peer-checked:border-[#ce1126]",ABSORBED:"peer-checked:bg-[#2e7d32] peer-checked:text-white peer-checked:border-[#2e7d32]"};return["ONGOING","EXPIRED","RESIGNED","ABSORBED"].map(c=>`
                                            <label class="cursor-pointer relative min-w-[80px]">
                                                ...
                                                <span class="px-3 py-1.5 rounded-lg border border-transparent text-[10px] font-black text-gray-400 dark:text-white! uppercase tracking-widest ${s[c]||""} transition-all block text-center cursor-pointer shadow-sm">
                                                    ${c}
                                                </span>
                                            </label>
                                        `).join("")})()}
    ...
    `;u.fire({html:i,width:window.innerWidth<1024?"96vw":"1000px",showConfirmButton:!1,showCloseButton:!1,padding:window.innerWidth<1024?"0.75rem":"2rem",customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},didOpen:s=>{const c=s.querySelector("#cancel-modal-btn");c&&c.addEventListener("click",()=>{!o&&!e?._isBulk&&localStorage.removeItem("add_beneficiary_draft"),u.close(),e?._isBulk&&J.onCancel()});const d=s.querySelector("#bulk-add-btn");d&&d.addEventListener("click",()=>{u.close(),J.init()});const l=s.querySelector("#birthday-input"),b=s.querySelector("#age-display");l&&b&&(l.addEventListener("change",p=>{p.target.value&&(b.value=oe(p.target.value))}),l.value&&!e?.age&&(b.value=oe(l.value)));const f=s.querySelector("#name-input-field"),h=s.querySelector("#duplicate-warning");if(f&&h){let p;f.addEventListener("input",g=>{const m=g.target.value.trim();if(clearTimeout(p),m.length<3){h.classList.add("hidden");return}p=setTimeout(async()=>{try{const y=await(await fetch(`${B()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:m})})).json();y.success&&y.exists?(h.classList.remove("hidden"),G()?h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600"):h.classList.add("hidden")}catch(k){console.error("Duplicate check error:",k)}},500)}),e?.name&&(h.classList.add("hidden"),(async()=>{const m=await(await fetch(`${B()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e.name})})).json();m.success&&m.exists&&(h.classList.remove("hidden"),G()?h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600")})())}const x=s.querySelector("#full-id-input"),$=s.querySelector("#series-no-input"),D=s.querySelector('input[name="startDate"]'),I=s.querySelector('input[name="endDate"]'),N=s.querySelectorAll('input[name="remarks"]'),A=s.querySelector("#extension-log-container"),U=p=>{o||(x&&(x.classList.add("animate-pulse"),x.placeholder="Loading...",fetch(`${B()}api/beneficiaries.php?next_id&year=${p}`).then(g=>g.json()).then(g=>{x.classList.remove("animate-pulse"),g.success&&g.nextId&&(x.value=g.nextId)})),$&&($.classList.add("animate-pulse"),$.placeholder="Loading...",fetch(`${B()}api/beneficiaries.php?next_series_no&year=${p}`).then(g=>g.json()).then(g=>{$.classList.remove("animate-pulse"),g.success&&g.nextSeries&&($.value=g.nextSeries)})))},Y=()=>{const p=s.querySelector('input[name="remarks"]:checked');return p?p.value:"ONGOING"},T=p=>{const g=s.querySelector(`input[name="remarks"][value="${p}"]`);g&&(g.checked=!0,w())},R=()=>{if(I&&I.value){const p=I.value.split("-"),g=new Date(p[0],p[1]-1,p[2]),m=new Date;m.setHours(0,0,0,0);let k="ONGOING";g<m&&(k="EXPIRED"),T(k)}},w=()=>{if(!A)return;if(Y()==="ABSORBED"){const g=e?.absorbDate||new Date().toLocaleString("en-US",{timeZone:"Asia/Manila",month:"short",day:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});A.innerHTML=`
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                                <div class="${r?"bg-green-900/10 border-green-900/30":"bg-[#e8f5e9]/50 border-[#c8e6c9]"} rounded-lg p-2.5 flex items-center justify-between border">
                                    <div>
                                        ...
                                        <p class="text-[10px] font-black ${r?"text-green-400":"text-[#1b5e20]"} uppercase">${g}</p>
                                        <input type="hidden" name="absorbDate" value="${g}">
                                    </div>
                    ...
                    `}else A.innerHTML=""};if(D&&(D.addEventListener("change",p=>{const g=p.target.value;if(g){const m=new Date(g).getFullYear();if(U(m),I&&!I.value){const k=new Date(g);k.setMonth(k.getMonth()+1),I.value=k.toISOString().split("T")[0]}R()}}),!o)){const p=D.value?new Date(D.value).getFullYear():new Date().getFullYear();U(p)}I&&I.addEventListener("change",R),N.forEach(p=>p.addEventListener("change",w));const S=s.querySelector("#resign-btn"),E=s.querySelector("#absorb-btn");S&&S.addEventListener("click",()=>T("RESIGNED")),E&&E.addEventListener("click",()=>T("ABSORBED")),s.querySelectorAll('input[type="text"], textarea').forEach(p=>{["id-number-input","full-id-input"].includes(p.id)||p.addEventListener("input",()=>{const g=p.selectionStart,m=p.selectionEnd;p.value=p.value.toUpperCase(),p.setSelectionRange(g,m)})}),R(),w(),C("education-input","course-suggestions","course-option"),C("designation-input","work-suggestions","work-option"),C("office-input","office-suggestions","office-option");function C(p,g,m){const k=s.querySelector(`#${p}`),y=s.querySelector(`#${g}`);!k||!y||(k.addEventListener("focus",()=>y.classList.remove("hidden")),document.addEventListener("click",M=>{!k.contains(M.target)&&!y.contains(M.target)&&y.classList.add("hidden")}),k.addEventListener("input",()=>{const M=k.value.toLowerCase(),j=y.querySelectorAll(`.${m}`);let z=!1;j.forEach(P=>{const H=P.querySelector(".option-text");(H?H.innerText:P.innerText).toLowerCase().includes(M)?(P.style.display="block",z=!0):P.style.display="none"}),z?y.classList.remove("hidden"):y.classList.add("hidden")}),y.querySelectorAll(`.${m}`).forEach(M=>{M.addEventListener("click",()=>{const j=M.querySelector(".option-text");k.value=j?j.innerText.trim():M.innerText.trim(),y.classList.add("hidden"),k.dispatchEvent(new Event("change")),k.dispatchEvent(new Event("input"))})}))}const v=s.querySelector("#add-beneficiary-form"),L="add_beneficiary_draft";if(!o){const p=localStorage.getItem(L);if(p)try{const g=JSON.parse(p);Object.entries(g).forEach(([m,k])=>{const y=v.elements[m];y&&y.type!=="file"&&y.type!=="hidden"&&(y.value=k)})}catch(g){console.error("Error loading draft",g)}}v.addEventListener("input",p=>{if(!o){const g=new FormData(v),m={};g.forEach((k,y)=>m[y]=k),localStorage.setItem(L,JSON.stringify(m))}}),v&&v.addEventListener("submit",p=>{p.preventDefault(),v.querySelectorAll('input:not([type="hidden"]), select, textarea').forEach(_=>{_.classList.remove("ring-2","ring-red-500","!border-red-500")});const m=new FormData(v);let k=!1;const y=_=>{const q=v.querySelector(`[name="${_}"]`);q&&q.classList.add("ring-2","ring-red-500","!border-red-500"),k=!0},M=m.get("name"),j=m.get("contact"),z=m.get("startDate"),P=m.get("endDate"),H=m.get("designation");if((!M||M.trim()===""||/[0-9]/.test(M))&&y("name"),j&&j.trim()!==""&&/[^0-9]/.test(j.replace(/[\s\-\+\(\)]/g,""))&&y("contact"),z||y("startDate"),P||y("endDate"),(!H||H.trim()==="")&&y("designation"),k)return;const O={};m.forEach((_,q)=>{O[q]=_});const V=s.querySelector("#full-id-input")?.value;o?(O.id=e?.id,V&&(O.gip_id=V)):(O.id=null,V&&(O.gip_id=V)),window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(O)){if(!o){const q="add_beneficiary_draft",ce=v.querySelector('[name="office"]')?.value||"",pe=v.querySelector('[name="designation"]')?.value||"",ue=v.querySelector('[name="education"]')?.value||"";localStorage.setItem(q,JSON.stringify({office:ce,designation:pe,education:ue}))}u.close(),setTimeout(()=>{u.fire({toast:!0,position:"top-end",icon:"success",title:`Record ${o?"Updated":"Added"} Successfully`,showConfirmButton:!1,timer:3e3,timerProgressBar:!0}),!o&&e?._isBulk&&J.onSaveSuccess()},100)}else u.fire({icon:"error",title:"Save Failed",text:"There was an error saving the record to the database."})})()})}})}window.handleContactSubmit=async function(e){e.preventDefault();const o=e.target,a=o.querySelector('button[type="submit"]'),n=a.innerHTML;a.disabled=!0,a.innerHTML=`
        <svg class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        </svg>
        Sending...
    `;try{const r=new FormData(o);if((await fetch(o.action,{method:"POST",body:r,headers:{Accept:"application/json"}})).ok)u.fire({toast:!0,position:"top-end",icon:"success",title:"Message Sent Successfully!",text:"Thank you for reaching out. I will get back to you soon!",showConfirmButton:!1,timer:4e3,timerProgressBar:!0,didOpen:i=>{i.addEventListener("mouseenter",u.stopTimer),i.addEventListener("mouseleave",u.resumeTimer)},customClass:{popup:"rounded-2xl border-l-4 border-teal-500 shadow-2xl"}}),o.reset();else throw new Error("Failed to send")}catch{u.fire({toast:!0,position:"top-end",icon:"error",title:"Oops! Something went wrong.",text:"Could not send your message. Please try again later.",showConfirmButton:!1,timer:4e3,customClass:{popup:"rounded-2xl border-l-4 border-red-500 shadow-2xl"}})}finally{a.disabled=!1,a.innerHTML=n}return!1};function B(){const e=window.location.pathname,o="/dole-system/",a=e.toLowerCase().indexOf(o.toLowerCase());return a!==-1?e.substring(0,a+o.length):"/"}function Le(){const e=localStorage.getItem("hasVisitedBefore"),o=document.getElementById("page-loader");e&&(document.documentElement.classList.add("loaded"),o&&(o.style.display="none")),window.addEventListener("load",()=>{const a=document.querySelector("body > *:not(.page-loader)");a&&a.classList.add("content-fade-in"),setTimeout(()=>{document.documentElement.classList.add("loaded"),o&&o.classList.add("hidden"),document.body.style.overflow="auto",localStorage.setItem("hasVisitedBefore","true")},300)})}const W={_key:"DOLE-GIP-SECURE-KEY-2026",encrypt:function(e){try{const o=r=>r.split("").map(t=>t.charCodeAt(0)),a=r=>("0"+Number(r).toString(16)).substr(-2),n=r=>o(this._key).reduce((t,i)=>t^i,r);return e.split("").map(o).map(n).map(a).join("")}catch(o){return console.error("Encryption Failed",o),null}},decrypt:function(e){try{const o=n=>n.split("").map(r=>r.charCodeAt(0)),a=n=>o(this._key).reduce((r,t)=>r^t,n);return e.match(/.{1,2}/g).map(n=>parseInt(n,16)).map(a).map(n=>String.fromCharCode(n)).join("")}catch(o){return console.error("Decryption Failed",o),null}}};function Ie(){document.querySelectorAll(".login-form-shared").forEach(o=>{const a=o.querySelector('input[name="username"]'),n=o.querySelector('input[name="password"]'),r=o.querySelector('input[name="rememberMe"]');if(a&&n&&r){const t=localStorage.getItem("secure_user"),i=localStorage.getItem("secure_pass");if(t&&i){const s=W.decrypt(t),c=W.decrypt(i);s&&c&&(a.value=s,n.value=c,r.checked=!0)}}o.addEventListener("submit",async t=>{t.preventDefault();try{const s=await(await fetch(`${B()}api/auth.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:a.value,password:n.value})})).json();if(s.success){r.checked?(localStorage.setItem("secure_user",W.encrypt(a.value)),localStorage.setItem("secure_pass",W.encrypt(n.value))):(localStorage.removeItem("secure_user"),localStorage.removeItem("secure_pass"));const c=localStorage.getItem("hasLoggedInBefore")==="true";localStorage.setItem("isLoggedIn","true"),localStorage.setItem("hasLoggedInBefore","true"),localStorage.setItem("user",JSON.stringify(s.user));const d=document.getElementById("drawer-login");if(d){d.classList.add("translate-y-full");const l=d.querySelector("[data-drawer-hide]");l&&l.click()}await we(c),Se(c)}else{const c=document.getElementById("drawer-login");c?(c.classList.add("translate-y-full"),setTimeout(()=>{re(),setTimeout(()=>{c.classList.remove("translate-y-full"),n.value="",n.focus()},600)},400)):(re(),n.value="",n.focus())}}catch(i){console.error("Login Error:",i),u.fire({icon:"error",title:"Login Error",text:"Unable to reach the server. Please check your connection."})}})})}function Se(e=!1){const o=document.getElementById("left-panel"),a=document.getElementById("right-panel"),n=document.getElementById("left-panel-content"),r=document.getElementById("right-panel-content");n&&(n.style.opacity="0"),r&&(r.style.opacity="0");const t=document.createElement("div");t.className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none";const i=e?"":"animate__delay-1s",s=e?"animation-duration: 0.8s;":"animation-duration: 2s;";t.innerHTML=`
        <img src="${B()}frontend/images/logo/doleiligan.png" class="w-64 h-64 md:w-96 md:h-96 object-contain bg-white/20 backdrop-blur-sm shadow-2xl rounded-full p-4 animate__animated animate__rotateOut ${i}" style="${s}" alt="DOLE Logo">
    `,document.body.appendChild(t);const c=e?0:1e3,d=e?600:1500;setTimeout(()=>{o&&o.classList.add("animate-slide-left"),a&&a.classList.add("animate-slide-right"),setTimeout(()=>{window.location.href=`${B()}frontend/dashboard/`},d)},c)}function Me(){const e=document.getElementById("logoutBtn");e&&e.addEventListener("click",()=>{localStorage.removeItem("isLoggedIn"),window.location.href=`${B()}`})}function Ae(){const e=document.getElementById("mobile-splash"),o=document.getElementById("show-login-btn"),a=document.getElementById("back-to-splash"),n=document.getElementById("mobile-bg-content"),r=document.getElementById("mobile-welcome-text"),t=document.getElementById("reopen-login-drawer"),i=document.getElementById("request-notifications-btn"),s=async()=>{if("Notification"in window){const x=await Notification.requestPermission();console.log("Notification permission:",x),x==="granted"&&i&&i.classList.add("hidden")}};Notification.permission==="default"&&i&&(i.classList.remove("hidden"),i.addEventListener("click",s));const c=()=>{e&&(e.style.transform="translateY(-100%)",setTimeout(()=>{e.style.visibility="hidden",e.style.pointerEvents="none",e.style.zIndex="-1",Notification.permission==="default"&&s();const x=document.getElementById("drawer-login");x&&x.classList.remove("translate-y-full")},800))},d=()=>{e&&(e.style.zIndex="9999",e.style.pointerEvents="auto",e.style.visibility="visible",e.style.transform="translateY(0)")};o&&o.addEventListener("click",c),document.querySelectorAll(".forgot-password-link").forEach(x=>{x.addEventListener("click",$=>{$.target.closest("#mobile-splash")&&c()})}),a&&a.addEventListener("click",()=>{const x=document.getElementById("drawer-login");if(x){x.classList.add("translate-y-full");const $=x.querySelector("[data-drawer-hide]");$&&$.click()}d()});const b=document.getElementById("drawer-login"),f=document.getElementById("curved-welcome"),h=document.getElementById("peoples-bg");b&&new MutationObserver($=>{$.forEach(D=>{D.attributeName==="class"&&(b.classList.contains("translate-y-full")?(n&&(n.style.transform="translateY(0)"),r&&(r.style.opacity="1",r.style.transform="translateY(0) scale(1)"),f&&(f.style.opacity="0",f.style.transform="scale(0.5)"),t&&e&&e.style.visibility==="hidden"&&(t.style.opacity="1",t.style.transform="scale(1)"),h&&(h.classList.add("opacity-0","scale-0"),h.classList.remove("opacity-40","scale-[1.6]"))):(n&&(n.style.transform="translateY(-35%)"),r&&(r.style.opacity="0",r.style.transform="translateY(20px) scale(0.9)"),f&&(f.style.opacity="1",f.style.transform="scale(1)"),t&&(t.style.opacity="0",t.style.transform="scale(0)"),h&&(h.classList.remove("opacity-0","scale-0"),h.classList.add("opacity-40","scale-[1.6]"))))})}).observe(b,{attributes:!0})}export{ne as _,Be as a,Ie as b,Me as c,Ae as d,De as e,B as g,Le as i,$e as u};
