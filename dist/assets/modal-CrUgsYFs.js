...
import k from"./vendor-swal-BSk0fVSb.js";import{a as Re}from"./vendor-DHtNC8Ux.js";const Oe="true".toLowerCase()==="true";function De(){return Oe}function Y(){const e=window.location.pathname,o="/dole-system/",s=e.toLowerCase().indexOf(o.toLowerCase());if(s!==-1)return e.substring(0,s+o.length);const a=e.indexOf("/frontend/");if(a!==-1)return e.substring(0,a+1);const r=e.indexOf("/backend/");return r!==-1?e.substring(0,r+1):"/"}function we(e="Incorrect Username or Password"){k.fire({html:`
        ...
        `,timer:e?800:3e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1,width:"350px",padding:"0",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-hidden border border-gray-100",timerProgressBar:"bg-green-500 h-1.5"},backdrop:"rgba(0, 0, 0, 0.4)"})}function st(){const e=localStorage.getItem("hasVisitedBefore"),o=document.getElementById("page-loader");e&&(document.documentElement.classList.add("loaded"),o&&(o.style.display="none")),window.addEventListener("load",()=>{const s=document.querySelector("body > *:not(.page-loader)");s&&s.classList.add("content-fade-in"),setTimeout(()=>{document.documentElement.classList.add("loaded"),o&&o.classList.add("hidden"),document.body.style.overflow="auto",localStorage.setItem("hasVisitedBefore","true")},300)})}const de={_key:"DOLE-GIP-SECURE-KEY-2026",encrypt:function(e){try{const o=r=>r.split("").map(t=>t.charCodeAt(0)),s=r=>("0"+Number(r).toString(16)).substr(-2),a=r=>o(this._key).reduce((t,u)=>t^u,r);return e.split("").map(o).map(a).map(s).join("")}catch(o){return console.error("Encryption Failed",o),null}},decrypt:function(e){try{const o=a=>a.split("").map(r=>r.charCodeAt(0)),s=a=>o(this._key).reduce((r,t)=>r^t,a);return e.match(/.{1,2}/g).map(a=>parseInt(a,16)).map(s).map(a=>String.fromCharCode(a)).join("")}catch(o){return console.error("Decryption Failed",o),null}}};function nt(){document.querySelectorAll(".login-form-shared").forEach(o=>{const s=o.querySelector('input[name="username"]'),a=o.querySelector('input[name="password"]'),r=o.querySelector('input[name="rememberMe"]');if(s&&a&&r){const t=localStorage.getItem("secure_user"),u=localStorage.getItem("secure_pass");if(t&&u){const i=de.decrypt(t),l=de.decrypt(u);i&&l&&(s.value=i,a.value=l,r.checked=!0)}}o.addEventListener("submit",async t=>{t.preventDefault();try{const i=await(await fetch(`${Y()}api/auth.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:s.value,password:a.value})})).json();if(i.success){r.checked?(localStorage.setItem("secure_user",de.encrypt(s.value)),localStorage.setItem("secure_pass",de.encrypt(a.value))):(localStorage.removeItem("secure_user"),localStorage.removeItem("secure_pass"));const l=localStorage.getItem("hasLoggedInBefore")==="true";localStorage.setItem("isLoggedIn","true"),localStorage.setItem("hasLoggedInBefore","true"),localStorage.setItem("user",JSON.stringify(i.user));const p=document.getElementById("drawer-login");if(p){p.classList.add("translate-y-full");const n=p.querySelector("[data-drawer-hide]");n&&n.click()}await je(l),_e(l)}else{const l=document.getElementById("drawer-login");l?(l.classList.add("translate-y-full"),setTimeout(()=>{we(),setTimeout(()=>{l.classList.remove("translate-y-full"),a.value="",a.focus()},600)},400)):(we(),a.value="",a.focus())}}catch(u){console.error("Login Error:",u),k.fire({icon:"error",title:"Login Error",text:"Unable to reach the server. Please check your connection."})}})})}function _e(e=!1){const o=document.getElementById("left-panel"),s=document.getElementById("right-panel"),a=document.getElementById("left-panel-content"),r=document.getElementById("right-panel-content");a&&(a.style.opacity="0"),r&&(r.style.opacity="0");const t=document.createElement("div");t.className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none";const u=e?"":"animate__delay-1s",i=e?"animation-duration: 0.8s;":"animation-duration: 2s;";t.innerHTML=`
    ...
    `,document.body.appendChild(t);const l=e?0:1e3,p=e?600:1500;setTimeout(()=>{o&&o.classList.add("animate-slide-left"),s&&s.classList.add("animate-slide-right"),setTimeout(()=>{window.location.href=`${Y()}frontend/dashboard/`},p)},l)}function it(){const e=document.getElementById("logoutBtn");e&&e.addEventListener("click",()=>{localStorage.removeItem("isLoggedIn"),window.location.href=`${Y()}`})}function lt(){const e=document.getElementById("mobile-splash"),o=document.getElementById("show-login-btn"),s=document.getElementById("back-to-splash"),a=document.getElementById("mobile-bg-content"),r=document.getElementById("mobile-welcome-text"),t=document.getElementById("reopen-login-drawer"),u=document.getElementById("request-notifications-btn"),i=async()=>{if("Notification"in window){const v=await Notification.requestPermission();console.log("Notification permission:",v),v==="granted"&&u&&u.classList.add("hidden")}};Notification.permission==="default"&&u&&(u.classList.remove("hidden"),u.addEventListener("click",i));const l=()=>{e&&(e.style.transform="translateY(-100%)",setTimeout(()=>{e.style.visibility="hidden",e.style.pointerEvents="none",e.style.zIndex="-1",Notification.permission==="default"&&i();const v=document.getElementById("drawer-login");v&&v.classList.remove("translate-y-full")},800))},p=()=>{e&&(e.style.zIndex="9999",e.style.pointerEvents="auto",e.style.visibility="visible",e.style.transform="translateY(0)")};o&&o.addEventListener("click",l),document.querySelectorAll(".forgot-password-link").forEach(v=>{v.addEventListener("click",y=>{y.target.closest("#mobile-splash")&&l()})}),s&&s.addEventListener("click",()=>{const v=document.getElementById("drawer-login");if(v){v.classList.add("translate-y-full");const y=v.querySelector("[data-drawer-hide]");y&&y.click()}p()});const c=document.getElementById("drawer-login"),x=document.getElementById("curved-welcome"),$=document.getElementById("peoples-bg");c&&new MutationObserver(y=>{y.forEach(w=>{w.attributeName==="class"&&(c.classList.contains("translate-y-full")?(a&&(a.style.transform="translateY(0)"),r&&(r.style.opacity="1",r.style.transform="translateY(0) scale(1)"),x&&(x.style.opacity="0",x.style.transform="scale(0.5)"),t&&e&&e.style.visibility==="hidden"&&(t.style.opacity="1",t.style.transform="scale(1)"),$&&($.classList.add("opacity-0","scale-0"),$.classList.remove("opacity-40","scale-[1.6]"))):(a&&(a.style.transform="translateY(-35%)"),r&&(r.style.opacity="0",r.style.transform="translateY(20px) scale(0.9)"),x&&(x.style.opacity="1",x.style.transform="scale(1)"),t&&(t.style.opacity="0",t.style.transform="scale(0)"),$&&($.classList.remove("opacity-0","scale-0"),$.classList.add("opacity-40","scale-[1.6]"))))})}).observe(c,{attributes:!0})}const le=()=>"false".toLowerCase()==="true";function Pe(e){try{return JSON.stringify(e)}catch{return"[unserializable]"}}const oe={debug(...e){le()&&console.debug(...e)},info(...e){le()&&console.info(...e)},warn(...e){le()&&console.warn(...e)},error(...e){console.error(...e)},table(e){le()&&console.table(e)},json(e,o){le()&&console.debug(e,Pe(o))}},ce=new Map;async function ne(e,o={}){const a=`${Y()}${e}`;let r=null;try{const n=JSON.parse(localStorage.getItem("user"));n&&(r=n.user_id||n.id||null)}catch{}const t={headers:{"Content-Type":"application/json",...r?{"X-User-Id":r}:{},...o.headers},...o},i=(t.method||"GET").toUpperCase()==="GET"?2:1;let l=null;for(let n=1;n<=i;n++)try{if(oe.debug("[API] Request",{url:a,method:t.method||"GET",hasUserId:!!r}),t.body)try{oe.json("[API] Payload",JSON.parse(t.body))}catch{oe.debug("[API] Payload (raw)",t.body)}const c=await fetch(a,t);if(!c.ok)throw new Error(`HTTP ${c.status}: ${c.statusText}`);const x=await c.json();return ce.has(a)&&(ce.delete(a),oe.info?.("[API] Recovered",{url:a})),oe.debug("[API] Response",{url:a,ok:!0}),{success:!0,data:x}}catch(c){if(l=c,c instanceof TypeError&&/fetch/i.test(c.message||"")&&n<i){await new Promise(v=>setTimeout(v,1200));continue}}return l instanceof TypeError&&/fetch/i.test(l.message||"")?ce.get(a)||(ce.set(a,!0),oe.error("API Request Network Error (suppressed for repeats):",{url:a,message:l.message})):oe.error("API Request Error:",l),{success:!1,error:l?.message||"Unknown request error"}}async function V(e){return ne(e,{method:"GET"})}async function xe(e,o){return ne(e,{method:"POST",body:JSON.stringify(o)})}async function He(e,o){return ne(e,{method:"PUT",body:JSON.stringify(o)})}async function dt(e,o){const s=new URLSearchParams(o).toString();return ne(`${e}?${s}`,{method:"PATCH"})}class qe{constructor(){this.intervals=new Map,this.isPageVisible=!0,document.addEventListener("visibilitychange",()=>{this.isPageVisible=!document.hidden,this.isPageVisible?console.log("[Polling] Page visible - resuming normal activity"):console.log("[Polling] Page hidden - reducing activity")})}start(o,s,a=1e4){this.stop(o),s();const r=setInterval(async()=>{this.isPageVisible&&await s()},a);this.intervals.set(o,r),console.log(`[Polling] Started: ${o} (every ${a}ms)`)}stop(o){this.intervals.has(o)&&(clearInterval(this.intervals.get(o)),this.intervals.delete(o),console.log(`[Polling] Stopped: ${o}`))}stopAll(){this.intervals.forEach((o,s)=>this.stop(s)),console.log("[Polling] All intervals stopped")}getActivePolls(){return Array.from(this.intervals.keys())}}const Fe=new qe;function ct(){typeof window.initFlowbite=="function"?(window.initFlowbite(),console.log("[Flowbite] Components re-initialized")):console.warn("[Flowbite] initFlowbite() not available globally")}function pt(e){return JSON.stringify(e)}window.addEventListener("beforeunload",()=>{Fe.stopAll()});const Ve="modulepreload",Ue=function(e,o){return new URL(e,o).href},ye={},Ce=function(o,s,a){let r=Promise.resolve();if(s&&s.length>0){let p=function(n){return Promise.all(n.map(c=>Promise.resolve(c).then(x=>({status:"fulfilled",value:x}),x=>({status:"rejected",reason:x}))))};const u=document.getElementsByTagName("link"),i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");r=p(s.map(n=>{if(n=Ue(n,a),n in ye)return;ye[n]=!0;const c=n.endsWith(".css"),x=c?'[rel="stylesheet"]':"";if(a)for(let v=u.length-1;v>=0;v--){const y=u[v];if(y.href===n&&(!c||y.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${x}`))return;const $=document.createElement("link");if($.rel=c?"stylesheet":Ve,c||($.as="script"),$.crossOrigin="",$.href=n,l&&$.setAttribute("nonce",l),document.head.appendChild($),c)return new Promise((v,y)=>{$.addEventListener("load",v),$.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${n}`)))})}))}function t(u){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=u,window.dispatchEvent(i),!i.defaultPrevented)throw u}return r.then(u=>{for(const i of u||[])i.status==="rejected"&&t(i.reason);return o().catch(t)})};let me=null;if(De()){const e="https://llnddycvbcetztzwbdpx.supabase.co",o="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImxsbmRkeWN2YmNldHp0endiZHB4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzQ1MDMwMTEsImV4cCI6MjA5MDA3OTAxMX0.apIpDlZYja7SNuA-joXgFSvu_wtbBcVVP3OQSPrh7fA";try{me=Re(e,o),console.log("[SUPABASE SDK] Client Initialized Successfully")}catch(s){console.error("[SUPABASE SDK] Failed to initialize client:",s)}}else console.log("[SUPABASE SDK] Supabase mode is disabled (Localhost PHP mode active).");function Ge(e=new Date().getFullYear()){const o=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"],s=[];for(let a=0;a<12;a++){const r=new Date(e,a+1,0).getDate();s.push(`${o[a]} 1-15, ${e}`),s.push(`${o[a]} 16-${r}, ${e}`)}return s}function ze(e,o,s){if(s==="ar")return(e.period||"").toUpperCase().trim()===o.toUpperCase().trim();{const a=o.match(/([A-Z]+)\s+(\d+)-(\d+),\s+(\d+)/i);if(!a)return!1;const t=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"].indexOf(a[1].toUpperCase());if(t===-1)return!1;const u=parseInt(a[4]),i=parseInt(a[2]),l=parseInt(a[3]),p=(e.date||"").substring(0,10),n=new Date(p+"T00:00:00");return isNaN(n)?!1:n.getFullYear()===u&&n.getMonth()===t&&n.getDate()>=i&&n.getDate()<=l}}function Ye(e){if(!e)return"-";const o=e.toUpperCase();return o==="VERIFIED"||o==="COMPLETED"?"✓":o==="REJECTED"||o==="DECLINED"?"X":o==="PENDING"?"?":o}function ke(e,o,s,a){const r=e.map(t=>{const u=o[t.id]||[],i=a.map(l=>{const p=u.find(n=>ze(n,l,s));return p?Ye(p.status):"-"});return{name:t.name||t.id,cells:i}});return{periods:a,rows:r}}function $e(e,o,s){const{periods:a,rows:r}=o,t=a.length+1;let u='<table border="1" style="border-collapse:collapse;font-family:Arial,sans-serif;font-size:10px;">';return u+=`<tr><td colspan="${t}" style="background:${s};color:#fff;font-weight:bold;font-size:13px;padding:8px 12px;text-transform:uppercase;letter-spacing:1px;">${e}</td></tr>`,u+=`<tr><th style="background:${s};color:#fff;padding:6px 10px;min-width:200px;text-align:left;">BENEFICIARY NAME</th>`,a.forEach(i=>{u+=`<th style="background:${s};color:#fff;padding:6px 8px;text-align:center;white-space:nowrap;">${i}</th>`}),u+="</tr>",r.forEach((i,l)=>{const p=l%2===0?"#ffffff":"#f5f5f5";u+="<tr>",u+=`<td style="background:${p};padding:5px 10px;font-weight:bold;text-transform:uppercase;">${i.name}</td>`,i.cells.forEach(n=>{u+=`<td style="background:${p};padding:5px 8px;text-align:center;font-weight:bold;color:${n==="✓"?"#15803d":n==="X"?"#dc2626":"#9ca3af"};">${n}</td>`}),u+="</tr>"}),u+="</table>",u}async function ut(e){const o="flex flex-col items-center justify-center p-3 rounded-2xl border-2 transition-all cursor-pointer font-black uppercase tracking-widest text-[10px] gap-1.5",s=e.length,a=await k.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Export DTR/AR',html:`
        ...
        </div>`,showConfirmButton:!1,allowOutsideClick:!1,customClass:{popup:"rounded-[1.5rem] shadow-2xl font-montserrat dark:bg-slate-900 border border-gray-100 dark:border-slate-800"}});try{const a=Ge(s),r=Y();async function t(y){const N=await(await fetch(`${r}api/logs.php?type=${y}`,{headers:{"X-User-Id":(()=>{try{return JSON.parse(localStorage.getItem("user"))?.id||""}catch{return""}})()}})).json();return N.success?N.logs||[]:[]}let u={},i={};(o==="dtr"||o==="both")&&(await t("dtr")).forEach(w=>{const N=String(w.gip_id||w.beneficiary_id||w.id||"");u[N]||(u[N]=[]),u[N].push(w)}),(o==="ar"||o==="both")&&(await t("ar")).forEach(w=>{const N=String(w.gip_id||w.beneficiary_id||w.id||"");i[N]||(i[N]=[]),i[N].push(w)});const l=e.map(y=>({...y,mapKey:String(y.id||y.gip_id||y.beneficiary_id)}));let p="";const n=new Intl.DateTimeFormat("en-PH",{timeZone:"Asia/Manila",dateStyle:"long",timeStyle:"short"}).format(new Date);if(o==="dtr"||o==="both"){const y=l.map(N=>({...N,id:N.mapKey})),w=ke(y,u,"dtr",a);p+="<br>"+$e(`DTR – Daily Time Records (${s})`,w,"#1d4ed8")}if(o==="ar"||o==="both"){const y=l.map(N=>({...N,id:N.mapKey})),w=ke(y,i,"ar",a);p+="<br><br>"+$e(`AR – Accomplishment Reports (${s})`,w,"#d97706")}const c=`
        ...
        `,x=new Blob([c],{type:"application/vnd.ms-excel"}),$=URL.createObjectURL(x),v=document.createElement("a");v.href=$,v.download=`LDN_LOGS_${o.toUpperCase()}_${s}.xls`,document.body.appendChild(v),v.click(),URL.revokeObjectURL($),document.body.removeChild(v),k.fire({toast:!0,position:"top-end",icon:"success",title:"Excel file downloaded!",showConfirmButton:!1,timer:2500})}catch(a){console.error("[LogsExport] Error:",a),k.fire("Error",a.message||"Failed to generate export.","error")}}const ie="color-theme",Ze=3600*24*365;function Je(e,o,s){document.cookie=`${e}=${o}; max-age=${s}; path=/; SameSite=Lax`}function Ie(e){const o=document.cookie.match(new RegExp("(?:^|; )"+e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"=([^;]*)"));return o?decodeURIComponent(o[1]):null}function Be(){const e=localStorage.getItem(ie)||Ie(ie);return e==="dark"||e==="light"?e:"light"}function ue(e){const o=document.documentElement;e==="dark"?o.classList.add("dark"):o.classList.remove("dark"),localStorage.setItem(ie,e),Je(ie,e,Ze),Xe(e),document.dispatchEvent(new CustomEvent("themeChanged",{detail:{theme:e}}))}function ve(){const e=Be();ue(e==="dark"?"light":"dark")}function Xe(e){const o=e==="dark",s=document.getElementById("pref-dark-mode");s&&(s.checked=o);const a=document.getElementById("theme-toggle-dark-icon"),r=document.getElementById("theme-toggle-light-icon");a&&r&&(a.classList.toggle("hidden",o),r.classList.toggle("hidden",!o));const t=document.getElementById("sidebar-theme-label");t&&(t.textContent=o?"Light Mode":"Dark Mode")}function gt(){const e=Be();ue(e);const o=document.getElementById("pref-dark-mode");o&&o.addEventListener("change",()=>{ue(o.checked?"dark":"light")});const s=document.getElementById("theme-toggle-btn");s&&s.addEventListener("click",ve),document.querySelectorAll("[data-theme-toggle]").forEach(a=>{a.addEventListener("click",ve)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",a=>{localStorage.getItem(ie)||Ie(ie)||ue(a.matches?"dark":"light")})}function ee(){return document.documentElement.classList.contains("dark")}window.toggleTheme=ve;window.isDarkMode=ee;const ge={queue:[],currentIndex:0,isActive:!1,isAutoSave:!1,lastInteractionTime:0,init(){this.showUploadModal()},showUploadModal(){const e=ee(),o={bgCard:e?"bg-slate-900/40":"bg-gray-50/40",borderCard:e?"border-slate-800":"border-gray-100",textHeading:e?"text-green-500":"text-[#2e7d32]",textSubtitle:e?"text-slate-500":"text-gray-400 dark:text-gray-300",bgUpload:e?"bg-slate-800":"bg-white",borderUpload:e?"border-slate-700":"border-gray-200",textUpload:e?"text-slate-400":"text-gray-500",hoverUpload:e?"hover:bg-slate-800/80 hover:border-blue-500":"hover:bg-blue-50/50 hover:border-royal-blue",iconText:e?"text-green-400":"text-[#2e7d32]",iconBg:e?"bg-green-900/20":"bg-[#e8f5e9]",iconBorder:e?"border-green-800/30":"border-[#c8e6c9]"},s=`
...
`&&r++,s.trim()!==""&&o.push(s),s=""):s+=t}s.trim()!==""&&o.push(s),this.queue=[];for(let r=0;r<o.length;r++){let t=o[r].trim();if(!t)continue;let u=[],i="",l=!1;for(let p=0;p<t.length;p++){let n=t[p];n==='"'?l=!l:n===","&&!l?(u.push(i.replace(/(^"|"$)/g,"").trim()),i=""):i+=n}if(u.push(i.replace(/(^"|"$)/g,"").trim()),u.length>=2){const p=u[3];if(!p||isNaN(parseInt(p)))continue;const n=u[1];if(!n||n.toLowerCase()==="name"||n.toLowerCase()==="full name")continue;const c=u[2];let x=u[4]?u[4].toUpperCase().trim():"",$="";(x==="F"||x.includes("FEMALE"))&&($="Female"),(x==="M"||x.includes("MALE"))&&($="Male");const v=u[5],y=u[6],w=u[7],N=this.formatDate(u[8]),j=this.formatDate(u[9]);this.queue.push({name:n,address:c,age:p,gender:$,education:v,startDate:N,endDate:j,office:y,designation:w})}}if(this.queue.length>0){try{k.fire({title:"Checking duplicates...",html:'<p class="text-sm">Please wait while we cross-reference your data.</p>',allowOutsideClick:!1,didOpen:()=>{k.showLoading()}});const r=this.queue.map(l=>l.name);let t=null;try{t=JSON.parse(localStorage.getItem("user")||"{}")?.id||null}catch{t=null}const i=await(await fetch(`${Y()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json",...t?{"X-User-Id":String(t)}:{}},body:JSON.stringify({names:r,user_id:t})})).json();if(i.success&&i.duplicates&&i.duplicates.length>0){const l=new Set(i.duplicates.map(n=>n.toLowerCase().trim())),p=this.queue.length;this.queue=this.queue.filter(n=>{const c=l.has(n.name.toLowerCase().trim());return c&&console.warn(`%c[Bulk Add] SKIPPED: ${n.name} already exists in database.`,"color: #ff9800; font-weight: bold;"),!c}),console.log(`[Bulk Add] Removed ${p-this.queue.length} duplicates ahead of time.`)}}catch(r){console.error("Bulk duplicate check failed:",r)}if(this.queue.length===0){k.fire("All Skipped","All beneficiaries in the CSV already exist in the database.","info");return}this.isActive=!0,this.currentIndex=0,k.close(),this.processNext()}else k.fire("Error","No valid beneficiary data found. Please ensure your CSV formatting matches the requirements.","error")},showProgressModal(){ee();const e=Math.round(this.currentIndex/this.queue.length*100),o=`
        ...
        `;if(k.isVisible()&&k.getPopup().querySelector("#bulk-progress-bar")){const s=document.getElementById("bulk-progress-bar"),a=k.getPopup().querySelector("span.text-\\[10px\\]"),r=document.getElementById("bulk-current-name");s&&(s.style.width=`${e}%`),a&&(a.textContent=`${this.currentIndex} / ${this.queue.length}`),r&&(r.textContent=this.queue[this.currentIndex]?.name||"...")}else k.fire({html:o,showConfirmButton:!1,allowOutsideClick:!1,allowEscapeKey:!1,width:"450px",customClass:{container:"font-montserrat",popup:"rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-800"},didOpen:s=>{s.querySelector("#stop-bulk-btn").onclick=()=>this.onCancel()}})},formatDate(e){if(!e||e.trim()==="")return"";const o=new Date(e);if(isNaN(o.getTime())){const t=e.split("/");return t.length===3?`${t[2]}-${t[1].padStart(2,"0")}-${t[0].padStart(2,"0")}`:""}const s=o.getFullYear(),a=String(o.getMonth()+1).padStart(2,"0"),r=String(o.getDate()).padStart(2,"0");return`${s}-${a}-${r}`},async processNext(){if(this.currentIndex<this.queue.length){const e=this.queue[this.currentIndex];e._isBulk=!0,e._bulkCurrent=this.currentIndex+1,e._bulkTotal=this.queue.length,this.isAutoSave?(this.showProgressModal(),window.addBeneficiaryData?(async()=>{try{const s=e.startDate?new Date(e.startDate).getFullYear():new Date().getFullYear(),[a,r]=await Promise.all([V(`api/beneficiaries.php?next_id&year=${s}`),V(`api/beneficiaries.php?next_series_no&year=${s}`)]);a.success&&a.data?.success&&a.data?.nextId&&(e.gip_id=a.data.nextId,e.id=null),r.success&&r.data?.success&&r.data?.nextSeries&&(e.seriesNo=r.data.nextSeries)}catch(s){console.warn("[Bulk Add] Identifier fetch failed, continuing:",s?.message||s)}const o=await window.addBeneficiaryData(e);this.isActive&&(o?this.onSaveSuccess():be(e))})():be(e)):be(e)}else this.isActive=!1,this.lastInteractionTime=Date.now(),k.fire({icon:"success",title:"Bulk Add Complete!",text:`Successfully processed ${this.queue.length} beneficiaries.`,confirmButtonColor:"#2e7d32"})},onSaveSuccess(){if(this.isActive){this.currentIndex++;const e=this.isAutoSave?100:1500;setTimeout(()=>{this.processNext()},e)}},onCancel(){this.isActive&&(this.isActive=!1,this.lastInteractionTime=Date.now(),this.queue=[],this.currentIndex=0,k.fire({icon:"info",title:"Bulk Add Cancelled",text:"Stopped processing the remaining beneficiaries and cleared the queue.",confirmButtonColor:"#3085d6"}).then(()=>{this.showUploadModal()}))}};window.BulkApp=ge;function Ee(e){if(!e)return"";const o=new Date(e),s=new Date;let a=s.getFullYear()-o.getFullYear();const r=s.getMonth()-o.getMonth();return(r<0||r===0&&s.getDate()<o.getDate())&&a--,a>=0?a:0}function We(e){return e?e.includes("DOLE")?"bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-300 dark:border-blue-800":e.includes("DepEd")?"bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/40 dark:text-orange-300 dark:border-orange-800":e.includes("LGU")?"bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/40 dark:text-purple-300 dark:border-purple-800":e.includes("DICT")?"bg-cyan-100 text-cyan-700 border-cyan-200 dark:bg-cyan-900/40 dark:text-cyan-300 dark:border-cyan-800":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300":"bg-gray-100 text-gray-700 border-gray-200 dark:text-gray-300"}function Ke(e){if(!e)return"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300";const o=e.toUpperCase();return o==="ONGOING"?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800":o==="EXPIRED"?"bg-red-400 text-white border-red-400 dark:bg-red-900/60 dark:border-red-800":o==="RESIGNED"?"bg-[#ce1126] text-white border-[#ce1126] dark:bg-red-900/80 dark:border-red-900":o==="ABSORBED"?"bg-[#2e7d32] text-white border-[#2e7d32] dark:bg-green-900/80 dark:border-green-900":"bg-gray-100 text-gray-600 border-gray-200 dark:text-gray-300"}function pe(e,o=0){e={...e,id:e?.id||e?.gip_id||"N/A",name:e?.name||"N/A",office:e?.office||"N/A",remarks:e?.remarks||"N/A",designation:e?.designation||"N/A",designatedBeneficiary:e?.designatedBeneficiary||"N/A",relationshipToAssured:e?.relationshipToAssured||"N/A"};const s=window.innerWidth<640?"top":"top-start";let a=o;const r=e.arLogs||[],t=e.dtrLogs||[],u=e.docs||[],i=["GIP FORM","BIRTH CERTIFICATE","DIPLOMA","TOR","VALID ID"],l=i.map(c=>{const x=u.find($=>$.name.toUpperCase()===c.toUpperCase());return x||{name:c,status:"PENDING",id:null}});u.forEach(c=>{i.some($=>$.toUpperCase()===c.name.toUpperCase())||l.push(c)});const p=`
    ...
    <div class="grid grid-cols-2 gap-4 mt-6 w-full">
        ...
        <div class="flex flex-col gap-1 text-left overflow-hidden">
            ...
            <div class="flex items-center flex-wrap gap-1.5 min-h-[30px]">
                ...
                <span class="${We(e.office)} hidden sm:inline-block text-[9px] font-black px-2.5 py-1 rounded-full border shadow-sm truncate max-w-[120px] lg:max-w-none" title="${e.office}">${e.office}</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div id="drawer-page-1" class="hidden flex-1 flex flex-col gap-6">
         ...
         <div class="flex flex-col gap-5">
            ...
            <div>
                ...
                <div class="space-y-2">
                    ${r.length?r.map(c=>{const x=c.status||"PENDING";let $=x==="VERIFIED"||x==="COMPLETED"?"text-green-500":x==="REJECTED"||x==="DECLINED"?"text-red-500":"text-gray-400 dark:text-gray-500",v=c.period||c.createdAt,y=v;if(v){const w=/^\d{4}-\d{2}-\d{2}$/.test(v)?new Date(v+"T00:00:00Z"):new Date(v);isNaN(w)||(y=w.toLocaleDateString("en-US",{month:"short",day:"2-digit",year:"numeric",timeZone:"Asia/Manila"}).toUpperCase())}return`
    ...
    `;let n=document.getElementById("beneficiary-drawer-container");n&&(n.remove(),document.documentElement.classList.remove("overflow-hidden"),document.body.classList.remove("overflow-hidden")),n=document.createElement("div"),n.id="beneficiary-drawer-container",n.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-neutral-primary-soft dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl",n.setAttribute("tabindex","-1"),n.setAttribute("data-drawer-backdrop","true"),n.innerHTML=p,document.body.appendChild(n),document.documentElement.classList.add("overflow-hidden"),document.body.classList.add("overflow-hidden"),Ce(async()=>{const{Drawer:c}=await import("./vendor-flowbite-B7rSfpuT.js").then(x=>x.b);return{Drawer:c}},__vite__mapDeps([0,1]),import.meta.url).then(({Drawer:c})=>{const x={placement:"right",backdrop:!0,bodyScrolling:!1,edge:!1,edgeOffset:"",backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{document.documentElement.classList.remove("overflow-hidden"),document.body.classList.remove("overflow-hidden"),setTimeout(()=>{n&&n.parentNode&&n.remove()},300)}},$=new c(n,x);$.show(),n.querySelector("#close-drawer-btn").addEventListener("click",()=>$.hide());const y=n.querySelector("#drawer-prev-btn"),w=n.querySelector("#drawer-next-btn"),N=2,j=()=>{n.querySelectorAll("[id^=drawer-page-]").forEach((L,h)=>{L.classList.toggle("hidden",h!==a)});const E=n.querySelector("#drawer-section-title");if(E){const L=["Personal Profile","Submission Logs","Required Documents"];E.textContent=L[a]||"Details"}const B=n.querySelector("#personal-profile-section");B&&B.classList.toggle("hidden",a!==0),y.disabled=a===0,w.disabled=a===N,y.classList.toggle("opacity-50",a===0),w.classList.toggle("opacity-50",a===N)};y.addEventListener("click",()=>{a>0&&a--,j()}),w.addEventListener("click",()=>{a<N&&a++,j()}),j(),n.querySelectorAll(".drawer-doc-btn").forEach(E=>{E.addEventListener("click",async()=>{const B=E.dataset.name,L=E.dataset.status,h="flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all cursor-pointer font-black uppercase tracking-widest text-[9px] gap-2 transition-all duration-300 ",g=await k.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Update Document</span>',html:`
                        <div class="font-montserrat text-left">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <label class="relative block cursor-pointer">
                                    <input type="radio" name="swal-doc-status" value="COMPLETED" class="peer sr-only" ${L==="COMPLETED"?"checked":""}>
                                ...
                                <label class="relative block cursor-pointer">
                                    <input type="radio" name="swal-doc-status" value="REJECTED" class="peer sr-only" ${L==="REJECTED"?"checked":""}>
                    ...
                    `,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest cursor-pointer">Update Status</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest cursor-pointer">Cancel</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100 dark:border-slate-800 dark:bg-slate-900",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-slate-600 text-xs px-6 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>{const b=document.querySelector('input[name="swal-doc-status"]:checked');return b?b.value:null}});if(g.isConfirmed){const b=g.value;if(b===L)return;try{const M={COMPLETED:"VERIFIED",REJECTED:"DECLINED",PENDING:"PENDING"}[b]||b,C=await xe("api/logs.php?type=docs",{gip_id:e.id,doc_name:B,status:M}),I=C.success?C.data:{success:!1,error:C.error};I.success?(k.fire({toast:!0,position:s,icon:"success",title:"Status updated!",showConfirmButton:!1,timer:1500}),window.viewBeneficiary&&window.viewBeneficiary(e,a)):k.fire("Error",I.error||"Failed to update","error")}catch(A){k.fire("Error",A.message,"error")}}})});const G=new Set(["2026-01-01","2026-04-02","2026-04-03","2026-04-09","2026-05-01","2026-06-12","2026-08-24","2026-08-31","2026-11-01","2026-11-30","2026-12-25","2026-12-30","2026-12-31"]),O=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"];function W(E){const L=new Date(E+"T00:00:00").getDay();return L!==0&&L!==6&&!G.has(E)}function _(E){const B=E.getDate(),L=O[E.getMonth()],h=E.getFullYear(),g=new Date(h,E.getMonth()+1,0).getDate();return B<=15?`${L} 1-15, ${h}`:`${L} 16-${g}, ${h}`}const z=()=>{const E=new Date;if(!t.length)return _(E);let B=-1,L="";const h=C=>{const I=(C||"").toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+),\s*(\d{4})/);if(!I)return-1;const d=O.indexOf(I[1]),m=parseInt(I[2])===1?0:1;return parseInt(I[4])*100+d*2+m};if(t.forEach(C=>{const I=C.day||C.date||"",d=h(I);d>B&&(B=d,L=I)}),B===-1)return _(E);const g=L.toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+),\s*(\d{4})/),b=O.indexOf(g[1]),A=parseInt(g[2]),M=parseInt(g[4]);if(A===1){const C=new Date(M,b+1,0).getDate();return`${O[b]} 16-${C}, ${M}`}else{const C=(b+1)%12,I=b===11?M+1:M;return`${O[C]} 1-15, ${I}`}},H=()=>{const E=new Date;if(!r.length)return _(E);let B=-1,L="";const h=C=>{const I=(C||"").toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+),\s*(\d{4})/);if(!I)return-1;const d=O.indexOf(I[1]),m=parseInt(I[2])===1?0:1;return parseInt(I[4])*100+d*2+m};if(r.forEach(C=>{const I=h(C.period);I>B&&(B=I,L=C.period)}),B===-1)return _(E);const g=L.toUpperCase().match(/([A-Z]{3})\s+(\d+)-(\d+),\s*(\d{4})/),b=O.indexOf(g[1]),A=parseInt(g[2]),M=parseInt(g[4]);if(A===1){const C=new Date(M,b+1,0).getDate();return`${O[b]} 16-${C}, ${M}`}else{const C=(b+1)%12,I=b===11?M+1:M;return`${O[C]} 1-15, ${I}`}},te=async(E,B)=>{k.fire({title:"Adding...",allowOutsideClick:!1,showConfirmButton:!1}),k.showLoading();try{const L={gip_id:e.id};if(E==="dtr"){const b=B.toUpperCase().match(/([A-Z]{3})\s+(\d+)-\d+,\s*(\d{4})/);if(b){const A=O.indexOf(b[1]),M=parseInt(b[2]),C=parseInt(b[3]);let I=new Date(C,A,M);for(;!W(I.toISOString().split("T")[0]);)I.setDate(I.getDate()+1);L.record_date=I.toISOString().split("T")[0]}else L.record_date=new Date().toISOString().split("T")[0];L.weekday=B}E==="ar"&&(L.period=B);const h=await xe(`api/logs.php?type=${E}`,L);(h.success?h.data:{success:!1,error:h.error}).success?(k.fire({toast:!0,position:s,icon:"success",title:"Auto-Added!",showConfirmButton:!1,timer:1500}),window.viewBeneficiary&&window.viewBeneficiary(e,a)):k.fire("Error","Failed to add log.","error")}catch(L){k.fire("Error",L.message,"error")}},ae=async(E,B,L,h,g)=>{const b=B==="dtr"?"Record Date":"Period";ee();const A="flex flex-col items-center justify-center p-3 rounded-xl border-2 transition-all cursor-pointer font-black uppercase tracking-widest text-[10px] sm:text-xs gap-2 ",M='<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>',C='<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"></path></svg>',{value:I}=await k.fire({title:`<span class="text-xl font-black text-heading uppercase tracking-tight">Edit ${E} Log</span>`,html:`
                ...
                `,focusConfirm:!1,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest cursor-pointer">SAVE REVISIONS</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest cursor-pointer">CANCEL</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100 dark:border-slate-800 dark:bg-slate-900",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-slate-600 text-xs px-6 py-2.5 rounded-xl border border-gray-200 dark:border-slate-600 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>{const d=document.querySelector('input[name="swal-log-status"]:checked');return{val:document.getElementById("swal-log-val").value.trim().toUpperCase(),status:d?d.value:"PENDING"}}});if(I&&(I.val!==h||I.status!==g))try{const d={type:B,id:L,status:I.status};if(B==="dtr"){const D=I.val.toUpperCase().match(/([A-Z]{3})\s+(\d+)-\d+,\s*(\d{4})/);if(D){const S=O.indexOf(D[1]),R=parseInt(D[2]),T=parseInt(D[3]);let q=new Date(T,S,R);for(;!W(q.toISOString().split("T")[0]);)q.setDate(q.getDate()+1);d.record_date=q.toISOString().split("T")[0]}else d.record_date=new Date().toISOString().split("T")[0];d.weekday=I.val}B==="ar"&&(d.period=I.val);const m=await He("api/logs.php",d),f=m.success?m.data:{success:!1,error:m.error};f.success?(k.fire({toast:!0,position:s,icon:"success",title:"Log Updated!",showConfirmButton:!1,timer:1500}),window.viewBeneficiary&&window.viewBeneficiary(e,a)):k.fire("Error",f.error||"Failed to update log.","error")}catch(d){k.fire("Error",d.message,"error")}},K=n.querySelector("#add-dtr-log-btn");K&&K.addEventListener("click",()=>te("dtr",z()));const Z=n.querySelector("#add-ar-log-btn");Z&&Z.addEventListener("click",()=>te("ar",H()));const J=n.querySelector("#export-log-btn");J&&J.addEventListener("click",async()=>{const E="flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all cursor-pointer font-black uppercase tracking-widest text-[11px] gap-2 ",B=await k.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Export DTR/AR',html:`
                        <div class="font-montserrat text-left">
    ...
    <div class="flex flex-col gap-4 text-sm mt-3 px-1 pb-24">
        ...
        <div class="flex flex-col gap-2 pt-3 mt-1 border-t border-gray-50 dark:border-slate-800/60">
            ...
            <div id="edit-education-suggestions-box" class="hidden mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                ${Ae.map(p=>`<button type="button" class="edit-education-option w-full text-left px-3 py-2 text-[11px] font-bold text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-slate-700 cursor-pointer"><span class="option-text">${p.name}</span></button>`).join("")}
            </div>
        </div>
        ...
        <div class="flex justify-between items-center group">
            ...
            <select name="relationshipToAssured" class="${s} cursor-pointer max-w-[190px] text-right-select !pr-1 uppercase" style="direction: rtl;">
                <option value=""></option>
                ${Ne.map(p=>`<option value="${p}" ${e.relationshipToAssured===p?"selected":""}>${p}</option>`).join("")}
            </select>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-4 text-sm mt-4 px-1">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div id="edit-designation-suggestions-box" class="hidden mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg max-h-40 overflow-y-auto">
                ${Me.map(p=>`<button type="button" class="edit-designation-option w-full text-left px-3 py-2 text-[11px] font-bold text-slate-700 dark:text-slate-200 hover:bg-blue-50 dark:hover:bg-slate-700 cursor-pointer"><span class="option-text">${p}</span></button>`).join("")}
            </div>
        </div>
...
.pulse-highlight {
    ...
    `;let l=document.getElementById("edit-drawer-container");l&&(l.remove(),document.documentElement.classList.remove("overflow-hidden"),document.body.classList.remove("overflow-hidden")),l=document.createElement("div"),l.id="edit-drawer-container",l.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-white dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl pb-0",l.setAttribute("tabindex","-1"),l.innerHTML=i,document.body.appendChild(l),document.documentElement.classList.add("overflow-hidden"),document.body.classList.add("overflow-hidden"),setTimeout(()=>{const p=l.querySelector('textarea[name="name"]');p&&(p.style.height="auto",p.style.height=p.scrollHeight+"px")},10),(async()=>{try{const p=await ne("api/beneficiaries.php?get_offices=1");if(p.success&&p.data.offices){const n=l.querySelector("#edit-office-suggestions-box");if(n){const c=["DOLE Field Office","LGU","DEPED","DICT","PCA"],x=[...new Set([...c,...p.data.offices])];n.innerHTML=x.map($=>`
                ...
                `}else if(h==="RESIGNED"){const b=e.resignedDate&&!String(e.resignedDate).includes("0000-00-00")?new Date(e.resignedDate):new Date,A=b.getTimezoneOffset()*6e4,M=new Date(b.getTime()-A).toISOString().slice(0,16);O.innerHTML=`
                    <div class="mt-4 pt-4 border-t ${g?"border-slate-800":"border-gray-100"}">
                ...
                `}};G&&G.addEventListener("change",h=>{const g="text-[10px] sm:text-[11px] font-black px-2.5 py-2.5 rounded-lg border uppercase tracking-widest shadow-sm outline-none focus:ring-2 focus:ring-brand w-full cursor-pointer transition-colors duration-300 h-[42px]";G.className=`${u(h.target.value)} ${g} editable-indicator`,W(),(G.value==="ABSORBED"||G.value==="RESIGNED")&&setTimeout(()=>{O.scrollIntoView({behavior:"smooth",block:"center"}),O.classList.add("pulse-highlight"),setTimeout(()=>O.classList.remove("pulse-highlight"),1500)},50)}),W();let _=!1,z=!1;const H=(h,g)=>{h.addEventListener("input",b=>{const A=b.target.value,M=window.__maskDate(A);if(A!==M&&(b.target.value=M),M.length===10){const C=window.__parseFormattedDate(M);C&&g&&(z||g(C),document.activeElement===h&&h.blur())}}),h.addEventListener("changeDate",b=>{b.detail&&b.detail.date&&g&&(z||g(b.detail.date),h._datepicker&&h._datepicker.hide())})};$&&H($,h=>{v&&(!_||!v.value)&&(v.value=window.calculateAge(h))}),y&&H(y,h=>{if(w){const b=new Date(h);b.setDate(b.getDate()+182);const A=String(b.getMonth()+1).padStart(2,"0"),M=String(b.getDate()).padStart(2,"0"),C=b.getFullYear();w.value=`${A}/${M}/${C}`}const g=h.getFullYear();g>1900&&j&&N&&Promise.all([V(`api/beneficiaries.php?next_id&year=${encodeURIComponent(g)}`),V(`api/beneficiaries.php?next_series_no&year=${encodeURIComponent(g)}`)]).then(([b,A])=>{const M=b.success&&b.data?.success?b.data.nextId:null,C=A.success&&A.data?.success?A.data.nextSeries:null,I=String(j.value||"").match(/^ROX-RD-ESIG-(\d{4})-\d{4}$/),d=String(N.value||"").match(/^(\d{4})-\d{2}-\d{3}$/),m=I?Number(I[1]):null,f=d?Number(d[1]):null;M&&(m===null||m!==g)&&(j.value=M),C&&(f===null||f!==g)&&(N.value=C)}).catch(b=>{console.error("Edit drawer identifier sync error:",b)})}),w&&H(w);const te=window.Datepicker||(typeof Datepicker<"u"?Datepicker:null),ae=window.DateRangePicker||(typeof DateRangePicker<"u"?DateRangePicker:null);te&&$&&($._datepicker=new te($,{format:"mm/dd/yyyy",autohide:!0,orientation:"bottom right"}));const K=l.querySelector("#edit-date-range-picker");if(ae&&K){const h=new ae(K,{format:"mm/dd/yyyy",autohide:!0,allowOneSidedRange:!0,orientation:"auto"});y&&(y._datepicker=h.datepickers[0]),w&&(w._datepicker=h.datepickers[1])}e.id&&(z=!0,V(`api/beneficiaries.php?id=${encodeURIComponent(e.id)}`).then(h=>{if(h.success&&h.data&&h.data.beneficiary){const g=h.data.beneficiary;if(y&&g.startDate){const b=new Date(g.startDate);isNaN(b)||(y.value=g.startDateFormatted||"",y._datepicker&&y._datepicker.setDate(b))}if(w&&g.endDate){const b=new Date(g.endDate);isNaN(b)||(w.value=g.endDateFormatted||"",w._datepicker&&w._datepicker.setDate(b))}}setTimeout(()=>{z=!1},100)}).catch(h=>{console.error("Error fetching accurate beneficiary dates:",h),z=!1})),v&&v.addEventListener("input",()=>_=!0);const Z=(h,g,b)=>{const A=l.querySelector(h),M=l.querySelector(g);if(!A||!M)return;const C=()=>M.classList.add("hidden"),I=()=>M.classList.remove("hidden");A.addEventListener("focus",I),A.addEventListener("input",()=>{const d=A.value.toLowerCase().trim();let m=0;M.querySelectorAll(b).forEach(f=>{const S=(f.querySelector(".option-text")?.textContent||f.textContent||"").toLowerCase().includes(d);f.style.display=S?"block":"none",S&&m++}),m>0?I():C()}),M.addEventListener("click",d=>{const m=d.target.closest(b);m&&(A.value=(m.querySelector(".option-text")?.textContent||m.textContent||"").trim(),C(),A.dispatchEvent(new Event("change")))}),document.addEventListener("click",d=>{!A.contains(d.target)&&!M.contains(d.target)&&C()})};Z("#edit-education-input","#edit-education-suggestions-box",".edit-education-option"),Z("#edit-designation-input","#edit-designation-suggestions-box",".edit-designation-option"),Z("#edit-office-input","#edit-office-suggestions-box",".edit-office-option");const J=l.querySelector("#edit-replacement-input"),E=l.querySelector("#edit-replacement-suggestions-box"),B=l.querySelector("#edit-replacement-loading");let L=null;J&&E&&(J.addEventListener("input",h=>{const g=h.target.value.trim();clearTimeout(L),E.classList.add("hidden"),!(g.length<2)&&(B&&B.classList.remove("hidden"),L=setTimeout(async()=>{try{const b=await ne(`api/beneficiaries.php?replacement_candidates=1&q=${encodeURIComponent(g)}&limit=10`);b.success&&b.data&&b.data.candidates&&b.data.candidates.length>0?(E.innerHTML=b.data.candidates.map(A=>`
                            ...
                            `).join(""),E.classList.remove("hidden")):(E.innerHTML='<div class="px-4 py-3 text-xs text-gray-500 italic text-center font-medium">No active beneficiaries found.</div>',E.classList.remove("hidden"))}catch(b){console.error("Replacement fetch error:",b)}finally{B&&B.classList.add("hidden")}},400))}),E.addEventListener("click",h=>{const g=h.target.closest("button");g&&(J.value=g.dataset.name,E.classList.add("hidden"))}),document.addEventListener("click",h=>{!J.contains(h.target)&&!E.contains(h.target)&&E.classList.add("hidden")})),x.querySelectorAll("input, select, textarea").forEach(h=>{const g=(h.getAttribute("type")||"").toLowerCase(),b=!h.disabled&&!h.readOnly&&g!=="hidden";h.classList.remove("editable-indicator"),b&&h.classList.add("editable-indicator")}),x.addEventListener("submit",h=>{h.preventDefault();const g=new FormData(x),b={};g.forEach((A,M)=>b[M]=A),b.id=e.id,b.gip_id=b.gip_id||e.id,window.addBeneficiaryData&&(async()=>await window.addBeneficiaryData(b,!0,!1)&&(c(),window.viewBeneficiary&&setTimeout(()=>window.viewBeneficiary({id:e.id},0),100),k.fire({toast:!0,position:"top-end",icon:"success",title:"Record Updated",showConfirmButton:!1,timer:3e3})))()})})}function bt(){window.__maskDate=function(e){let o=e.replace(/\D/g,"").slice(0,8);return o.length>2&&o.length<=4?o=o.slice(0,2)+"/"+o.slice(2):o.length>4&&(o=o.slice(0,2)+"/"+o.slice(2,4)+"/"+o.slice(4)),o},window.__parseFormattedDate=function(e){if(!e)return null;const o=e.split("/");if(o.length===3){const s=parseInt(o[0])-1,a=parseInt(o[1]),r=parseInt(o[2]);if(r>1e3&&s>=0&&s<12&&a>0&&a<=31)return new Date(r,s,a)}return null},window.calculateAge=function(e){if(!e)return"";const o=e instanceof Date?e:new Date(e),s=new Date;let a=s.getFullYear()-o.getFullYear();const r=s.getMonth()-o.getMonth();return(r<0||r===0&&s.getDate()<o.getDate())&&a--,a>=0?a:0},window.viewBeneficiary=async function(e,o=0){const s=e?.id||e?.gip_id||null;if(!s)return;const a=!!(e?.name&&e?.office&&e?.remarks);let r={...e,id:s};if(!a){const i=await V(`api/beneficiaries.php?id=${encodeURIComponent(s)}`);i.success&&i.data?.success&&i.data?.beneficiary&&(r={...i.data.beneficiary,...r,id:s})}const t=`logs_cache_${s}`;let u=!1;try{if(window.__doleDB&&window.__doleDB.getSecureCache){const w=await window.__doleDB.getSecureCache(t);w&&(r.arLogs=w.arLogs||[],r.dtrLogs=w.dtrLogs||[],r.docs=w.docs||[],pe(r,o),u=!0)}let i=[],l=[],p=[];const[n,c,x,$]=await Promise.all([V(`api/logs.php?type=ar&gip_id=${encodeURIComponent(s)}`),V(`api/logs.php?type=dtr&gip_id=${encodeURIComponent(s)}`),V(`api/logs.php?type=docs&gip_id=${encodeURIComponent(s)}`),V(`api/logs.php?type=absorption&gip_id=${encodeURIComponent(s)}`)]);i=n.success&&n.data?.success?n.data.logs:[],l=c.success&&c.data?.success?c.data.logs:[],p=x.success&&x.data?.success?x.data.logs:[];const v=$.success&&$.data?.success?$.data.logs:[];if(v.length>0){const w=v[0];r.absorbDate=w.absorption_datetime,r.absorb_where=w.where||w.absorb_where,r.absorb_position=w.position||w.absorb_position,r.absorb_agency=w.agency||w.absorb_agency}const y={arLogs:i,dtrLogs:l,docs:p};window.__doleDB&&window.__doleDB.setSecureCache&&await window.__doleDB.setSecureCache(t,y),r.arLogs=i,r.dtrLogs=l,r.docs=p,u?document.getElementById("beneficiary-drawer-container")&&pe(r,o):pe(r,o)}catch(i){console.error("Error fetching logs/docs:",i),u||(r.arLogs=[],r.dtrLogs=[],r.docs=[],pe(r,o))}},window.showAddDataModal=function(e){be(e)},window.editBeneficiary=function(e){Qe(e)},window.showExportConfigModal=function(e){rt(e)},window.showProfileModal=function(){et()}}async function et(){try{if(De()&&me){let e="";try{const a=JSON.parse(localStorage.getItem("user"));a&&a.id&&(e=a.id)}catch{}if(!e)throw new Error("User not logged in");const{data:o,error:s}=await me.from("users").select("*").eq("id",e).single();if(s)throw s;Se(o)}else{let e="";try{const a=JSON.parse(localStorage.getItem("user"));a&&a.id&&(e=`?user_id=${a.id}`)}catch{}const s=await(await fetch(`${Y()}api/profile.php${e}`)).json();if(s.success){const a=s.profile;Se(a)}else k.fire({icon:"error",title:"Error",text:s.error||"Failed to load profile"})}}catch(e){console.error("Error fetching profile:",e)}}function Se(e){const o=e.profile_picture_path?`${Y()}${e.profile_picture_path}`:null,s=e.full_name?e.full_name.split(" ").map(r=>r[0]).join("").substring(0,2).toUpperCase():"US",a=`
    ...
    `;k.fire({html:u,width:window.innerWidth<1024?"96vw":"1000px",showConfirmButton:!1,showCloseButton:!1,padding:window.innerWidth<1024?"0.75rem":"2rem",customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},willOpen:()=>{document.documentElement.classList.add("overflow-hidden"),document.body.classList.add("overflow-hidden")},didClose:()=>{document.documentElement.classList.remove("overflow-hidden"),document.body.classList.remove("overflow-hidden")},didOpen:i=>{window.initFlowbite&&window.initFlowbite();const l=i.querySelector("#cancel-modal-btn");l&&l.addEventListener("click",()=>{!o&&!e?._isBulk&&localStorage.removeItem("add_beneficiary_draft"),k.close(),e?._isBulk&&ge.onCancel()});const p=i.querySelector("#bulk-add-btn");p&&p.addEventListener("click",()=>{k.close(),ge.init()});const n=(d,m)=>{d.addEventListener("input",f=>{const D=window.__maskDate(f.target.value);if(f.target.value!==D&&(f.target.value=D),D.length===10){const S=window.__parseFormattedDate(D);S&&m&&(m(S),document.activeElement===d&&d.blur())}}),d.addEventListener("changeDate",f=>{if(f.detail&&f.detail.date&&m){m(f.detail.date);const D=d._datepicker||d.parentNode&&d.parentNode._datepicker;D&&typeof D.hide=="function"&&D.hide()}})},c=i.querySelector("#birthday-input"),x=i.querySelector("#age-display");if(c){n(c,m=>{x&&(x.value=window.calculateAge(m),x.classList.add("animate-pulse"),setTimeout(()=>x.classList.remove("animate-pulse"),400))});const d=window.Datepicker||(typeof Datepicker<"u"?Datepicker:null);d&&(c._datepicker=new d(c,{format:"mm/dd/yyyy",autohide:!0,orientation:"bottom right"}))}const $=i.querySelector("#name-input-field"),v=i.querySelector("#duplicate-warning");if($&&v){let d;const m=()=>{try{return JSON.parse(localStorage.getItem("user")||"{}")?.id||null}catch{return null}},f=(S,R="")=>{v.className=`mt-1 text-[10px] font-bold ${S?"flex":"hidden"} items-center gap-1.5 animate-pulse ${ee()?"text-red-400":"text-red-600"}`;const T=v.querySelector("span");T&&(T.textContent=R?`Beneficiary already exists: ${R}`:"Beneficiary already exists")},D=async S=>{const R=m(),T=await fetch(`${Y()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json",...R?{"X-User-Id":String(R)}:{}},body:JSON.stringify({name:S,user_id:R,exclude_id:o?e?.id:null})});if(!T.ok)throw new Error(`Duplicate check failed (${T.status})`);return T.json()};$.addEventListener("input",S=>{const R=S.target.value.trim();if(clearTimeout(d),R.length<3){f(!1);return}d=setTimeout(async()=>{try{const T=await D(R);T.success&&T.exists?f(!0,T.match||T.name):f(!1)}catch(T){console.error("Duplicate check error:",T)}},500)}),e?.name&&(f(!1),(async()=>{const S=await D(e.name);S.success&&S.exists&&f(!0,S.match||S.name)})())}const y=i.querySelector("#full-id-input"),w=i.querySelector("#series-no-input"),N=i.querySelector('input[name="startDate"]'),j=i.querySelector('input[name="endDate"]'),G=i.querySelectorAll('input[name="remarks"]'),O=i.querySelector("#extension-log-container"),W=async d=>{if(!d)return;const m=[y,w].filter(Boolean);m.forEach(f=>{f.classList.add("animate-pulse"),f.placeholder="Syncing..."});try{const[f,D]=await Promise.all([V(`api/beneficiaries.php?next_id&year=${encodeURIComponent(d)}`),V(`api/beneficiaries.php?next_series_no&year=${encodeURIComponent(d)}`)]),S=f.success&&f.data?.success?f.data.nextId:null,R=D.success&&D.data?.success?D.data.nextSeries:null;S&&y&&(y.value=S),R&&w&&(w.value=R)}catch(f){console.error("ID Sync error:",f)}finally{m.forEach(f=>f.classList.remove("animate-pulse"))}},_=i.querySelector("#replacement-search-input"),z=i.querySelector("#replacement-hidden"),H=i.querySelector("#replacement-suggestions"),te=d=>{const m=(d.name||"").toUpperCase().trim(),f=d.startDateFormatted||d.startDate||"N/A",D=d.endDateFormatted||d.endDate||"N/A";return`${m} (${f.toUpperCase()} - ${D.toUpperCase()})`},ae=d=>{if(H){if(!d.length){H.innerHTML=`<div class="px-3 py-2 text-[10px] font-bold ${t.textCourseOpt}">No matching beneficiary found.</div>`,H.classList.remove("hidden");return}H.innerHTML=d.map(m=>{const f=te(m);return`
                    ...
                    `}else O.innerHTML=""};if(N){let d=null;n(N,S=>{const R=S.getFullYear();if(j){const T=new Date(S);T.setDate(T.getDate()+182);const q=String(T.getMonth()+1).padStart(2,"0"),U=String(T.getDate()).padStart(2,"0"),F=T.getFullYear();j.value=`${q}/${U}/${F}`}B(),R>1900&&R!==d&&(d=R,W(R))}),j&&n(j,()=>B());const m=i.querySelector("#date-range-picker"),f=window.DateRangePicker||(typeof DateRangePicker<"u"?DateRangePicker:null),D=window.Datepicker||(typeof Datepicker<"u"?Datepicker:null);if(f&&m&&N&&j){const S=new f(m,{format:"mm/dd/yyyy",autohide:!0,allowOneSidedRange:!0,orientation:"auto"});N._datepicker=S.datepickers?.[0]||null,j._datepicker=S.datepickers?.[1]||null}else D&&(N&&(N._datepicker=new D(N,{format:"mm/dd/yyyy",autohide:!0,orientation:"auto"})),j&&(j._datepicker=new D(j,{format:"mm/dd/yyyy",autohide:!0,orientation:"auto"})));if(!o){const S=new Date().getFullYear();W(S)}}G.forEach(d=>d.addEventListener("change",L));const h=i.querySelector("#resign-btn"),g=i.querySelector("#absorb-btn");h&&h.addEventListener("click",()=>E("RESIGNED")),g&&g.addEventListener("click",()=>E("ABSORBED")),i.querySelectorAll('input[type="text"], textarea').forEach(d=>{["id-number-input","full-id-input"].includes(d.id)||d.addEventListener("input",()=>{const m=d.selectionStart,f=d.selectionEnd;d.value=d.value.toUpperCase(),d.setSelectionRange(m,f)})}),B(),L(),M("education-input","course-suggestions","course-option"),M("designation-input","work-suggestions","work-option"),M("office-input","office-suggestions","office-option");const b={publicSector:["DOLE","LGU","DEPED"],privateSector:["DICT","PCA"]},A=(d=[])=>{const m=i.querySelector("#office-suggestions");if(!m)return;const f=F=>String(F||"").trim().toUpperCase(),D=new Set(b.publicSector.map(f)),S=new Set(b.privateSector.map(f)),R=new Set([...D,...S]),q=[...new Set((d||[]).map(f).filter(Boolean))].filter(F=>!R.has(F)),U=(F,P)=>P.length?`
                        ...
                        `).join("")}
                    `:"";m.innerHTML=[U("Public Sector",[...D]),U("Private Sector",[...S]),U("Other Offices",q)].join("")};A(),(async()=>{try{const d=await V("api/beneficiaries.php?get_offices=1");d.success&&d.data?.success&&Array.isArray(d.data.offices)&&A(d.data.offices)}catch(d){console.error("Office suggestion sync failed:",d)}})();function M(d,m,f){const D=i.querySelector(`#${d}`),S=i.querySelector(`#${m}`);if(!D||!S)return;let R=!1;D.addEventListener("focus",()=>S.classList.remove("hidden")),document.addEventListener("click",T=>{!D.contains(T.target)&&!S.contains(T.target)&&S.classList.add("hidden")}),D.addEventListener("input",()=>{if(R){R=!1;return}const T=D.value.toLowerCase(),q=S.querySelectorAll(`.${f}`);let U=!1;q.forEach(F=>{const P=F.querySelector(".option-text");(P?P.innerText:F.innerText).toLowerCase().includes(T)?(F.style.display="block",U=!0):F.style.display="none"}),U?S.classList.remove("hidden"):S.classList.add("hidden")}),S.addEventListener("click",T=>{const q=T.target.closest(`.${f}`);if(!q)return;const U=q.querySelector(".option-text");D.value=U?U.innerText.trim():q.innerText.trim(),R=!0,S.classList.add("hidden"),D.dispatchEvent(new Event("change"))})}const C=i.querySelector("#add-beneficiary-form"),I="add_beneficiary_draft";if(!o){const d=localStorage.getItem(I);if(d)try{const m=JSON.parse(d);Object.entries(m).forEach(([f,D])=>{const S=C.elements[f];S&&S.type!=="file"&&S.type!=="hidden"&&(S.value=D)})}catch(m){console.error("Error loading draft",m)}}C.addEventListener("input",d=>{if(!o){const m=new FormData(C),f={};m.forEach((D,S)=>f[S]=D),localStorage.setItem(I,JSON.stringify(f))}}),C&&C.addEventListener("submit",d=>{d.preventDefault(),C.querySelectorAll('input:not([type="hidden"]), select, textarea').forEach(Q=>{Q.classList.remove("ring-2","ring-red-500","!border-red-500")});const f=new FormData(C);let D=!1;const S=Q=>{const X=C.querySelector(`[name="${Q}"]`);X&&X.classList.add("ring-2","ring-red-500","!border-red-500"),D=!0},R=f.get("name"),T=f.get("contact"),q=f.get("startDate"),U=f.get("endDate"),F=(f.get("designation")||"").trim();if((!R||R.trim()===""||/[0-9]/.test(R))&&S("name"),T&&T.trim()!==""&&/[^0-9]/.test(T.replace(/[\s\-\+\(\)]/g,""))&&S("contact"),q||S("startDate"),U||S("endDate"),D)return;const P={};f.forEach((Q,X)=>{if(["birthday","startDate","endDate"].includes(X)){const se=window.__parseFormattedDate(Q);if(se){const fe=se.getFullYear(),he=String(se.getMonth()+1).padStart(2,"0"),Te=String(se.getDate()).padStart(2,"0");P[X]=`${fe}-${he}-${Te}`}else P[X]=Q}else P[X]=Q}),F||(P.designation="N/A"),P.replacement||(P.replacement="");const re=i.querySelector("#full-id-input")?.value;o?(P.id=e?.id,re&&(P.gip_id=re)):(P.id=null,re&&(P.gip_id=re)),window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(P)){if(!o){const X="add_beneficiary_draft",se=C.querySelector('[name="office"]')?.value||"",fe=C.querySelector('[name="designation"]')?.value||"",he=C.querySelector('[name="education"]')?.value||"";localStorage.setItem(X,JSON.stringify({office:se,designation:fe,education:he}))}k.close(),setTimeout(()=>{k.fire({toast:!0,position:"top-end",icon:"success",title:`Record ${o?"Updated":"Added"} Successfully`,showConfirmButton:!1,timer:3e3,timerProgressBar:!0}),!o&&e?._isBulk&&ge.onSaveSuccess()},100)}else k.fire({icon:"error",title:"Save Failed",text:"There was an error saving the record to the database."})})()})}})}window.handleContactSubmit=async function(e){e.preventDefault();const o=e.target,s=o.querySelector('button[type="submit"]'),a=s.innerHTML;s.disabled=!0,s.innerHTML=`
        <svg class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        </svg>
        Sending...
    `;try{const r=new FormData(o);if((await fetch(o.action,{method:"POST",body:r,headers:{Accept:"application/json"}})).ok)k.fire({toast:!0,position:"top-end",icon:"success",title:"Message Sent Successfully!",text:"Thank you for reaching out. I will get back to you soon!",showConfirmButton:!1,timer:4e3,timerProgressBar:!0,didOpen:u=>{u.addEventListener("mouseenter",k.stopTimer),u.addEventListener("mouseleave",k.resumeTimer)},customClass:{popup:"rounded-2xl border-l-4 border-teal-500 shadow-2xl"}}),o.reset();else throw new Error("Failed to send")}catch{k.fire({toast:!0,position:"top-end",icon:"error",title:"Oops! Something went wrong.",text:"Could not send your message. Please try again later.",showConfirmButton:!1,timer:4e3,customClass:{popup:"rounded-2xl border-l-4 border-red-500 shadow-2xl"}})}finally{s.disabled=!1,s.innerHTML=a}return!1};export{Ce as _,V as a,ne as b,dt as c,pt as d,gt as e,nt as f,Y as g,it as h,st as i,lt as j,bt as k,oe as l,ct as r,ut as s,tt as u};
