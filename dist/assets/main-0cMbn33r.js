import"./vendor-DC5wud4b.js";import{initFlowbite as Ae}from"./vendor-flowbite-B2TFTxm5.js";import{g as v,a as L,_ as De,r as fe,b as J,p as Ie,c as Be,s as Le,i as $e,d as Ne,e as Te,f as Oe,h as Me,j as Pe,u as Re}from"./auth-FVEiqT_S.js";import{A as _e}from"./vendor-charts-BjInCqFR.js";import G from"./vendor-swal-BSk0fVSb.js";const A=()=>document.documentElement.classList.contains("dark"),Fe=()=>A()?{text:"#ffffff",muted:"#94a3b8",grid:"#334155",cardBg:"#1e293b",tooltipBg:"#1e293b",tooltipBorder:"#334155"}:{text:"#0f172a",muted:"#64748b",grid:"#f1f5f9",cardBg:"#f8fafc",tooltipBg:"#ffffff",tooltipBorder:"#e2e8f0"},y={royalBlue:()=>A()?"#60a5fa":"#0038A8",philippineRed:"#CE1126",goldenYellow:"#FCD116",successGreen:"#22c55e",mutedSlate:()=>(A(),"#94a3b8")};let z=null,C="ALL",pe="Overall Stats";const se={ILIGAN:120,KAUSWAGAN:50,BACOLOD:45,MAIGO:35,KOLAMBUGAN:50,TUBOD:65,BAROY:40,SALVADOR:35,KAPATAGAN:75,LALA:60,SAPAD:35,BALOI:40};async function ee(){let t=[];if(z)t=z;else try{const m=await(await fetch(`${v()}api/beneficiaries.php`)).json();if(m.success)t=m.beneficiaries||[],z=t;else{console.error("Failed to load chart data:",m.error);return}}catch(c){console.error("Error fetching chart data:",c);return}if(t.length===0)return;document.querySelectorAll('[id$="-chart"]').forEach(c=>c.innerHTML="");const e=Fe(),o=je(t);Ue(o);const n=[...new Set(t.map(c=>{const m=c.startDate||c.createdAt;return m?new Date(m).getFullYear().toString():null}).filter(c=>c))].sort((c,m)=>m-c);Ge(n);const r=new Date;let a=[];if(C==="ALL"){const m=new Date().getFullYear();for(let S=2020;S<=m;S++)a.push(S.toString())}else if(n.includes(C))a=["Q1","Q2","Q3","Q4"];else{const c=parseInt(C)||7;a=Array.from({length:c},(m,S)=>{const $=new Date;return $.setDate(r.getDate()-(c-1-S)),$.toISOString().split("T")[0]})}const s={};a.forEach(c=>s[c]=0),t.forEach(c=>{const m=c.startDate||c.createdAt;if(m){const S=new Date(m),$=S.getFullYear().toString(),re=typeof m=="string"&&m.includes("T")?m.split("T")[0]:S.toISOString().split("T")[0];if(C==="ALL")s.hasOwnProperty($)&&s[$]++;else if(C.includes("D"))s.hasOwnProperty(re)&&s[re]++;else if($===C){const ae="Q"+(Math.floor(S.getMonth()/3)+1);s.hasOwnProperty(ae)&&s[ae]++}}});const i=Object.values(s),d=i.reduce((c,m)=>c+m,0),l=i[i.length-1]||0,h=i[i.length-2]||0;let p;if(C==="ALL"){const c=d/a.length;p=l>=c}else p=l>=h;document.querySelectorAll(".metric-added-count").forEach(c=>{c.textContent=d,c.className=`text-3xl sm:text-5xl font-black transition-colors duration-500 leading-none metric-added-count ${p?"text-green-600 dark:text-green-400":"text-red-600 dark:text-red-400"}`});const b=h>0?Math.round((l-h)/h*100):l>0?100:0;document.querySelectorAll(".metric-added-rate").forEach(c=>c.textContent=(b>=0?"+":"")+(C==="ALL"?"Growth":b+"%"));const u=document.getElementById("added-metric-badge");u&&(u.className=`flex items-center px-3 py-1 text-[10px] sm:text-xs font-black text-white rounded-full shadow-lg transition-all duration-500 border border-white/20 translate-y-1 ${p?"bg-green-500 shadow-green-500/30":"bg-red-500 shadow-red-500/30"}`);const k=document.getElementById("added-metric-icon");k&&(k.style.transform=p?"rotate(0deg)":"rotate(180deg)");const P=document.getElementById("dropdownDefaultButton");P&&(P.innerHTML=`${pe} <svg class="w-3 h-3 ms-1.5" aria-hidden="true" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9-7 7-7-7" /></svg>`);const we={chart:{height:160,type:"area",fontFamily:"Montserrat, sans-serif",toolbar:{show:!1},sparkline:{enabled:!0},background:"transparent"},theme:{mode:A()?"dark":"light"},fill:{type:"gradient",gradient:{shadeIntensity:1,opacityFrom:.6,opacityTo:.1,stops:[0,90,100],colorStops:[{offset:0,color:p?y.successGreen:y.philippineRed,opacity:.6},{offset:100,color:p?y.successGreen:y.philippineRed,opacity:.1}]}},stroke:{curve:"smooth",width:3,colors:[p?y.successGreen:y.philippineRed]},series:[{name:"New Beneficiaries",data:i}],xaxis:{categories:a},yaxis:{show:!1},grid:{show:!1,padding:{left:10,right:35,top:0,bottom:0}},colors:[p?y.successGreen:y.philippineRed],markers:{size:a.length>20?0:4,colors:[p?y.successGreen:y.philippineRed],strokeColors:e.cardBg,strokeWidth:2,hover:{size:6}},tooltip:{theme:A()?"dark":"light",y:{title:{formatter:()=>"Added:"}}}};N("workforce-chart",we);const ve={series:[o.genders.Female||0,o.genders.Male||0],chart:{height:320,type:"donut",fontFamily:"Montserrat, sans-serif",background:e.cardBg},colors:[y.philippineRed,y.royalBlue()],labels:["Female","Male"],plotOptions:{pie:{donut:{size:"75%",labels:{show:!0,name:{show:!0,fontSize:"12px",fontWeight:600,color:e.muted},value:{show:!0,fontSize:"24px",fontWeight:900,color:e.text,formatter:c=>c},total:{show:!0,label:"TOTAL",fontSize:"10px",fontWeight:800,color:e.muted,formatter:c=>c.globals.seriesTotals.reduce((m,S)=>m+S,0)}}}}},dataLabels:{enabled:!1},legend:{show:!1},stroke:{colors:[e.cardBg],width:4},theme:{mode:A()?"dark":"light"},responsive:[{breakpoint:640,options:{chart:{height:260},plotOptions:{pie:{donut:{size:"70%",labels:{value:{fontSize:"18px"}}}}}}}]};N("gender-chart",ve);const Ce={series:[o.education["College Grad"],o.education["College Lvl"],o.education["HS Grad"],o.education["Senior High"]].map(c=>Math.round(c/t.length*100)),chart:{height:300,type:"radialBar",background:e.cardBg},plotOptions:{radialBar:{hollow:{size:"30%"},dataLabels:{name:{fontSize:"11px",fontWeight:700,color:e.muted,offsetY:-5},value:{fontSize:"16px",fontWeight:900,color:e.text,offsetY:5},total:{show:!0,label:"GRADUATES",color:e.muted}},track:{background:e.grid,strokeWidth:"95%"}}},colors:[y.royalBlue(),y.goldenYellow,y.philippineRed,y.mutedSlate()],labels:["Col. Grad","Col. Lvl","HS Grad","Snr High"],theme:{mode:A()?"dark":"light"},responsive:[{breakpoint:640,options:{chart:{height:260},plotOptions:{radialBar:{hollow:{size:"20%"},dataLabels:{value:{fontSize:"14px"}}}}}}]};N("education-chart",Ce);const ne=Object.entries(o.designations).sort((c,m)=>m[1]-c[1]).slice(0,5),ke={series:[{name:"Beneficiaries",data:ne.map(c=>c[1]),color:y.royalBlue()}],chart:{type:"bar",height:180,toolbar:{show:!1},fontFamily:"Montserrat, sans-serif",background:e.cardBg},plotOptions:{bar:{horizontal:!0,columnWidth:"100%",borderRadius:4,barHeight:"60%"}},dataLabels:{enabled:!1},xaxis:{categories:ne.map(c=>c[0]),labels:{show:!0,style:{fontWeight:600,colors:e.muted,fontSize:"9px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{show:!0,style:{fontWeight:700,colors:e.text,fontSize:"10px"}}},grid:{borderColor:e.grid,strokeDashArray:4,padding:{left:-15,right:0}},theme:{mode:A()?"dark":"light"},responsive:[{breakpoint:640,options:{chart:{height:160},xaxis:{labels:{style:{fontSize:"8px"}}},yaxis:{labels:{style:{fontSize:"9px"}}}}}]};N("job-roles-chart",ke);const Ee={series:[{name:"Beneficiaries",data:Object.values(o.ages),color:y.royalBlue()}],chart:{type:"area",height:220,toolbar:{show:!1},fontFamily:"Montserrat, sans-serif",background:e.cardBg},stroke:{curve:"smooth",width:3},fill:{type:"gradient",gradient:{shadeIntensity:1,opacityFrom:.4,opacityTo:.1}},dataLabels:{enabled:!0,offsetY:-10,offsetX:0,style:{fontSize:"9px",fontWeight:"800"},background:{enabled:!0,padding:3,borderRadius:4,borderWidth:0,opacity:.9}},xaxis:{categories:Object.keys(o.ages),labels:{style:{fontWeight:600,colors:e.muted,fontSize:"10px"}},axisBorder:{show:!1}},yaxis:{labels:{style:{fontWeight:600,colors:e.muted,fontSize:"10px"}}},grid:{borderColor:e.grid,strokeDashArray:6,padding:{left:20,right:60}},theme:{mode:A()?"dark":"light"},responsive:[{breakpoint:640,options:{chart:{height:160}}}]};N("age-chart",Ee);const R=qe(t);He(R);const Se={series:[{name:"Actual Beneficiaries",data:Object.values(R.municipalityData).map(c=>c.actual)},{name:"Target Slots",data:Object.values(R.municipalityData).map(c=>c.target)}],chart:{type:"bar",height:350,fontFamily:"Montserrat, sans-serif",toolbar:{show:!1},background:e.cardBg},theme:{mode:A()?"dark":"light"},colors:[y.royalBlue(),A()?"#334155":"#E2E8F0"],plotOptions:{bar:{horizontal:!1,columnWidth:"55%",borderRadius:8}},dataLabels:{enabled:!1},stroke:{show:!0,width:2,colors:["transparent"]},xaxis:{categories:Object.keys(R.municipalityData),labels:{style:{fontWeight:600,colors:e.muted,fontSize:"9px"}},axisBorder:{show:!1},axisTicks:{show:!1}},yaxis:{labels:{style:{fontWeight:600,colors:e.muted}}},legend:{show:!1},fill:{opacity:1},grid:{borderColor:e.grid,strokeDashArray:4,yaxis:{lines:{show:!0}}}};N("performance-gap-chart",Se)}function N(t,e){const o=document.getElementById(t);if(!o)return;o.innerHTML="",new _e(o,e).render()}function je(t){const e={offices:{},genders:{Female:0,Male:0,Unknown:0},education:{"College Grad":0,"College Lvl":0,"HS Grad":0,"Senior High":0},designations:{},ages:{"18-24":0,"25-30":0,"31-40":0,"41+":0},totalAge:0,ageCount:0};return t.forEach(o=>{const n=o.office||"Unassigned";e.offices[n]=(e.offices[n]||0)+1;const r=(o.gender||"Unknown").trim(),a=r==="F"||r==="Female"?"Female":r==="M"||r==="Male"?"Male":"Unknown";e.genders[a]++;const s=(o.education||"").toUpperCase();s.includes("GRADUATE")||s.includes("DEGREE")||s.includes("BS")||s.includes("AB")?e.education["College Grad"]++:s.includes("COLLEGE")||s.includes("LEVEL")||s.includes("UNIT")?e.education["College Lvl"]++:s.includes("SENIOR")?e.education["Senior High"]++:(s.includes("HS")||s.includes("HIGH"))&&e.education["HS Grad"]++;const i=o.designation||"General Support";e.designations[i]=(e.designations[i]||0)+1;const d=parseInt(o.age);isNaN(d)||(e.totalAge+=d,e.ageCount++,d>=18&&d<=24?e.ages["18-24"]++:d>=25&&d<=30?e.ages["25-30"]++:d>=31&&d<=40?e.ages["31-40"]++:d>=41&&e.ages["41+"]++)}),e}function qe(t){const e={municipalityData:{},totalTarget:0,totalActual:0,retention:{count:0,resign:0},velocity:{totalDays:0,count:0}};return Object.entries(se).forEach(([o,n])=>{e.municipalityData[o]={actual:0,target:n},e.totalTarget+=n}),t.forEach(o=>{const n=(o.office||"").toUpperCase();let r="OTHER";for(const s in se)if(n.includes(s)){r=s;break}if(e.municipalityData[r]&&(e.municipalityData[r].actual++,e.totalActual++),(o.remarks||"ONGOING").toUpperCase()==="RESIGNED"?e.retention.resign++:e.retention.count++,o.createdAt&&o.startDate){const s=new Date(o.createdAt),i=new Date(o.startDate),d=Math.ceil((i-s)/(1e3*60*60*24));d>=0&&d<180&&(e.velocity.totalDays+=d,e.velocity.count++)}}),e}function He(t){const e=t.totalTarget>0?(t.totalActual/t.totalTarget*100).toFixed(1):0;document.querySelectorAll(".metric-utilization-rate").forEach(a=>{a.textContent=e+"%";const s=a.parentElement?.nextElementSibling?.firstElementChild;s&&(s.style.width=e+"%")});const o=t.velocity.count>0?(t.velocity.totalDays/t.velocity.count).toFixed(1):"14.2";document.querySelectorAll(".metric-velocity-avg").forEach(a=>a.textContent=o);const n=t.retention.count+t.retention.resign,r=n>0?(t.retention.count/n*100).toFixed(1):"100";document.querySelectorAll(".metric-retention-rate").forEach(a=>a.textContent=r+"%")}function Ue(t){const e=Object.values(t.offices).reduce((u,k)=>u+k,0);document.querySelectorAll(".metric-total-beneficiaries").forEach(u=>u.textContent=e);const o=t.genders.Female||0,n=t.genders.Male||0,r=o+n,a=r>0?Math.round(o/r*100)+"%":"0%",s=r>0?Math.round(n/r*100)+"%":"0%";document.querySelectorAll(".metric-female-ratio").forEach(u=>u.textContent=a),document.querySelectorAll(".metric-male-ratio").forEach(u=>u.textContent=s);const i=Object.keys(t.offices).length;document.querySelectorAll(".metric-deployment-sites").forEach(u=>u.textContent=i);const d=t.ageCount>0?Math.round(t.totalAge/t.ageCount):0;document.querySelectorAll(".metric-avg-age").forEach(u=>u.textContent=d),document.querySelectorAll(".metric-avg-age-range").forEach(u=>u.textContent=d+" YRS"),Object.entries({"College Grad":".count-college-grad","College Lvl":".count-college-lvl","HS Grad":".count-hs-grad","Senior High":".count-senior-high"}).forEach(([u,k])=>{document.querySelectorAll(k).forEach(P=>P.textContent=t.education[u]||0)});const h=Object.values(t.designations).reduce((u,k)=>u+k,0);let p=0;Object.entries(t.designations).forEach(([u,k])=>{u.toLowerCase().match(/field|driver|maintenance/)&&(p+=k)}),document.querySelectorAll(".count-office-based").forEach(u=>u.textContent=h-p),document.querySelectorAll(".count-field-based").forEach(u=>u.textContent=p);const b=Object.entries(t.designations).sort((u,k)=>k[1]-u[1])[0]?.[0]||"N/A";document.querySelectorAll(".metric-top-role").forEach(u=>u.textContent=b)}function Ge(t){const e=document.querySelector("#lastDaysdropdown ul");if(!e)return;let o=`
        <li><a href="javascript:void(0)" onclick="updateWorkforceFilter('ALL', 'Overall Stats')" class="block px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors uppercase tracking-widest ${C==="ALL"?"bg-royal-blue/10 text-royal-blue":""}">Overall Stats</a></li>
        <li class="border-t border-slate-100 dark:border-slate-700 my-1"></li>
        <li><a href="javascript:void(0)" onclick="updateWorkforceFilter('7D', 'Last 7 Days')" class="block px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors uppercase tracking-widest ${C==="7D"?"bg-royal-blue/10 text-royal-blue":""}">Last 7 Days</a></li>
        <li><a href="javascript:void(0)" onclick="updateWorkforceFilter('30D', 'Last 30 Days')" class="block px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors uppercase tracking-widest ${C==="30D"?"bg-royal-blue/10 text-royal-blue":""}">Last 30 Days</a></li>
        <li><a href="javascript:void(0)" onclick="updateWorkforceFilter('90D', 'Last 90 Days')" class="block px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors uppercase tracking-widest ${C==="90D"?"bg-royal-blue/10 text-royal-blue":""}">Last 90 Days</a></li>
        <li class="border-t border-slate-100 dark:border-slate-700 my-1"></li>
    `;t.forEach(n=>{o+=`<li><a href="javascript:void(0)" onclick="updateWorkforceFilter('${n}', 'Year ${n}')" class="block px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors uppercase tracking-widest ${C===n?"bg-royal-blue/10 text-royal-blue":""}">Year ${n}</a></li>`}),e.innerHTML=o}function ze(t,e){C=t,pe=e;const o=document.getElementById("lastDaysdropdown");if(o&&window.FlowbiteInstances){const n=window.FlowbiteInstances.getInstance("Dropdown","lastDaysdropdown");n&&n.hide()}else o&&o.classList.add("hidden");ee()}window.updateWorkforceFilter=ze;document.addEventListener("themeChanged",()=>{setTimeout(()=>ee(),50)});let Q=null,Z="default",X=0,W=localStorage.getItem("last_notified_id")?parseInt(localStorage.getItem("last_notified_id")):0;function We(){const t=v();Q=new Audio(`${t}backend/src/assets/sounds/ping-ding.mp3`),Ye(),Ve(),Ke(),j()}async function Ye(){if(!("Notification"in window)){console.log("This browser does not support notifications");return}if(Notification.permission==="default"){const{default:t}=await De(async()=>{const{default:o}=await import("./vendor-swal-BSk0fVSb.js");return{default:o}},[]);if((await t.fire({title:"Enable Notifications?",html:`
                <div class="text-left">
    ...
    `}function ge(t){const e=document.getElementById("notificationList");if(!e)return;const o=e.scrollTop;if(t.length===0){e.innerHTML=`
        ...
        `;return}const n=t.map(r=>Qe(r)).join("");e.innerHTML=n,requestAnimationFrame(()=>{e.scrollTop=o})}function Qe(t){const e=Xe(t.created_at),o=Ze(e),n=t.is_read===0;return`
    ...
    `}function Ze(t){const e=t.minutes;return e<1?`
        ...
        `,t.style.opacity="1"},300);try{const e=await L("api/notifications.php",{method:"POST",body:JSON.stringify({action:"clear_all"})}),o=e.data;e.success&&o.success}catch(e){console.error("Error clearing notifications:",e)}}};window.markAsRead=async function(t){v();const e=document.querySelector(`[data-notification-id="${t}"]`);if(e){const o=e.querySelector(".notification-marker");o&&(o.style.display="none"),e.classList.remove("bg-emerald-50/20","dark:bg-emerald-500/5","border-l-4","border-emerald-500","shadow-xs"),e.classList.add("opacity-60","grayscale-[0.2]","border-l-4","border-transparent");const n=e.querySelector(".rounded-full");if(n){n.classList.remove("bg-gradient-to-br","from-royal-blue","to-blue-700"),n.classList.add("bg-slate-200","dark:bg-slate-700");const r=n.querySelector("svg");r&&r.classList.add("text-slate-400","dark:text-slate-500")}}X>0&&B(X-1);try{await L("api/notifications.php",{method:"POST",body:JSON.stringify({action:"mark_read",notification_id:t})})}catch(o){console.error("Error marking notification as read:",o)}};function Ke(){setInterval(async()=>{await he()},1e4)}async function he(){v();const t=document.getElementById("notificationDropdown");try{const e=await L("api/notifications.php?check_new=1"),o=e.data;if(e.success&&o.success){if(B(o.unread_count),t&&!t.classList.contains("hidden")){const n=await L("api/notifications.php"),r=n.data;n.success&&r.success&&ge(r.notifications)}if(o.has_new){const n=o.latest_notification;n&&n.id>W&&(W=n.id,localStorage.setItem("last_notified_id",W),et(),tt(n))}}}catch(e){console.error("Error checking notifications:",e)}}function et(){const t=JSON.parse(localStorage.getItem("user")||"{}"),e=t.notifications_enabled!==void 0?parseInt(t.notifications_enabled)===1:!0;e&&Q?Q.play().catch(o=>{console.log("Could not play notification sound (Interaction-required or muted):",o)}):e||console.log("Notification sound muted by user preference")}function tt(t){if(Z==="granted"&&t){const e=JSON.parse(localStorage.getItem("user")||"{}"),o=e.notifications_enabled!==void 0?parseInt(e.notifications_enabled)===1:!0;new Notification("DOLE-GIP System",{body:t.message,icon:`${v()}frontend/images/logo/doleiligan.png`,badge:`${v()}frontend/images/logo/doleiligan.png`,tag:`notification-${t.id}`,requireInteraction:!1,silent:!o})}}async function ot(t,e="info"){v();try{const o=await L("api/notifications.php",{method:"POST",body:JSON.stringify({action:"create",message:t,type:e})}),n=o.data;return o.success&&n.success&&await he(),n}catch(o){return console.error("Error creating notification:",o),{success:!1,error:o.message}}}const ce="dole-gip-db",nt=2,f={BENEFICIARIES:"beneficiaries",SYNC_QUEUE:"sync_queue",METADATA:"metadata",APP_CACHE:"app_cache"};let _=null;function D(){return _?Promise.resolve(_):new Promise((t,e)=>{const o=indexedDB.open(ce,nt);o.onupgradeneeded=n=>{const r=n.target.result;if(!r.objectStoreNames.contains(f.BENEFICIARIES)){const a=r.createObjectStore(f.BENEFICIARIES,{keyPath:"id"});a.createIndex("name","name",{unique:!1}),a.createIndex("office","office",{unique:!1}),a.createIndex("remarks","remarks",{unique:!1})}r.objectStoreNames.contains(f.SYNC_QUEUE)||r.createObjectStore(f.SYNC_QUEUE,{keyPath:"queueId",autoIncrement:!0}).createIndex("status","status",{unique:!1}),r.objectStoreNames.contains(f.METADATA)||r.createObjectStore(f.METADATA,{keyPath:"key"}),r.objectStoreNames.contains(f.APP_CACHE)||r.createObjectStore(f.APP_CACHE,{keyPath:"key"})},o.onsuccess=n=>{_=n.target.result,console.log("[DB] IndexedDB opened:",ce),t(_)},o.onerror=n=>{console.error("[DB] Failed to open IndexedDB:",n.target.error),e(n.target.error)}})}async function rt(t){const e=await D();return new Promise((o,n)=>{const r=e.transaction(f.BENEFICIARIES,"readwrite"),a=r.objectStore(f.BENEFICIARIES);a.clear(),t.forEach(s=>{const i={...s,id:s.id||s.gip_id};a.put(i)}),r.oncomplete=()=>{dt("beneficiaries_last_sync",Date.now()),console.log(`[DB] Cached ${t.length} beneficiaries locally`),o(t.length)},r.onerror=()=>n(r.error)})}async function H(){const t=await D();return new Promise((e,o)=>{const a=t.transaction(f.BENEFICIARIES,"readonly").objectStore(f.BENEFICIARIES).getAll();a.onsuccess=()=>e(a.result||[]),a.onerror=()=>o(a.error)})}async function at(t){const e=await D();return new Promise((o,n)=>{const a=e.transaction(f.BENEFICIARIES,"readwrite").objectStore(f.BENEFICIARIES),s={...t,id:t.id||t.gip_id},i=a.put(s);i.onsuccess=()=>o(i.result),i.onerror=()=>n(i.error)})}async function st(){const t=await me("beneficiaries_last_sync");return t?Date.now()-t:1/0}async function it(t,e,o){const n=await D();return new Promise((r,a)=>{const i=n.transaction(f.SYNC_QUEUE,"readwrite").objectStore(f.SYNC_QUEUE),d={method:t,endpoint:e,payload:o,status:"pending",attempts:0,createdAt:Date.now(),lastAttempt:null},l=i.add(d);l.onsuccess=()=>{console.log(`[SyncQueue] Enqueued ${t} ${e} (id: ${l.result})`),r(l.result)},l.onerror=()=>a(l.error)})}async function U(){const t=await D();return new Promise((e,o)=>{const s=t.transaction(f.SYNC_QUEUE,"readonly").objectStore(f.SYNC_QUEUE).index("status").getAll("pending");s.onsuccess=()=>e(s.result||[]),s.onerror=()=>o(s.error)})}async function le(t,e,o={}){const n=await D();return new Promise((r,a)=>{const i=n.transaction(f.SYNC_QUEUE,"readwrite").objectStore(f.SYNC_QUEUE),d=i.get(t);d.onsuccess=()=>{const l=d.result;if(!l)return r();const h={...l,status:e,lastAttempt:Date.now(),attempts:(l.attempts||0)+1,...o},p=i.put(h);p.onsuccess=()=>r(),p.onerror=()=>a(p.error)},d.onerror=()=>a(d.error)})}async function ct(t){const e=await D();return new Promise((o,n)=>{const s=e.transaction(f.SYNC_QUEUE,"readwrite").objectStore(f.SYNC_QUEUE).delete(t);s.onsuccess=()=>o(),s.onerror=()=>n(s.error)})}async function lt(){return(await U()).length}async function dt(t,e){const o=await D();return new Promise((n,r)=>{const i=o.transaction(f.METADATA,"readwrite").objectStore(f.METADATA).put({key:t,value:e});i.onsuccess=()=>n(),i.onerror=()=>r(i.error)})}async function me(t){const e=await D();return new Promise((o,n)=>{const s=e.transaction(f.METADATA,"readonly").objectStore(f.METADATA).get(t);s.onsuccess=()=>o(s.result?.value??null),s.onerror=()=>n(s.error)})}function ut(t){return t?btoa(encodeURIComponent(JSON.stringify(t))):null}function ft(t){if(!t)return null;try{return JSON.parse(decodeURIComponent(atob(t)))}catch(e){return console.error("[DB] Failed to decrypt local cache",e),null}}async function pt(t,e){const o=await D();return new Promise((n,r)=>{const s=o.transaction(f.APP_CACHE,"readwrite").objectStore(f.APP_CACHE),i={key:t,data:ut(e),updated_at:Date.now()},d=s.put(i);d.onsuccess=()=>{console.log(`[DB] Securely cached offline data for: ${t}`),n()},d.onerror=()=>r(d.error)})}async function gt(t){const e=await D();return new Promise((o,n)=>{const s=e.transaction(f.APP_CACHE,"readonly").objectStore(f.APP_CACHE).get(t);s.onsuccess=()=>{s.result&&s.result.data?o(ft(s.result.data)):o(null)},s.onerror=()=>n(s.error)})}async function ht(){const[t,e]=await Promise.all([H(),U()]),o=await me("beneficiaries_last_sync");return{localBeneficiaries:t.length,pendingSync:e.length,lastSync:o?new Date(o).toLocaleString():"Never"}}window.__doleDB={getStats:ht,getLocalBeneficiaries:H,getPendingSyncItems:U,setSecureCache:pt,getSecureCache:gt};const mt=3,de=8e3;let ue=null,Y=!1,T=null;function yt(){if(document.getElementById("sync-status-pill"))return;const t=document.createElement("div");t.id="sync-status-pill",t.style.cssText=`
        position: fixed;
        bottom: 16px;
        left: 16px;
        z-index: 9999;
    ...
    `,document.body.appendChild(t),T=t}function O(t,e=0){if(!T)return;const o={synced:{bg:"#dcfce7",color:"#15803d",border:"1px solid #bbf7d0",icon:"●",label:"All Synced",opacity:"1"},pending:{bg:"#fef9c3",color:"#854d0e",border:"1px solid #fde68a",icon:"⏳",label:`${e} Pending`,opacity:"1"},syncing:{bg:"#dbeafe",color:"#1d4ed8",border:"1px solid #bfdbfe",icon:"↑",label:"Syncing...",opacity:"1"},offline:{bg:"#fee2e2",color:"#b91c1c",border:"1px solid #fecaca",icon:"✕",label:"Offline – data saved locally",opacity:"1"}},n=o[t]||o.synced;Object.assign(T.style,{background:n.bg,color:n.color,border:n.border,opacity:n.opacity}),T.innerHTML=`<span>${n.icon}</span><span>${n.label}</span>`,t==="synced"&&setTimeout(()=>{T&&(T.style.opacity="0")},4e3)}function bt(){try{return JSON.parse(localStorage.getItem("user"))?.id||null}catch{return null}}async function xt(t){const e=bt(),o=`${v()}${t.endpoint}`,n={"Content-Type":"application/json",...e?{"X-User-Id":String(e)}:{}},r={method:t.method,headers:n},a=t.method==="PATCH"?`${o}?${new URLSearchParams(t.payload).toString()}`:o;t.method!=="PATCH"&&t.method!=="GET"&&(r.body=JSON.stringify(t.payload));const s=await fetch(a,r);if(!s.ok)throw new Error(`HTTP ${s.status}`);const i=await s.json();if(!i.success)throw new Error(i.error||"API returned failure");return!0}async function F(){if(Y)return;if(!navigator.onLine){O("offline");return}const t=await U();if(t.length===0)return;Y=!0,O("syncing",t.length);let e=0,o=0;for(const r of t){if((r.attempts||0)>=mt){await le(r.queueId,"failed"),o++;continue}try{await xt(r),await ct(r.queueId),e++,console.log(`[Sync] ✓ Pushed ${r.method} ${r.endpoint} (queueId: ${r.queueId})`)}catch(a){console.warn(`[Sync] ✗ Failed ${r.method} ${r.endpoint}:`,a.message),await le(r.queueId,"pending",{lastError:a.message}),o++}}Y=!1;const n=await lt();n===0?O("synced"):O("pending",n),console.log(`[Sync] Batch complete. ✓ ${e} synced, ✗ ${o} failed. ${n} remaining.`)}function wt(){ue||(F(),ue=setInterval(()=>{F()},de),window.addEventListener("online",()=>{console.log("[Sync] Back online — flushing queue immediately"),O("syncing"),F()}),window.addEventListener("offline",()=>{console.log("[Sync] Gone offline"),O("offline")}),console.log(`[Sync] Worker started (interval: ${de}ms)`))}let x=[],V=null,w=1;const M=10;let ye=null;async function be(){const t=await H();if(t.length>0){x=t,q(x);const n=localStorage.getItem("ldn_sort_preference");n?K(n,!1):I(),console.log(`[Offline-First] Rendered ${t.length} records from local cache`)}const e=await st(),o=30*1e3;if(e<o&&t.length>0){console.log(`[Offline-First] Cache is fresh (${Math.round(e/1e3)}s old), skipping remote fetch`);return}try{const r=await(await fetch(`${v()}api/beneficiaries.php`)).json();if(r.success&&r.beneficiaries){const a=r.beneficiaries,s=J(t),i=J(a);if(s!==i){await rt(a),x=a,q(x);const d=localStorage.getItem("ldn_sort_preference");d?K(d,!1):I(),console.log(`[Offline-First] Remote data synced and rendered (${a.length} records)`)}else console.log("[Offline-First] Remote data matches cache — no re-render needed")}}catch(n){console.warn("[Offline-First] Remote fetch failed (using local cache):",n.message)}}function q(t){const e=new Date;e.setHours(0,0,0,0),t.forEach(o=>{if(o.remarks==="ONGOING"&&o.endDate){const n=new Date(o.endDate);if(n.setHours(0,0,0,0),n<e){o.remarks="EXPIRED";const r={...o};fetch(`${v()}api/beneficiaries.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)}).catch(a=>console.error("Auto sync failed",a))}}})}function vt(){be(),Bt(),Lt(),Ct()}function Ct(){document.getElementById("beneficiary-table-body")&&Ie.start("beneficiaries",async()=>{if(window.BulkApp&&(window.BulkApp.isActive||Date.now()-(window.BulkApp.lastInteractionTime||0)<3e4))return;const o=await Be("api/beneficiaries.php");if(o.success&&o.data.beneficiaries){const n=o.data.beneficiaries;q(n);const r=J(n);V&&r!==V&&(x=n,I(),fe(),Le("Data Synced","Beneficiary list has been updated","info")),V=r}},1e4)}function I(t=x){const e=document.getElementById("beneficiary-table-body");if(!e)return;if(ye=t,t.length===0){e.innerHTML=`
            <tr>
        ...
        <tr class="bg-blue-50 border-b border-blue-100 hover:bg-blue-100 transition-colors group cursor-pointer"
            ...
            <td class="px-4 py-3 text-center">
                <div class="flex justify-center">
                    <span class="${St(i.office)} text-[10px] sm:text-xs font-bold px-2.5 py-0.5 rounded whitespace-nowrap">
                        ${i.office||"N/A"}
                    </span>
                </div>
            </td>
            ...
            <td class="px-4 py-3 text-center">
                <span class="${At(i.remarks)} text-xs font-bold px-2.5 py-0.5 rounded uppercase border">
                    ${i.remarks||"N/A"}
                </span>
            </td>
    ...
    `).join(""),kt(o,n),fe()}function kt(t,e){const o=document.getElementById("pagination-controls");if(!o)return;if(t<=M){o.innerHTML=`
    ...
    `}function Et(t,e){let o="",r=Math.max(1,t-1),a=Math.min(e,r+3-1);a-r+1<3&&(r=Math.max(1,a-3+1)),r>1&&(o+='<span class="px-2 text-gray-400">...</span>');for(let s=r;s<=a;s++)o+=`
        ...
        `;return a<e&&(o+='<span class="px-2 text-gray-400">...</span>'),o}window.changePage=t=>{w=t,I(ye||x)};function St(t){return t?t.includes("DOLE")?"bg-blue-100 text-blue-700 border border-blue-200 dark:!text-white":t.includes("DepEd")?"bg-orange-100 text-orange-700 border border-orange-200 dark:!text-white":t.includes("LGU")?"bg-purple-100 text-purple-700 border border-purple-200 dark:!text-white":t.includes("DICT")?"bg-cyan-100 text-cyan-700 border border-cyan-200 dark:!text-white":"bg-gray-100 text-gray-700 border border-gray-200 dark:!text-white":"bg-gray-100 text-gray-700 border border-gray-200 dark:!text-white"}function At(t){if(!t)return"bg-gray-100 text-gray-600 border-gray-200";const e=t.toUpperCase();return e==="ONGOING"?"bg-green-100 text-green-700 border-green-200":e==="EXPIRED"?"bg-red-400 text-white border-red-400":e==="RESIGNED"?"bg-[#ce1126] text-white border-[#ce1126]":e==="ABSORBED"?"bg-[#2e7d32] text-white border-[#2e7d32]":"bg-gray-100 text-gray-600 border-gray-200"}function K(t,e=!0){switch(e&&localStorage.setItem("ldn_sort_preference",t),t){case"name_asc":x.sort((n,r)=>{const a=n.name.localeCompare(r.name);return a!==0?a:new Date(n.createdAt)-new Date(r.createdAt)});break;case"name_desc":x.sort((n,r)=>{const a=r.name.localeCompare(n.name);return a!==0?a:new Date(n.createdAt)-new Date(r.createdAt)});break;case"office":x.sort((n,r)=>(n.office||"").localeCompare(r.office||""));break;case"remarks":x.sort((n,r)=>(n.remarks||"").localeCompare(r.remarks||""));break;case"education":x.sort((n,r)=>(n.education||"").localeCompare(r.education||""));break;case"work":x.sort((n,r)=>(n.designation||"").localeCompare(r.designation||""));break;case"address":x.sort((n,r)=>(n.address||"").localeCompare(r.address||""));break}w=1,I();const o=document.getElementById("sort-dropdown");o&&!o.classList.contains("hidden")&&o.classList.add("hidden")}async function Dt(t){const e={...t};["name","address","education","designation"].forEach(r=>{e[r]&&typeof e[r]=="string"&&(e[r]=e[r].toUpperCase().trim())});const n=e.id?"PUT":"POST";!e.id&&!e.gip_id&&(e._tempId=`temp_${Date.now()}_${Math.random().toString(36).slice(2,7)}`,e.id=e._tempId);try{await at(e),x=await H(),q(x),I(),console.log(`[Offline-First] ✓ Saved "${e.name}" to local cache`)}catch(r){console.error("[Offline-First] Local save failed:",r)}n==="POST"&&ot(`New user <strong>${e.name}</strong> added. pending "Required Documents" for review.`,"success");try{await it(n,"api/beneficiaries.php",e),F()}catch(r){console.error("[Offline-First] Failed to enqueue sync:",r)}return!0}async function It(t){if(!(await G.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Confirm Archive</span>',html:`
            <div class="py-4">
        ...
        `,reverseButtons:!0,customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-green-50 text-green-700 hover:bg-green-600 hover:text-white font-black text-xs px-6 py-2.5 rounded-xl transition-all border border-green-200 shadow-sm mx-2 cursor-pointer",cancelButton:"bg-red-50 text-red-700 hover:bg-red-600 hover:text-white font-black text-xs px-6 py-2.5 rounded-xl transition-all border border-red-200 shadow-sm mx-2 cursor-pointer"},buttonsStyling:!1})).isConfirmed)return!1;try{const n=await(await fetch(`${v()}api/beneficiaries.php?id=${encodeURIComponent(t)}&action=archive`,{method:"PATCH"})).json();if(n.success)return G.fire({toast:!0,position:"top-end",icon:"success",title:"Record Archived",showConfirmButton:!1,timer:3e3,timerProgressBar:!0}),await be(),!0;throw new Error(n.error||"Failed to archive")}catch(o){return console.error("Error archiving beneficiary:",o),G.fire({icon:"error",title:"Archive Failed",text:o.message}),!1}}function Bt(){const t=document.getElementById("ldn-header-container"),e=document.getElementById("ldn-header-text"),o=document.getElementById("ldn-header-icon");t&&e&&o&&(t.addEventListener("click",()=>{if(window.innerWidth<640)return;const n=e.innerText.trim(),r="Lanao Del Norte - GIP",a="LDN - GIP";e.querySelector(".sm\\:hidden")?.offsetParent,n.includes(r)?(e.innerHTML=a,o.classList.add("rotate-180")):(e.innerHTML=r,o.classList.remove("rotate-180"))}),t.classList.add("cursor-pointer","select-none","transition-all","duration-200"),o.classList.add("transition-transform","duration-200"))}function Lt(){const t=document.getElementById("table-search");t&&(t.addEventListener("input",e=>{const o=e.target.value.toLowerCase().trim();if(o===""){w=1,I(x);return}const n=x.filter(r=>r.name?.toLowerCase().includes(o)||!1||r.id?.toLowerCase().includes(o)||!1||r.office?.toLowerCase().includes(o)||!1||r.remarks?.toLowerCase().includes(o)||!1||r.designation?.toLowerCase().includes(o)||!1||r.address?.toLowerCase().includes(o)||!1||r.education?.toLowerCase().includes(o)||!1);w=1,I(n)}),window.addEventListener("keydown",e=>{e.key==="/"&&document.activeElement!==t&&(e.preventDefault(),t.focus())}))}window.sortData=K;window.archiveRecord=It;window.addBeneficiaryData=Dt;let te=[],E=["id","name","office","position","status"],g={office:"ALL",status:"ALL",search:"",sort:"name",section:"ALL",columns:["id","name","office","position","status"],preparedBy:localStorage.getItem("ldn_export_prepared")||"",approvedBy:localStorage.getItem("ldn_export_approved")||""};async function $t(){Nt(),await Ot()}function Nt(){const t=localStorage.getItem("ldn_export_config");if(t)try{const e=JSON.parse(t);g={...g,...e},E=g.columns}catch(e){console.error("Error loading saved export config",e)}}function Tt(){localStorage.setItem("ldn_export_config",JSON.stringify(g))}async function Ot(){try{const e=await(await fetch(`${v()}api/beneficiaries.php?all=true`)).json();e.success&&e.beneficiaries&&(te=e.beneficiaries,window.handleFilterUpdate(g))}catch(t){console.error("Error loading data for export",t)}}window.handleFilterUpdate=function(t){g={...g,...t},t.columns&&(E=t.columns),t.preparedBy!==void 0&&(g.preparedBy=t.preparedBy),t.approvedBy!==void 0&&(g.approvedBy=t.approvedBy),Tt();let e=[...te];g.search&&(e=e.filter(o=>o.name.toLowerCase().includes(g.search)||o.id.toLowerCase().includes(g.search))),g.office!=="ALL"&&(e=e.filter(o=>o.office.includes(g.office))),g.status!=="ALL"&&(e=e.filter(o=>o.remarks.toUpperCase()===g.status.toUpperCase())),g.section==="ACTIVE"?e=e.filter(o=>!o.isArchived):g.section==="ARCHIVED"&&(e=e.filter(o=>o.isArchived)),g.sort&&e.sort((o,n)=>{switch(g.sort){case"name":return(o.name||"").localeCompare(n.name||"");case"id":return(o.id||"").localeCompare(n.id||"");case"office":return(o.office||"").localeCompare(n.office||"");case"startdate":const r=new Date(o.startDate||0);return new Date(n.startDate||0)-r;default:return 0}}),Mt(e)};window.getExportFilters=()=>g;function Mt(t){Rt(t),_t(t);const e=document.getElementById("record-count");e&&(e.textContent=t.length),window.currentFilteredData=t}window.exportToExcel=function(){const t=window.currentFilteredData||te,e=E,o=`
        ...
        <body>
            <table>
                ...
                ${(()=>{let s=null,i="";[...t].sort((l,h)=>l.isArchived-h.isArchived).forEach(l=>{l.isArchived!==s&&(s=l.isArchived,i+=`<tr><td colspan="${e.length}" class="cell divider">${s?"ARCHIVED RECORDS":"ACTIVE BENEFICIARIES"}</td></tr>`),i+=`<tr>${e.map(h=>{let p=l[h]||"-";return h==="position"&&(p=l.designation||"-"),h==="startdate"&&(p=l.startDateFormatted||l.startDate||"-"),h==="enddate"&&(p=l.endDateFormatted||l.endDate||"-"),h==="status"?(p=l.remarks||"N/A",`<td class="cell ${"status-"+p.toLowerCase()}">${p}</td>`):`<td class="cell">${p}</td>`}).join("")}</tr>`})})()}
                <tr><td colspan="${e.length}"></td></tr>
                <tr><td colspan="${e.length}"></td></tr>
                <tr>
    ...
    `}function xe(t,e,o=!1){return e.map(n=>{let r=t[n]||"-";if(n==="position"&&(r=t.designation||"-"),n==="startdate"&&(r=t.startDateFormatted||t.startDate||"-"),n==="enddate"&&(r=t.endDateFormatted||t.endDate||"-"),n==="status"&&(r=t.remarks||"N/A"),o){let a="px-3 py-2 border border-gray-200 text-center";return n==="id"&&(a+=" font-mono font-bold"),n==="name"&&(a+=" font-bold text-black uppercase leading-tight text-left px-4"),n==="status"&&(a+=` text-center font-bold uppercase ${{ABSORBED:"text-golden-yellow",RESIGNED:"text-slate-500",EXPIRED:"text-philippine-red",ONGOING:"text-green-600"}[r]||"text-gray-500"}`),(n==="startdate"||n==="enddate")&&(a+=" text-center font-mono text-[9px]"),`<td class="${a}">${r}</td>`}else return n==="id"?`<th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap font-mono text-xs text-center">${r}</th>`:n==="name"?`<td class="px-4 py-3 font-bold text-royal-blue group-hover/row:translate-x-1 transition-transform uppercase">${r}</td>`:n==="office"?`<td class="px-4 py-3 text-center"><span class="bg-white text-blue-700 px-2 py-0.5 rounded text-[10px] border border-blue-100 font-bold shadow-sm">${r}</span></td>`:n==="status"?`<td class="px-4 py-3 text-center"><span class="${{ABSORBED:"bg-golden-yellow/10 text-golden-yellow border-golden-yellow/20",RESIGNED:"bg-slate-100 text-slate-500 border-slate-200",EXPIRED:"bg-red-50 text-philippine-red border-red-100",ONGOING:"bg-green-50 text-green-600 border-green-100"}[r]||"bg-gray-100 text-gray-700 border-gray-200"} px-2 py-0.5 rounded text-xs border uppercase font-bold text-[10px] shadow-sm">${r}</span></td>`:n==="startdate"?`<td class="px-4 py-3 text-center text-[11px] font-black text-royal-blue uppercase tracking-tight">${r}</td>`:n==="enddate"?`<td class="px-4 py-3 text-center text-[11px] font-black text-philippine-red uppercase tracking-tight">${r}</td>`:`<td class="px-4 py-3 text-xs font-semibold text-gray-500 text-center">${r}</td>`}).join("")}function Rt(t){const e=document.querySelector(".overflow-x-auto table");if(!e)return;const o=e.querySelector("thead"),n=document.getElementById("web-table-body");if(o.innerHTML=Pt(E),t.length===0){n.innerHTML=`<tr><td colspan="${E.length}" class="px-6 py-12 text-center text-gray-400 font-medium italic">No matching records found.</td></tr>`;return}const r=[...t].sort((l,h)=>l.isArchived!==h.isArchived?l.isArchived-h.isArchived:0);let a=null,s=null,i="";const d=g.section==="ALL";r.forEach(l=>{d&&l.isArchived!==a&&(a=l.isArchived,s=null,i+=`
        ...
        `}),n.innerHTML=i}function _t(t){const e=document.getElementById("print-area");if(!e)return;const n=e.querySelector("table").querySelector("thead"),r=document.getElementById("print-table-body");n.innerHTML=`
        <tr class="text-white bg-royal-blue font-bold uppercase tracking-wider text-[10px] text-center">
            ${E.map(b=>{let u="";return b==="name"&&(u=' title="Last Name, First Name, Middle Initial"'),`<th class="px-3 py-2 border border-royal-blue"${u}>${oe[b]||b.toUpperCase()}</th>`}).join("")}
        </tr>
    `;const a=document.getElementById("print-prepared-by"),s=document.getElementById("print-approved-by");a&&(a.textContent=g.preparedBy),s&&(s.textContent=g.approvedBy);const i=[...t].sort((b,u)=>b.isArchived!==u.isArchived?b.isArchived-u.isArchived:0);let d=null,l=null,h="";const p=g.section==="ALL";i.forEach((b,u)=>{p&&b.isArchived!==d&&(d=b.isArchived,l=null,h+=`
                <tr class="print:bg-gray-200 bg-gray-200">
                    <td colspan="${E.length}" class="px-3 py-1 border border-gray-400 text-center">
                        <span class="text-[10px] font-black uppercase tracking-[0.2em]">${d?"SECTION: ARCHIVED RECORDS":"SECTION: ACTIVE BENEFICIARIES"}</span>
                    </td>
                </tr>
            `),b.office!==l&&(l=b.office,h+=`
        ...
        `}),r.innerHTML=h}$e();Ne();window.initFlowbite=Ae;document.addEventListener("DOMContentLoaded",()=>{console.log("DOLE System initialized");const t=window.location.pathname;Te(),Oe(),Me(),ee(),vt(),Pe(),qt(),Ht(),We(),yt(),wt(),t.includes("/export/")&&$t(),Ft(),jt()});function Ft(){document.querySelectorAll(".togglePassword").forEach(e=>{const o=e.closest(".relative").querySelector("input");e&&o&&e.addEventListener("click",()=>{const n=o.getAttribute("type")==="password"?"text":"password";o.setAttribute("type",n);const r=e.querySelector(".eye-open"),a=e.querySelector(".eye-closed");r&&a&&(r.classList.toggle("hidden"),a.classList.toggle("hidden"))})})}function jt(){const t=new Image;t.crossOrigin="Anonymous",t.onload=function(){const n=document.createElement("canvas"),r=64;n.width=r,n.height=r;const a=n.getContext("2d");a.beginPath(),a.arc(r/2,r/2,r/2,0,2*Math.PI),a.closePath(),a.clip(),a.drawImage(t,0,0,r,r);let s=document.querySelector("link[rel~='icon']");s||(s=document.createElement("link"),s.rel="icon",document.getElementsByTagName("head")[0].appendChild(s)),s.type="image/png",s.href=n.toDataURL()};const e=window.location.pathname;let o="";e.includes("/dole-system/")&&(o=e.substring(0,e.indexOf("/dole-system/")+13)),t.src=`${o}frontend/images/logo/doleiligan.png`}function qt(){const t=document.querySelectorAll(".auto-year"),e=new Date().getFullYear();t.forEach(o=>{o.textContent=e})}async function Ht(){try{let t="";try{const n=JSON.parse(localStorage.getItem("user"));n&&n.id&&(t=`?user_id=${n.id}`)}catch{}const o=await(await fetch(`${v()}api/profile.php${t}`)).json();o.success&&Re(o.profile)}catch(t){console.error("Error loading user profile:",t)}}
