    ...
    <div class="grid grid-cols-12 gap-4 mt-6 w-full">
        ...
        <div class="col-span-7 flex flex-col gap-1 text-left overflow-hidden w-full">
            ...
            <div class="flex justify-start items-center w-full gap-2 min-h-[30px] font-montserrat flex-nowrap">
                <span class="${at(e.remarks)} text-[0.5625rem] sm:text-[0.625rem] font-black px-2.5 sm:px-4 py-2 rounded-lg border uppercase tracking-widest shadow-sm border-l-4 ${e.remarks==="ONGOING"?"border-l-green-600":"border-l-red-600"} min-w-[80px] sm:min-w-[100px] text-center inline-block whitespace-nowrap">${e.remarks}</span>
                <span class="${ot(e.office)} inline-block text-[0.5625rem] sm:text-[0.625rem] font-black px-2.5 sm:px-4 py-2 rounded-lg border shadow-sm min-w-[80px] sm:min-w-[100px] text-center whitespace-nowrap max-w-full truncate" title="${e.office}">${e.office}</span>
            </div>
        </div>
    </div>
</div>
