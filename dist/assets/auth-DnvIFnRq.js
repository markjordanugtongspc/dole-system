...
import p from"./vendor-swal-BSk0fVSb.js";const G="color-theme",fe=3600*24*365;function be(e,o,a){document.cookie=`${e}=${o}; max-age=${a}; path=/; SameSite=Lax`}function ae(e){const o=document.cookie.match(new RegExp("(?:^|; )"+e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")+"=([^;]*)"));return o?decodeURIComponent(o[1]):null}function se(){const e=localStorage.getItem(G)||ae(G);return e==="dark"||e==="light"?e:"light"}function J(e){const o=document.documentElement;e==="dark"?o.classList.add("dark"):o.classList.remove("dark"),localStorage.setItem(G,e),be(G,e,fe),xe(e),document.dispatchEvent(new CustomEvent("themeChanged",{detail:{theme:e}}))}function K(){const e=se();J(e==="dark"?"light":"dark")}function xe(e){const o=e==="dark",a=document.getElementById("pref-dark-mode");a&&(a.checked=o);const n=document.getElementById("theme-toggle-dark-icon"),r=document.getElementById("theme-toggle-light-icon");n&&r&&(n.classList.toggle("hidden",o),r.classList.toggle("hidden",!o));const t=document.getElementById("sidebar-theme-label");t&&(t.textContent=o?"Light Mode":"Dark Mode")}function Ie(){const e=se();J(e);const o=document.getElementById("pref-dark-mode");o&&o.addEventListener("change",()=>{J(o.checked?"dark":"light")});const a=document.getElementById("theme-toggle-btn");a&&a.addEventListener("click",K),document.querySelectorAll("[data-theme-toggle]").forEach(n=>{n.addEventListener("click",K)}),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",n=>{localStorage.getItem(G)||ae(G)||J(n.matches?"dark":"light")})}function F(){return document.documentElement.classList.contains("dark")}window.toggleTheme=K;window.isDarkMode=F;const X={queue:[],currentIndex:0,isActive:!1,lastInteractionTime:0,init(){this.showUploadModal()},showUploadModal(){const e=F(),o={bgCard:e?"bg-slate-900/40":"bg-gray-50/40",borderCard:e?"border-slate-800":"border-gray-100",textHeading:e?"text-green-500":"text-[#2e7d32]",textSubtitle:e?"text-slate-500":"text-gray-400 dark:text-gray-300",bgUpload:e?"bg-slate-800":"bg-white",borderUpload:e?"border-slate-700":"border-gray-200",textUpload:e?"text-slate-400":"text-gray-500",hoverUpload:e?"hover:bg-slate-800/80 hover:border-blue-500":"hover:bg-blue-50/50 hover:border-royal-blue",iconText:e?"text-green-400":"text-[#2e7d32]",iconBg:e?"bg-green-900/20":"bg-[#e8f5e9]",iconBorder:e?"border-green-800/30":"border-[#c8e6c9]"},a=`
...
<style>
    ...
    `;let d=document.getElementById("beneficiary-drawer-container");d&&d.remove(),d=document.createElement("div"),d.id="beneficiary-drawer-container",d.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-neutral-primary-soft dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl",d.setAttribute("tabindex","-1"),d.setAttribute("data-drawer-backdrop","true"),d.innerHTML=c,document.body.appendChild(d),ne(async()=>{const{Drawer:l}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:l}},__vite__mapDeps([0,1])).then(({Drawer:l})=>{const g={placement:"right",backdrop:!0,bodyScrolling:!1,edge:!1,edgeOffset:"",backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{d&&d.parentNode&&d.remove()},300)}},b=new l(d,g);b.show(),d.querySelector("#close-drawer-btn").addEventListener("click",()=>b.hide());const x=d.querySelector("#drawer-prev-btn"),$=d.querySelector("#drawer-next-btn"),D=2,I=()=>{d.querySelectorAll("[id^=drawer-page-]").forEach((w,S)=>{w.classList.toggle("hidden",S!==a)}),x.disabled=a===0,$.disabled=a===D,x.classList.toggle("opacity-50",a===0),$.classList.toggle("opacity-50",a===D)};x.addEventListener("click",()=>{a>0&&a--,I()}),$.addEventListener("click",()=>{a<D&&a++,I()}),I(),d.querySelectorAll(".drawer-doc-btn").forEach(w=>{w.addEventListener("click",async()=>{const S=w.dataset.name,E=w.dataset.status,C=await p.fire({title:'<span class="text-xl font-black text-heading uppercase tracking-tight">Update Document</span>',html:`
                ...
                `,focusConfirm:!1,showCancelButton:!0,confirmButtonText:'<span class="font-black uppercase tracking-widest">SAVE REVISIONS</span>',cancelButtonText:'<span class="font-black uppercase tracking-widest">CANCEL</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-brand text-white hover:bg-brand-strong text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1,preConfirm:()=>({val:document.getElementById("swal-log-val").value.trim().toUpperCase()})});if(L&&L.val!==C)try{const u={type:S,id:E,status:"PENDING"};S==="dtr"&&(u.record_date=L.val),S==="ar"&&(u.period=L.val);const m=await(await fetch(`${B()}api/logs.php`,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)})).json();m.success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Log Updated!",showConfirmButton:!1,timer:1500}),b.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error",m.error||"Failed to update log.","error")}catch(u){p.fire("Error",u.message,"error")}},T=d.querySelector("#add-dtr-log-btn");T&&T.addEventListener("click",()=>H("dtr",N()));const P=d.querySelector("#add-ar-log-btn");P&&P.addEventListener("click",()=>H("ar",A())),d.querySelectorAll(".edit-log-btn").forEach(w=>{w.addEventListener("click",S=>{if(S.target.closest(".delete-log-btn"))return;const E=w.dataset.type,C=w.dataset.id,v=w.dataset.val;Y(E.toUpperCase(),E,C,v)})}),d.querySelectorAll(".delete-log-btn").forEach(w=>{w.addEventListener("click",async()=>{const S=w.dataset.id,E=w.dataset.type;if((await p.fire({title:'<span class="text-xl font-black text-philippine-red uppercase tracking-tight">Delete item?</span>',text:"This action cannot be undone.",icon:"warning",showCancelButton:!0,confirmButtonText:'<span class="font-black tracking-widest uppercase">Delete</span>',cancelButtonText:'<span class="font-black tracking-widest uppercase">Wait</span>',customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl border border-gray-100",confirmButton:"bg-philippine-red text-white hover:bg-red-700 text-xs px-6 py-2.5 rounded-xl border border-transparent shadow-sm mx-2",cancelButton:"bg-gray-100 text-gray-600 hover:bg-gray-200 text-xs px-6 py-2.5 rounded-xl border border-gray-200 shadow-sm mx-2"},buttonsStyling:!1})).isConfirmed)try{const v=new FormData;v.append("log_id",S),v.append("action","delete");const u=await(await fetch(`${B()}api/logs.php?type=${E}`,{method:"POST",body:v})).text();let f={success:!1};try{f=JSON.parse(u)}catch{}f.success?(p.fire({toast:!0,position:"top-end",icon:"success",title:"Deleted",showConfirmButton:!1,timer:1500}),b.hide(),setTimeout(()=>window.viewBeneficiary(e,a),400)):p.fire("Error","Failed to delete data.","error")}catch(v){p.fire("Error",v.message,"error")}})})}).catch(console.error)}async function ie(e,o={}){const n=`${B()}${e}`;let r=null;try{const i=JSON.parse(localStorage.getItem("user"));i&&i.id&&(r=i.id)}catch{}const t={headers:{"Content-Type":"application/json",...r?{"X-User-Id":r}:{},...o.headers},...o};try{const i=await fetch(n,t);if(!i.ok)throw new Error(`HTTP ${i.status}: ${i.statusText}`);return{success:!0,data:await i.json()}}catch(i){return console.error("API Request Error:",i),{success:!1,error:i.message}}}async function Me(e){return ie(e,{method:"GET"})}class we{constructor(){this.intervals=new Map,this.isPageVisible=!0,document.addEventListener("visibilitychange",()=>{this.isPageVisible=!document.hidden,this.isPageVisible?console.log("[Polling] Page visible - resuming normal activity"):console.log("[Polling] Page hidden - reducing activity")})}start(o,a,n=1e4){this.stop(o),a();const r=setInterval(async()=>{this.isPageVisible&&await a()},n);this.intervals.set(o,r),console.log(`[Polling] Started: ${o} (every ${n}ms)`)}stop(o){this.intervals.has(o)&&(clearInterval(this.intervals.get(o)),this.intervals.delete(o),console.log(`[Polling] Stopped: ${o}`))}stopAll(){this.intervals.forEach((o,a)=>this.stop(a)),console.log("[Polling] All intervals stopped")}getActivePolls(){return Array.from(this.intervals.keys())}}const ye=new we;function Ae(){typeof window.initFlowbite=="function"?(window.initFlowbite(),console.log("[Flowbite] Components re-initialized")):console.warn("[Flowbite] initFlowbite() not available globally")}function je(e,o="",a="info"){p.fire({toast:!0,position:"top-end",icon:a,title:e,text:o,showConfirmButton:!1,timer:3e3,timerProgressBar:!0})}function Ne(e){return JSON.stringify(e)}window.addEventListener("beforeunload",()=>{ye.stopAll()});function ke(e){const o=F(),a=`w-full bg-transparent border-b-2 ${o?"border-slate-700 text-white focus:border-brand placeholder-slate-600":"border-gray-200 text-gray-900 focus:border-brand placeholder-gray-300"} px-1 py-1 text-sm font-black outline-none transition-all focus:ring-0`,n=`w-full bg-transparent border-none ${o?"text-white":"text-royal-blue"} px-0 py-0 text-xl sm:text-2xl font-black leading-tight tracking-tight focus:ring-0 outline-none placeholder-gray-300 resize-none overflow-hidden`;function r(s){if(!s)return"";const c=new Date(s),d=new Date;let l=d.getFullYear()-c.getFullYear();const g=d.getMonth()-c.getMonth();return(g<0||g===0&&d.getDate()<c.getDate())&&l--,l>=0?l:0}const t=`
    ...
    <div class="flex flex-col gap-4 text-sm mt-4 px-1">
        ...
        <div class="flex flex-col gap-2">
            ...
            <datalist id="work-suggestions">
                ${de.map(s=>`<option value="${s}"></option>`).join("")}
            </datalist>
        </div>
...
.text-right-select { text-align-last: right; }
    ...
    `;let i=document.getElementById("edit-drawer-container");i&&i.remove(),i=document.createElement("div"),i.id="edit-drawer-container",i.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-white dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl pb-0",i.setAttribute("tabindex","-1"),i.innerHTML=t,document.body.appendChild(i),setTimeout(()=>{const s=i.querySelector('textarea[name="name"]');s&&(s.style.height="auto",s.style.height=s.scrollHeight+"px")},10),(async()=>{try{const s=await ie("api/beneficiaries.php?get_offices=1");if(s.success&&s.data.offices){const c=i.querySelector("#edit-office-suggestions");if(c){const d=["DOLE Field Office","LGU","DEPED","DICT","PCA"],l=[...new Set([...d,...s.data.offices])];c.innerHTML=l.map(g=>`<option value="${g}">`).join("")}}}catch(s){console.error("Error fetching office suggestions:",s)}})(),ne(async()=>{const{Drawer:s}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:s}},__vite__mapDeps([0,1])).then(({Drawer:s})=>{const c=new s(i,{placement:"right",backdrop:!0,bodyScrolling:!1,backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{i.parentNode&&i.remove()},300)}});c.show(),i.querySelector("#close-edit-drawer-btn").addEventListener("click",()=>c.hide()),i.querySelector("#edit-drawer-cancel-btn").addEventListener("click",()=>c.hide());const d=i.querySelector("#edit-bday-input"),l=i.querySelector("#edit-age-display");d&&l&&d.addEventListener("change",b=>{b.target.value&&(l.value=r(b.target.value))});const g=i.querySelector("#edit-beneficiary-drawer-form");g.addEventListener("submit",b=>{b.preventDefault();const h=new FormData(g),x={};h.forEach(($,D)=>x[D]=$),x.id=e.id,x.gip_id=e.id,window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(x,!0,!1)){c.hide();const D=document.querySelector("#close-drawer-btn");D&&D.click(),p.fire({toast:!0,position:"top-end",icon:"success",title:"Record Updated",showConfirmButton:!1,timer:3e3})}})()})})}function re(e="Incorrect Username or Password"){p.fire({html:`
            <div class="p-6">
        ...
        `,timer:e?800:3e3,timerProgressBar:!0,showConfirmButton:!1,showCloseButton:!1,width:"350px",padding:"0",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-hidden border border-gray-100",timerProgressBar:"bg-green-500 h-1.5"},backdrop:"rgba(0, 0, 0, 0.4)"})}function Oe(){window.viewBeneficiary=async function(e,o=0){try{const[a,n,r]=await Promise.all([fetch(`${B()}api/logs.php?type=ar&gip_id=${encodeURIComponent(e.id)}`),fetch(`${B()}api/logs.php?type=dtr&gip_id=${encodeURIComponent(e.id)}`),fetch(`${B()}api/logs.php?type=docs&gip_id=${encodeURIComponent(e.id)}`)]),t=await a.json(),i=await n.json(),s=await r.json();e.arLogs=t.success?t.logs:[],e.dtrLogs=i.success?i.logs:[],e.docs=s.success?s.logs:[],te(e,o)}catch(a){console.error("Error fetching logs/docs:",a),e.arLogs=[],e.dtrLogs=[],e.docs=[],te(e,o)}},window.showAddDataModal=function(e){ce(e)},window.editBeneficiary=function(e){ke(e)},window.showExportConfigModal=function(e){Be(e)},window.showProfileModal=function(){Ee()}}async function Ee(){try{let e="";try{const n=JSON.parse(localStorage.getItem("user"));n&&n.id&&(e=`?user_id=${n.id}`)}catch{}const a=await(await fetch(`${B()}api/profile.php${e}`)).json();if(a.success){const n=a.profile;Se(n)}else p.fire({icon:"error",title:"Error",text:a.error||"Failed to load profile"})}catch(e){console.error("Error fetching profile:",e)}}function Se(e){const o=e.profile_picture_path?`${B()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(r=>r[0]).join("").substring(0,2).toUpperCase():"US",n=`
    ...
    `;p.fire({html:n,width:"450px",showConfirmButton:!1,showCloseButton:!0,padding:"1.5rem",customClass:{container:"font-montserrat",popup:"rounded-[1.5rem] shadow-2xl overflow-visible ldn-modal-popup",closeButton:"focus:outline-none bg-gray-50 border-none swal2-custom-close cursor-pointer"},didOpen:r=>{const t=r.querySelector("#profile-edit-form"),i=r.querySelector("#profile-pic-input"),s=r.querySelector("#profile-avatar-preview");i.addEventListener("change",c=>{const d=c.target.files[0];if(d){const l=new FileReader;l.onload=g=>{s.innerHTML=`<img src="${g.target.result}" class="w-full h-full object-cover" />`},l.readAsDataURL(d)}}),t.addEventListener("submit",async c=>{c.preventDefault();const d=new FormData(t);try{const l=JSON.parse(localStorage.getItem("user"));l&&l.id&&d.append("user_id",l.id)}catch{}try{const g=await(await fetch(`${B()}api/profile.php`,{method:"POST",body:d})).json();g.success?(g.profile&&(localStorage.setItem("user",JSON.stringify(g.profile)),Ce(g.profile)),p.close(),p.fire({toast:!0,position:"top-end",icon:"success",title:"Profile Updated",showConfirmButton:!1,timer:3e3,timerProgressBar:!0})):p.fire({icon:"error",title:"Update Failed",text:g.error||"Something went wrong"})}catch(l){console.error("Error saving profile:",l)}})}})}function Ce(e){const o=e.profile_picture_path?`${B()}${e.profile_picture_path}`:null,a=e.full_name?e.full_name.split(" ").map(t=>t[0]).join("").substring(0,2).toUpperCase():"US",n=document.querySelectorAll(".sidebar-user-name"),r=document.querySelectorAll(".sidebar-user-avatar");n.forEach(t=>t.textContent=e.full_name),r.forEach(t=>{o?t.innerHTML=`<img src="${o}" class="w-full h-full object-cover" />`:t.textContent=a}),localStorage.setItem("user_full_name",e.full_name),o&&localStorage.setItem("user_avatar",o)}function Be(e){const o=window.getExportFilters?window.getExportFilters():{office:"ALL",status:"ALL",search:"",sort:"name",section:"ALL",columns:["id","name","office","position","startdate","enddate","status"],preparedBy:localStorage.getItem("ldn_export_prepared")||"",approvedBy:localStorage.getItem("ldn_export_approved")||""},a=`
        <div class="text-left font-montserrat p-1 overflow-visible">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-royal-blue/10 rounded-2xl flex items-center justify-center">
    ...
    `;p.fire({html:i,width:window.innerWidth<1024?"96vw":"1000px",showConfirmButton:!1,showCloseButton:!1,padding:window.innerWidth<1024?"0.75rem":"2rem",customClass:{container:"font-montserrat",popup:"rounded-2xl ldn-modal-popup"},didOpen:s=>{const c=s.querySelector("#cancel-modal-btn");c&&c.addEventListener("click",()=>{!o&&!e?._isBulk&&localStorage.removeItem("add_beneficiary_draft"),p.close(),e?._isBulk&&X.onCancel()});const d=s.querySelector("#bulk-add-btn");d&&d.addEventListener("click",()=>{p.close(),X.init()});const l=s.querySelector("#birthday-input"),g=s.querySelector("#age-display");l&&g&&(l.addEventListener("change",u=>{u.target.value&&(g.value=oe(u.target.value))}),l.value&&!e?.age&&(g.value=oe(l.value)));const b=s.querySelector("#name-input-field"),h=s.querySelector("#duplicate-warning");if(b&&h){let u;b.addEventListener("input",f=>{const m=f.target.value.trim();if(clearTimeout(u),m.length<3){h.classList.add("hidden");return}u=setTimeout(async()=>{try{const y=await(await fetch(`${B()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:m})})).json();y.success&&y.exists?(h.classList.remove("hidden"),F()?h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600"):h.classList.add("hidden")}catch(k){console.error("Duplicate check error:",k)}},500)}),e?.name&&(h.classList.add("hidden"),(async()=>{const m=await(await fetch(`${B()}api/check_duplicate.php`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:e.name})})).json();m.success&&m.exists&&(h.classList.remove("hidden"),F()?h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-400":h.className="mt-1 text-[10px] font-bold flex items-center gap-1.5 animate-pulse text-red-600")})())}const x=s.querySelector("#full-id-input"),$=s.querySelector("#series-no-input"),D=s.querySelector('input[name="startDate"]'),I=s.querySelector('input[name="endDate"]'),N=s.querySelectorAll('input[name="remarks"]'),A=s.querySelector("#extension-log-container"),H=u=>{o||(x&&(x.classList.add("animate-pulse"),x.placeholder="Loading...",fetch(`${B()}api/beneficiaries.php?next_id&year=${u}`).then(f=>f.json()).then(f=>{x.classList.remove("animate-pulse"),f.success&&f.nextId&&(x.value=f.nextId)})),$&&($.classList.add("animate-pulse"),$.placeholder="Loading...",fetch(`${B()}api/beneficiaries.php?next_series_no&year=${u}`).then(f=>f.json()).then(f=>{$.classList.remove("animate-pulse"),f.success&&f.nextSeries&&($.value=f.nextSeries)})))},Y=()=>{const u=s.querySelector('input[name="remarks"]:checked');return u?u.value:"ONGOING"},T=u=>{const f=s.querySelector(`input[name="remarks"][value="${u}"]`);f&&(f.checked=!0,w())},P=()=>{if(I&&I.value){const u=I.value.split("-"),f=new Date(u[0],u[1]-1,u[2]),m=new Date;m.setHours(0,0,0,0);let k="ONGOING";f<m&&(k="EXPIRED"),T(k)}},w=()=>{if(!A)return;if(Y()==="ABSORBED"){const f=e?.absorbDate||new Date().toLocaleString("en-US",{timeZone:"Asia/Manila",month:"short",day:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0});A.innerHTML=`
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                                <div class="${r?"bg-green-900/10 border-green-900/30":"bg-[#e8f5e9]/50 border-[#c8e6c9]"} rounded-lg p-2.5 flex items-center justify-between border">
                                    <div>
                                        ...
                                        <p class="text-[10px] font-black ${r?"text-green-400":"text-[#1b5e20]"} uppercase">${f}</p>
                                        <input type="hidden" name="absorbDate" value="${f}">
                                    </div>
    ...
    `,document.body.appendChild(t);const c=e?0:1e3,d=e?600:1500;setTimeout(()=>{o&&o.classList.add("animate-slide-left"),a&&a.classList.add("animate-slide-right"),setTimeout(()=>{window.location.href=`${B()}frontend/dashboard/`},d)},c)}function Re(){const e=document.getElementById("logoutBtn");e&&e.addEventListener("click",()=>{localStorage.removeItem("isLoggedIn"),window.location.href=`${B()}`})}function _e(){const e=document.getElementById("mobile-splash"),o=document.getElementById("show-login-btn"),a=document.getElementById("back-to-splash"),n=document.getElementById("mobile-bg-content"),r=document.getElementById("mobile-welcome-text"),t=document.getElementById("reopen-login-drawer"),i=document.getElementById("request-notifications-btn"),s=async()=>{if("Notification"in window){const x=await Notification.requestPermission();console.log("Notification permission:",x),x==="granted"&&i&&i.classList.add("hidden")}};Notification.permission==="default"&&i&&(i.classList.remove("hidden"),i.addEventListener("click",s));const c=()=>{e&&(e.style.transform="translateY(-100%)",setTimeout(()=>{e.style.visibility="hidden",e.style.pointerEvents="none",e.style.zIndex="-1",Notification.permission==="default"&&s();const x=document.getElementById("drawer-login");x&&x.classList.remove("translate-y-full")},800))},d=()=>{e&&(e.style.zIndex="9999",e.style.pointerEvents="auto",e.style.visibility="visible",e.style.transform="translateY(0)")};o&&o.addEventListener("click",c),document.querySelectorAll(".forgot-password-link").forEach(x=>{x.addEventListener("click",$=>{$.target.closest("#mobile-splash")&&c()})}),a&&a.addEventListener("click",()=>{const x=document.getElementById("drawer-login");if(x){x.classList.add("translate-y-full");const $=x.querySelector("[data-drawer-hide]");$&&$.click()}d()});const g=document.getElementById("drawer-login"),b=document.getElementById("curved-welcome"),h=document.getElementById("peoples-bg");g&&new MutationObserver($=>{$.forEach(D=>{D.attributeName==="class"&&(g.classList.contains("translate-y-full")?(n&&(n.style.transform="translateY(0)"),r&&(r.style.opacity="1",r.style.transform="translateY(0) scale(1)"),b&&(b.style.opacity="0",b.style.transform="scale(0.5)"),t&&e&&e.style.visibility==="hidden"&&(t.style.opacity="1",t.style.transform="scale(1)"),h&&(h.classList.add("opacity-0","scale-0"),h.classList.remove("opacity-40","scale-[1.6]"))):(n&&(n.style.transform="translateY(-35%)"),r&&(r.style.opacity="0",r.style.transform="translateY(20px) scale(0.9)"),b&&(b.style.opacity="1",b.style.transform="scale(1)"),t&&(t.style.opacity="0",t.style.transform="scale(0)"),h&&(h.classList.remove("opacity-0","scale-0"),h.classList.add("opacity-40","scale-[1.6]"))))})}).observe(g,{attributes:!0})}export{ne as _,ie as a,Me as b,Ne as c,Ie as d,Pe as e,Re as f,B as g,_e as h,Te as i,Oe as j,ye as p,Ae as r,je as s,Ce as u};
