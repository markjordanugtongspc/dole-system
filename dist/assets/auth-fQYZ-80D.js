            ...
            ${s.map(i=>{const b=i.status.toUpperCase(),h={VERIFIED:"COMPLETED",DECLINED:"REJECTED",PENDING:"PENDING"}[b]||b,x=h==="COMPLETED",$=h==="REJECTED",D=x?"text-green-500":$?"text-red-500":"text-gray-400 dark:text-gray-500",I=x?"bg-green-50/50 dark:bg-green-900/10":$?"bg-red-50/50 dark:bg-red-900/10":"bg-gray-50/50 dark:bg-slate-800/50",N=x?"bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-300 dark:border-green-800 hover:bg-green-200 cursor-pointer":$?"bg-red-100 text-red-700 border-red-200 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800 hover:bg-red-200 cursor-pointer":"bg-white text-gray-500 border-gray-200 dark:bg-slate-700 dark:text-gray-400 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-600 cursor-pointer";let A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>';return x?A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path></svg>':$&&(A='<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M6 18L18 6M6 6l12 12"></path></svg>'),`
                <div class="flex items-center justify-between p-3.5 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm transition-all hover:-translate-y-0.5 ${I}">
                    <div class="flex items-center gap-3 w-full">
                        ...
                        <span class="text-xs sm:text-sm font-black ${x?"text-heading":"text-gray-500 dark:text-gray-400"} uppercase tracking-tight flex-1">${i.name}</span>
                    </div>
                    <button type="button" class="ml-3 ${N} text-[10px] font-black px-3 py-1.5 rounded-full border uppercase tracking-widest transition-colors flex-shrink-0 drawer-doc-btn" data-id="${i.id}" data-name="${i.name}" data-status="${h} cursosr-pointer">
                        ${h}
                    </button>
                </div>
                `}).join("")}
...
.text-right-select { text-align-last: right; }
    ...
    `;let l=document.getElementById("edit-drawer-container");l&&l.remove(),l=document.createElement("div"),l.id="edit-drawer-container",l.className="fixed top-0 right-0 z-[100] h-screen p-4 sm:p-6 overflow-y-auto transition-transform duration-500 ease-in-out translate-x-full bg-white dark:bg-slate-900 w-full sm:w-[550px] lg:w-[650px] shadow-2xl pb-0",l.setAttribute("tabindex","-1"),l.innerHTML=t,document.body.appendChild(l),setTimeout(()=>{const s=l.querySelector('textarea[name="name"]');s&&(s.style.height="auto",s.style.height=s.scrollHeight+"px")},10),ne(async()=>{const{Drawer:s}=await import("./vendor-flowbite-B2TFTxm5.js");return{Drawer:s}},__vite__mapDeps([0,1])).then(({Drawer:s})=>{const c=new s(l,{placement:"right",backdrop:!0,bodyScrolling:!1,backdropClasses:"bg-gray-900/50 dark:bg-gray-900/80 fixed inset-0 z-50",onHide:()=>{setTimeout(()=>{l.parentNode&&l.remove()},300)}});c.show(),l.querySelector("#close-edit-drawer-btn").addEventListener("click",()=>c.hide()),l.querySelector("#edit-drawer-cancel-btn").addEventListener("click",()=>c.hide());const d=l.querySelector("#edit-bday-input"),i=l.querySelector("#edit-age-display");d&&i&&d.addEventListener("change",f=>{f.target.value&&(i.value=r(f.target.value))});const b=l.querySelector("#edit-beneficiary-drawer-form");b.addEventListener("submit",f=>{f.preventDefault();const h=new FormData(b),x={};h.forEach(($,D)=>x[D]=$),x.id=e.id,x.gip_id=e.id,window.addBeneficiaryData&&(async()=>{if(await window.addBeneficiaryData(x,!0,!1)){c.hide();const D=document.querySelector("#close-drawer-btn");D&&D.click(),u.fire({toast:!0,position:"top-end",icon:"success",title:"Record Updated",showConfirmButton:!1,timer:3e3})}})()})})}function re(e="Incorrect Username or Password"){u.fire({html:`
            <div class="p-6">
            ...
            <form id="export-config-form" class="space-y-6">
                ...
                <div class="bg-gray-50/50 rounded-2xl p-4 border border-gray-100 mt-4">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                        ${["ID","Name","Office","Position","Start Date","End Date","Status"].map(n=>{const r=n.toLowerCase().replace(" ",""),t=o.columns.includes(r),l=`col-switch-${r}`;return`
